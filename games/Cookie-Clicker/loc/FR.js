AddLanguage("FR", "french", {
  ...
  "notifications disappear much faster":
    "fait disparaître les notifications plus vite",
  ...
  "add options on buildings like Mute":
    "ajoute des options aux constructions, comme la Sourdine",
  ...
  "note: this will save and reload your game":
    "note : votre partie sera enregistrée et rechargée",
  "Press %1 to toggle fullscreen.":
    "Appuyez sur %1 pour activer le plein écran ou non",
  ...
  "at %1% of its potential <b>(+%2% CpS)</b>":
    "à %1 % de son potentiel <b>(+%2 % CpS)</b>",
  ...
  "%1 to resume from your save file.":
    "%1 pour reprendre depuis le fichier de sauvegarde.",
  ...
  "Are you sure you want to close Cookie Clicker?":
    "Veux-tu vraiment fermer Cookie Clicker ?",
  ...
  "Use this to keep backups on your computer":
    "Sert à garder des copies sur ton ordinateur",
  ...
  "You earned <b>%1</b> while you were away.":
    "Tu as gagné <b>%1</b> pendant ton absence.",
  Mods: "/",
  ...
  "Mods are loaded from top to bottom.":
    "Les mods sont chargés de haut en bas.",
  ...
  "What should your bakery's name be?":
    "Comment ta pâtisserie devrait-elle s'appeler ?",
  ...
  "You harvested <b>%1</b> while you were away.":
    "Tu as récolté <b>%1</b> en ton absence.",
  ...
  "Sugar lump cooldowns cleared!":
    "Barres d'attentes de morceaux de sucre vidées !",
  ...
  "Cookie chain over. You made %1.":
    "Chaîne de cookies terminée. Tu as fait %1.",
  ...
  "Your dragon dropped something!":
    "Ton dragon a laissé tomber quelque chose !",
  ...
  "Your family accepts to try some of your cookies.":
    "Ta famille accepte de goûter à tes cookies.",
  "Your cookies are popular in the neighborhood.":
    "Tes cookies sont populaires dans le quartier.",
  "People are starting to talk about your cookies.":
    "Les gens commencent à parler de tes cookies.",
  ...
  "Your cookies are renowned in the whole town!":
    "Tes cookies sont renommés dans toute la ville !",
  ...
  "Your cookies now have their own website!":
    "Tes cookies ont leur propre site web !",
  ...
  "The whole planet is enjoying your cookies!":
    "Tout la planète se délecte de tes cookies.",
  ...
  "Your cookies have achieved sentience.":
    "Tes cookies sont devenus conscients.",
  ...
  "Wish granted. Golden cookie spawned.":
    "Vœu exaucé. Apparition d'un cookie doré.",
  "help me!": "aidez-moi !",
  Ascend: "Ascension",
  "You've been on this run for <b>%1</b>.":
    "Tu as commencé ta partie depuis <b>%1</b>.",
  ...
  "each %1 produces <b>%2</b> per second":
    "chaque %1 produit <b>%2</b> par seconde",
  ...
  "...also boosting some other buildings:":
    "...améliore aussi d'autres constructions :",
  ...
  "[Bank quote]Generates cookies from interest.":
    "Génère des cookies à partir des intérêts.",
  ...
  "[Temple quote]Full of precious, ancient chocolate.":
    "Plein de chocolat antique et précieux.",
  ...
  "[Portal quote]Opens a door to the Cookieverse.":
    "Ouvre un passage vers le cookievers.",
  ...
  "[Prism quote]Converts light itself into cookies.":
    "Convertit la lumière elle-même en cookies.",
  ...
  "[You quote]You, alone, are the reason behind all these cookies. You figure if there were more of you... maybe you could make even more.":
    "C’est seulement toi, la raison derrière tous ces cookies. Tu te dis que s’il y avait davantage de toi… tu pourrais en fabriquer encore plus.",
  ...
  "[You business quote]Your business is as great as it's gonna get. The only real way to improve it anymore is to improve yourself - and become the best CEO this world has ever seen.":
    "Ton entreprise va aussi bien qu’elle peut. La seule manière de l’améliorer consiste à t’améliorer toi-même… et devenir le meilleur PDG que le monde ait jamais connu.",
  CpS: "/",
  ...
  "Clicking is <b>%1%</b> more powerful.":
    "Les clics sont <b>%1 %</b> plus puissants.",
  ...
  "%1 are <b>twice</b> as efficient.":
    "%1 sont <b>deux fois</b> plus efficaces.",
  ...
  "Tiered upgrades for <b>%1</b> provide an extra <b>+%2%</b> production.<br>Only works with unshackled upgrade tiers.":
    "Les améliorations à paliers de <b>%1</b> fournissent <b>+%2 %</b> de production supplémentaire.<br>Ne fonctionne qu'avec les paliers d'amélioration débridées.",
  "Unshackles all <b>%1-tier upgrades</b>, making them more powerful.<br>Only applies to unshackled buildings.":
    "Débride toutes les <b> améliorations à %1 paliers</b>, les rendant plus puissantes.<br>S'applique uniquement aux constructions débridées.",
  ...
  "Time remaining until pledge runs out:":
    "Temps restant avant la fin de l'engagement :",
  ...
  "Research takes only <b>5 seconds</b>.":
    "La recherche prend seulement <b>5 secondes</b>.",
  ...
  "Golden cookies stay <b>%1%</b> longer.":
    "Les cookies dorés restent <b>%1 %</b> plus longtemps.",
  ...
  "Wrinklers spawn much more frequently.":
    "Les rideux apparaissent nettement plus fréquemment.",
  ...
  "Wrinklers digest <b>%1% more cookies</b>.":
    "Les rideux digèrent <b>%1 % de cookies en plus</b>.",
  ...
  "a festive test tube<br>and <b>%1</b>.":
    "une éprouvette festive<br>et <b>%1</b>.",
  "Cost scales with CpS.": "Le coût est proportionnel aux CpS.",
  "Cost scales with Santa level.":
    "Le coût est proportionnel au niveau de Père Noël.",
  ...
  "All upgrades are <b>%1% cheaper</b>.":
    "Toutes les améliorations sont <b>%1 %</b> moins chères.",
  ...
  "Reindeer spawn much more frequently.":
    "Les rennes apparaissent beaucoup plus fréquemment.",
  ...
  "The egg bursts into <b>%1</b> cookies!":
    "L'œuf éclate et donne <b>%1</b> cookies !",
  "You found an egg!": "Tu as trouvé un œuf !",
  "Eggs drop <b>%1%</b> more often.":
    "Les œufs apparaissent <b>%1 %</b> plus souvent.",
  ...
  "Contains an assortment of...something.":
    "Contient un assortiment de... quelque chose.",
  ...
  "Pick an upgrade to make permanent":
    "Choisis une amélioration à rendre permanente",
  ...
  "Unlocks the <b>cookie dragon egg</b>.":
    "Débloque <b>l'œuf de dragon de cookie</b>.",
  ...
  "Contains more wallpapers for your background selector.":
    "Contient de nouveaux papiers peints pour ton sélecteur de fond d’écran.",
  "Lets you pick which wallpaper to display.":
    "Permet de choisir le fond d'écran à afficher.",
  ...
  "You can attract <b>%1 more wrinklers</b>.":
    "Tu peux attirer<b>%1 rideux de plus</b>.",
  ...
  "Cookie production <b>reduced to 0</b>.":
    "Production de cookies <b>réduite à 0</b>.",
  ...
  "May only be used once per ascension.":
    "Ne peut être utilisée qu'une fois par ascension.",
  ...
  "<b>+%1%</b> sugar lump growth.":
    "<b>+%1 %</b> de croissance des morceaux de sucre.",
  "Sugar lumps ripen <b>%1</b> sooner.":
    "Les morceaux de sucre mûrissent <b>%1</b> plus tôt.",
  "Sugar lumps mature <b>%1</b> sooner.":
    "Les morceaux de sucre s'affinent <b>%1</b> plus tôt.",
  ...
  "Has a <b>%1%</b> chance to not break.":
    "Offre <b>%1 %</b> de chances de ne pas se déchirer.",
  ...
  "You've been neglecting your %1.":
    "%1 n'a pas bénéficié d'assez de ton attention.",
  "Remember to visit your %1 sometimes.":
    "Ce serait bien d'aller voir %1 de temps en temps.",
  ...
  "Hey, what's up. I'm a fortune cookie.":
    "Hé, coucou. Je suis un biscuit de bonne aventure.",
  "You think you have it bad? Look at me.":
    "Tu penses être dans la mouise ? Regarde-moi.",
  ...
  "Kittens are <b>%1%</b> more effective.":
    "Les chatons sont <b>%1 %</b> plus efficaces.",
  ...
  "Seasonal cookies purchased: <b>%1</b>.":
    "Cookies saisonniers achetés : <b>%1</b>.",
  "Reindeer cookies purchased: <b>%1</b>.":
    "Cookies rennes achetés : <b>%1</b>.",
  ...
  "Some seasonal effects are boosted.":
    "Certains effets saisonniers sont augmentés.",
  ...
  "Switching seasons is %1% pricier.":
    "Changer de saison coûte %1 % plus cher.",
  "Switching seasons is %1% cheaper.":
    "Changer de saison coûte %1 % moins cher.",
  "Heavenly chips have %1% less effect.":
    "Les pépites célestes ont %1 % d'effet en moins.",
  ...
  "You may now send and receive gifts with other players through buttons in the top-right of the %1 menu.":
    "Tu peux maintenant envoyer et recevoir des cadeaux avec les autres joueurs avec le boutons en haut à droite du menu %1.",
  "You need at least %1 cookies in bank to send and receive gifts.":
    "Il te faut au moins %1 cookies à la banque pour envoyer et recevoir des cadeaux.",
  ...
  'Clicking "%1" will generate a text code you can send to others. Gift codes can be redeemed multiple times by anyone but expire after a day or two. You can only generate one gift code per hour. Your game will save after sending.':
    'Cliquer sur "%1" génèrera un code que tu peux envoyer à d’autres. Les codes cadeaux peuvent être récupérés plusieurs fois par n’importe qui, mais expirent après un jour ou deux. Tu ne peux générer qu’un seul code cadeau par heure. Ta partie sera sauvegardée après l’envoi.',
  "You may put between %1 and %2 cookies in the gift box.":
    "Tu peux mettre entre %1 et %2 cookies dans le paquet cadeau.",
  "You can leave a note. Don't be rude!<br>Maximum %1 lines and %2 characters.":
    "Tu peux ajouter un message. Pas de grossièretés !<br>%1 lignes et %2 caractères maximum.",
  "Once you redeem a gift, you will have to wait an hour before you can redeem another. Your game will save after redeeming.":
    "Une fois un cadeau récupéré, tu devras attendre une heure avant de pouvoir en récupérer un autre. Ta partie sera sauvegardée après la récupération.",
  "Box design": "Apparence du paquet",
  Icon: "Icône",
  "Here's your gift code!<br>Make sure to copy it so you can share it.":
    "Voilà ton code cadeau !<br>N’oublie pas de le copier pour pouvoir le partager.",
  ...
  "Ascend with <b>%1</b> baked.":
    "Effectue une ascension avec <b>%1</b> cuits.",
  ...
  "Have at least <b>%1 of everything</b>.":
    "Possède au moins <b>%1 exemplaire de tout</b>.",
  ...
  "Trigger the grandmapocalypse for the first time.":
    "déclenche la grandmapocalypse pour la première fois.",
  ...
  "Declare a covenant with the grandmatriarchs.":
    "Engage-toi auprès des grand-matriarches.",
  "Own at least <b>%1</b> grandma types.":
    "Possède au moins <b>%1</b> types de grand-mère.",
  ...
  "Reach <b>Santa's 7th form</b>.":
    "Atteins la <b>7ème forme du Père Noël</b>.",
  "Reach <b>Santa's final form</b>.":
    "Atteins la <b>forme finale du Père Noël</b>.",
  ...
  "Complete your <b>dragon's training</b>.":
    "Achève <b>l'entraînement de ton dragon</b>.",
  "Click on the news ticker <b>%1 times</b>.":
    "Clique <b>%1 fois</b> sur le fil d'informations.",
  ...
  "Own <b>%1</b> heavenly upgrades.":
    "Possède <b>%1</b> améliorations célestes. ",
  ...
  "Poke a wrinkler <b>%1 times</b> without killing it.":
    "Touche un rideux <b>%1 fois</b> sans le tuer.",
  ...
  "Harvest <b>%1</b> mature garden plants.":
    "Récolte <b>%1</b> plantes du jardin à maturation.",
  ...
  "Ascend with exactly <b>%1</b>.":
    "Effectue une ascension avec exactement <b>%1</b>.",
  ...
  "Make your first stock market profit.":
    "Réalise ton premier profit sur le marché boursier.",
  ...
  "Take out a loan and ascend before incurring the CpS penalty.":
    "Fais un prêt et effectue une ascension avant de subir la pénalité de CpS.",
  "Own <b>%1</b> kitten upgrades.":
    "Possède <b>%1</b> améliorations de chatons.",
  ...
  "Redeem a cookie gift code from a friend (or from yourself, we don't judge).":
    "Utilise le code cadeau cookie d’un ami (ou le tiens, on ne te juge pas).",
  "Shape your clones to resemble %1.":
    "Modèle tes clones pour ressembler à %1.",
  Clone: "/",
  ...
  "Cookie production %1% slower for %2!":
    "Production de cookies ralentie de %1 % pendant %2 !",
  "Cookie production halved for %1!":
    "Production de cookies divisée en deux pendant %1 !",
  ...
  "Can't send or receive gifts again for %1.":
    "Tu ne peux pas envoyer ni recevoir de cadeaux pendant %1.",
  ...
  "Your garden is frozen, providing no effects.":
    "Ton jardin est gelé, n'apportant aucun effet.",
  "Combined effects of all your plants:":
    "Effets combinés de toutes tes plantes :",
  "None.": "Aucun.",
  ...
  "Garden is frozen. Unfreeze to resume.":
    "Le jardin est gelé. Dégèle-le pour reprendre.",
  ...
  "harvest when mature for a sugar lump":
    "à récolter une fois à maturité pour un morceau de sucre",
  useless: "inutile",
  ...
  "Click to select this seed for planting.":
    "Clique pour choisir cette graine à planter.",
  ...
  "Mature plants harvested: %1 (total: %2)":
    "Palntes à maturité récoltées : %1 (total : %2)",
  ...
  "You magic <b>%1</b> out of thin air.":
    "Tu fais apparaître <b>%1</b> par magie.",
  ...
  "Summon an unlucky wrath cookie.":
    "Invoque un cookie de colère portant la malchance.",
  ...
  "Backfired, but no buildings to destroy!":
    "Mal tourné, mais pas de constructions à détruire !",
  ...
  "[GOD 5 NAME]Selebrak, Spirit of Festivities":
    "Selebrak, esprit des festivités",
  ...
  "Release to assign %1 to this slot.":
    "Libérer pour assigner %1 à cet emplacement.",
  ...
  "%1: currently worth <b>$%2</b> per unit.":
    "%1 : vaut actuellement <b>%2 $</b> l'unité.",
  "You currently own %1 (worth <b>$%2</b>).":
    "Tu possèdes actuellement %1 (valant <b>%2 $</b>).",
  "Your warehouses can store up to %1.":
    "Tes entrepôts peuvent actuellement stocker jusqu'à %1.",
  ...
  "+%1 warehouse space for all goods":
    "+ %1 espace d'entrepôt pour toutes les marchandises",
  ...
  "A nice broker to trade more cookies.":
    "Un gentil courtier pour échanger davantage de cookies.",
  Hire: "Engager",
  ...
  "Hiring a new broker will cost you %1.":
    "Engager un nouveau courtier te coûtera %1.",
  ...
  "[Upgrade name 1]Carpal tunnel prevention cream":
    "Crème de soin du canal carpien",
  ...
  "[Upgrade name 8]Steel-plated rolling pins":
    "Rouleaux à pâtisserie plaqués acier",
  ...
  "[Upgrade name 35]Oatmeal raisin cookies":
    "Cookies farine d'avoine et raisins secs",
  ...
  "[Upgrade name 45]Genetically-modified cookies":
    "Cookies modifiés génétiquement",
  ...
  "[Upgrade name 55]Dark chocolate-coated cookies":
    "Cookies enrobés de chocolat noir",
  "[Upgrade name 56]White chocolate-coated cookies":
    "Cookies enrobés de chocolat blanc",
  ...
  "[Upgrade name 64]Bingo center/Research facility":
    "Centre de bingo/de recherches",
  "[Upgrade name 65]Specialized chocolate chips":
    "Pépites de chocolat spécialisées",
  ...
  "[Upgrade name 94]Chocolate british tea biscuits":
    "Biscuits au chocolat pour le thé britannique",
  "[Upgrade name 95]Round british tea biscuits":
    "Biscuits ronds pour le thé britannique",
  ...
  "[Upgrade name 157]Reindeer baking grounds":
    "Terrains de pâtisserie des rennes",
  ...
  "[Upgrade name 253]Tin of british tea biscuits":
    "Boîte de biscuits pour le thé britannique",
  ...
  "[Upgrade name 256]Pure black chocolate cookies":
    "Cookies au chocolat noir pur",
  "[Upgrade name 257]Pure white chocolate cookies":
    "Cookies au chocolat blanc pur",
  ...
  "[Upgrade name 264]Permanent upgrade slot I":
    "Emplacement d'amélioration permanente I",
  "[Upgrade name 265]Permanent upgrade slot II":
    "Emplacement d'amélioration permanente II",
  "[Upgrade name 266]Permanent upgrade slot III":
    "Emplacement d'amélioration permanente III",
  "[Upgrade name 267]Permanent upgrade slot IV":
    "Emplacement d'amélioration permanente IV",
  "[Upgrade name 268]Permanent upgrade slot V":
    "Emplacement d'amélioration permanente V",
  ...
  "[Upgrade name 281]Twin Gates of Transcendence":
    "Portes jumelles de la transcendance",
  ...
  "[Upgrade name 302]Theory of atomic fluidity":
    "Théorie de la fluidité atomique",
  "[Upgrade name 303]End of times back-up plan":
    "Plan de secours en cas de fin des temps",
  ...
  "[Upgrade name 317]Cookietopian moments of maybe":
    "Moments de possibilités cookietopiens",
  ...
  "[Upgrade name 328]Classic dairy selection":
    "Sélection de produits laitiers classiques",
  "[Upgrade name 329]Fanciful dairy selection":
    "Sélection de produits laitiers de luxe",
  ...
  "[Upgrade name 334]Milk chocolate butter biscuit":
    "Biscuit au beurre au chocolat au lait",
  "[Upgrade name 335]Dark chocolate butter biscuit":
    "Biscuit au beurre au chocolat noir",
  "[Upgrade name 336]White chocolate butter biscuit":
    "Biscuit au beurre au chocolat blanc",
  "[Upgrade name 337]Ruby chocolate butter biscuit":
    "Biscuit au beurre au chocolat rubis",
  ...
  "[Upgrade name 361]Golden cookie sound selector":
    "Sélecteur de son de cookie doré",
  "[Upgrade name 362]Basic wallpaper assortment":
    "Ensemble de fonds d'écran de base",
  ...
  "[Upgrade name 397]Distilled essence of redoubled luck":
    "Essence distillée de chance redoublée",
  ...
  "[Upgrade name 451]Sugar aging process":
    "Processus de vieillissement du sucre",
  ...
  "[Upgrade name 480]Timeproof hair dyes":
    "Teintures à cheveux à l'épreuve du temps",
  ...
  "[Upgrade name 487]Restaurants at the end of the universe":
    "Restaurants du bout de l'univers",
  ...
  "[Upgrade name 490]Additional clock hands":
    "Aiguilles d'horloge supplémentaires",
  ...
  "[Upgrade name 560]One lone chocolate chip":
    "Une pépite de chocolat solitaire",
  ...
  "[Upgrade name 594]The JavaScript console for dummies":
    "La console javascript pour les nuls",
  ...
  "[Upgrade name 655]Peanut butter cup cookies":
    "Cookies en bouchée beurre de cacahouète",
  ...
  "[Upgrade name 659]Cosmic chocolate butter biscuit":
    "Biscuit au beurre chocolat cosmique",
  ...
  "[Upgrade name 704]Diminishing tax returns":
    "Rendements d'impôts décroissants",
  ...
  "[Upgrade name 730]Principled neural shackles":
    "Menottes neurales scrupuleuses",
  ...
  "[Upgrade name 746]N-dimensional assembly lines":
    "Chaînes de montage à n dimensions",
  ...
  "[Upgrade name 750]Cosmic foreground radiation":
    "Rayonnement cosmique de premier plan",
  ...
  "[Upgrade name 779]Unshackled time machines":
    "Machines à voyager dans le temps débridées",
  "[Upgrade name 780]Unshackled antimatter condensers":
    "Condenseurs d'antimatière débridés",
  ...
  "[Upgrade name 804]Distinguished wallpaper assortment":
    "Ensemble de fonds d'écran distingués",
  ...
  "[Upgrade name 815]Marshmallow sandwich cookies":
    "Cookies sandwich à la guimauve",
  ...
  "[Upgrade name 847]At your doorstep in 30 minutes or your money back":
    "Chez vous en 30 minutes ou remboursé",
  ...
  "[Achievement name 70]Cheated cookies taste awful":
    "Les cookies trichés ont un goût affreux",
  ...
  "[Achievement name 96]Getting even with the oven":
    "Régler ses comptes avec le four",
  "[Achievement name 97]Now this is pod-smashing":
    "Ça c'est écraser les gousses",
  ...
  "[Achievement name 189]Finger clickin' good":
    "Bon à en cliquer avec les doigts",
  ...
  "[Achievement name 202]A still more glorious dawn":
    "Une aube encore plus glorieuse",
  ...
  "[Achievement name 218]A place lost in time":
    "Un endroit perdu dans le temps",
  ...
  "[Achievement name 224]The land of milk and cookies":
    "Le pays du lait et des cookies",
  ...
  "[Achievement name 243]Tabloid addiction":
    "Dépendance à la presse de caniveau",
  ...
  "[Achievement name 306]Now the dark days are gone":
    "Maintenant, les jours sombres sont loin",
  ...
  "[Achievement name 313]It belongs in a bakery":
    "Sa place est dans une pâtisserie",
  ...
  "[Achievement name 327]Grandma needs a new pair of shoes":
    "Grand-mère a besoin de chaussures",
  "[Achievement name 328]Million to one shot, doc":
    "Une chance sur un million, Doc",
  ...
  "[Achievement name 340]But wait 'til you get older":
    "Mais attends un peu de grandir",
  ...
  "[Achievement name 344]Treacle tart economics":
    "Ruissellement de tarte à la mélasse",
  "[Achievement name 345]Holy cookies, grandma!":
    "Saints cookies, grand-mère !",
  ...
  "[Achievement name 363]Groundhog day":
    "Le jour de la marmotte (et du papier alu)",
  ...
  "[Achievement name 371]Green cookies sleep furiously":
    "Les cookies verts dorment furieusement",
  ...
  "[Achievement name 405]The meteor men beg to differ":
    "Les hommes-météores ne sont pas d'accord",
  "[Achievement name 406]Only shooting stars":
    "Les étoiles filantes ne parlent que de moi",
  ...
  "[Achievement name 459]No nobility in poverty":
    "Pas de noblesse dans la pauvreté",
  ...
  "[Achievement name 529]When there's nothing left to add":
    "Quand il ne reste rien à ajouter",
  ...
  "[Achievement name 532]But I didn't say stop, did I?":
    "Mais je n'ai pas dit d'arrêter, si ?",
  ...
  "[Achievement name 539]It's big brain time":
    "C'est l'heure des gros cerveaux",
  ...
  "[Achievement name 542]The organ that named itself":
    "L'organe qui s'est nommé lui-même",
  ...
  "[Achievement name 556]They moistly come at night":
    "Ils viennent moelleusement la nuit",
  ...
  "[Achievement name 566]But the future refused to change":
    "Mais l'avenir refusait de changer",
  "[Achievement name 567]What's the dark matter with you":
    "Ta matière de noir les choses",
  ...
  "[Achievement name 578]Fake it till you bake it":
    "Fais comme si, viendra la pâtisserie",
  "[Achievement name 579]History in the baking":
    "L'Histoire en train de se cuire",
  ...
  "[Achievement name 591]Speed's the name of the game (no it's not it's called Cookie Clicker)":
    "Un jeu nommé Vitesse (non, en fait, c’est Cookie Clicker)",
  ...
  "[Achievement name 638]Oft we mar what's well":
    "Nous gâtons souvent ce qui est bien",

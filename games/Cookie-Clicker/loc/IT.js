AddLanguage("IT", "italian", {
  ...
  "numbers that pop up when clicking the cookie":
    "mostra i numeri quando fai clic sul biscotto",
  "Milk [setting]": "Latte",
  ...
  "notifications disappear much faster":
    "le notifiche scompaiono più rapidamente",
  ...
  "note: this will save and reload your game":
    "nota: la partita verrà salvata e ricaricata",
  ...
  "at %1% of its potential <b>(+%2% CpS)</b>":
    "al %1% del suo potenziale <b>(+%2% di B/s)</b>",
  ...
  "%1 to resume from your save file.":
    "%1 per continuare dal tuo file di salvataggio.",
  ...
  "Are you sure you want to close Cookie Clicker?":
    "Vuoi davvero chiudere Cookie Clicker?",
  ...
  "You earned <b>%1</b> while you were away.":
    "Mentre non c'eri hai ottenuto <b>%1</b>.",
  Mods: "Mod",
  ...
  "Mods are loaded from top to bottom.":
    "Le mod vengono caricate dall'alto al basso.",
  ...
  "What should your bakery's name be?":
    "Quale sarà il nome della tua pasticceria?",
  ...
  "You harvested <b>%1</b> while you were away.":
    "Mentre non c'eri hai raccolto <b>%1</b>.",
  ...
  "Sugar lump cooldowns cleared!":
    "Tempi di ricarica delle zollette di zucchero azzerati!",
  ...
  "Cookie chain over. You made %1.":
    "Combo di biscotti terminata. Hai ottenuto %1.",
  ...
  "You find a present which contains...":
    "Hai trovato un regalo che contiene...",
  Evolve: "Evolvi",
  ...
  "Lets you use two dragon auras simultaneously":
    "Usa contemporaneamente due auree del drago",
  ...
  "Your cookies are popular in the neighborhood.":
    "I tuoi biscotti spopolano tra il vicinato.",
  ...
  "Your cookies are renowned in the whole town!":
    "I tuoi biscotti sono famosi in tutta la città!",
  "Your cookies bring all the boys to the yard.":
    "I tuoi biscotti attirano orde di ragazzi.",
  "Your cookies now have their own website!":
    "I tuoi biscotti hanno il loro sito web!",
  "Your cookies are worth a lot of money.":
    "I tuoi biscotti valgono un mucchio di soldi.",
  ...
  "The whole planet is enjoying your cookies!":
    "L'intero pianeta adora i tuoi biscotti!",
  ...
  "Your cookies have achieved sentience.":
    "I tuoi biscotti sono diventati senzienti.",
  ...
  "Wish granted. Golden cookie spawned.":
    "Desiderio esaudito. Biscotto dorato generato.",
  "help me!": "aiutami!",
  Ascend: "Ascendi",
  "You've been on this run for <b>%1</b>.":
    "Stai giocando a questa campagna da <b>%1</b>.",
  ...
  "Ascending now would grant you no prestige.":
    "Se ascendi ora non otterrai alcun prestigio.",
  ...
  "Are you ready to return to the mortal world?":
    "È il momento di tornare al mondo dei mortali?",
  "Hello, cookies!": "Ehilà, biscotti!",
  "Challenge mode for the next run:":
    "Modalità sfida per la prossima campagna:",
  ...
  "each %1 produces <b>%2</b> per second":
    "ogni %1 produce <b>%2</b> al secondo",
  "%1 producing <b>%2</b> per second":
    "Un totale di %1 produce <b>%2</b> al secondo",
  ...
  "...also boosting some other buildings:":
    "... vengono forniti bonus anche ad altre strutture:",
  ...
  "Granting <b>+%1% %2 CpS</b>.":
    "Garantiscono <b>+%1% B/s ottenuti da queste unità: %2</b>.",
  "Click to level up for %1.":
    "Fai clic per aumentare il livello al costo di %1.",
  ...
  "[Cursor quote]Autoclicks once every 10 seconds.":
    "Clic automatico ogni 10 secondi.",
  ...
  "[Factory quote]Produces large quantities of cookies.":
    "Produce enormi quantità di biscotti.",
  ...
  "[Bank quote]Generates cookies from interest.":
    "Genera biscotti dagli interessi.",
  ...
  "[Temple quote]Full of precious, ancient chocolate.":
    "Colmo di antico e prezioso cioccolato.",
  ...
  "[Wizard tower quote]Summons cookies with magic spells.":
    "Evoca biscotti con un incantesimo.",
  ...
  "[Portal quote]Opens a door to the Cookieverse.":
    "Apre un varco verso il biscoverso.",
  ...
  "[Prism quote]Converts light itself into cookies.":
    "Converte la luce stessa in biscotti.",
  ...
  "[You quote]You, alone, are the reason behind all these cookies. You figure if there were more of you... maybe you could make even more.":
    "Sei la sola ragione dietro a tutti questi biscotti. Pensa che se fossi replicabile...probabilmente guadagneresti ancora di più.",
  ...
  "[You business quote]Your business is as great as it's gonna get. The only real way to improve it anymore is to improve yourself - and become the best CEO this world has ever seen.":
    "La tua attività non potrebbe andare meglio. L'unico vero modo per migliorarla è migliorare sé stessi e diventare l'AD migliore che ci sia.",
  CpS: "BpS",
  ...
  "Clicking is <b>%1%</b> more powerful.":
    "I clic sono più potenti del <b>%1%</b>.",
  ...
  "%1 are <b>twice</b> as efficient.":
    "<b>Raddoppia</b> l'efficienza di queste unità: %1.",
  "%1 are <b>%2%</b> more powerful.":
    "<b>Aumenta del %2%</b> la potenza di queste unità: %1.",
  "Unshackled! <b>+%1%</b> extra production.":
    "Senza catene! <b>+%1%</b> produzione extra.",
  ...
  "Clicking gains <b>+%1% of your CpS</b>.":
    "Ottieni <b>+%1% B/s</b> con ogni clic.",
  "%1 gain <b>+%2%</b> CpS per %3.":
    "Queste unità ottengono <b>+%2%</b> B/s ogni %3: %1.",
  ...
  "Each %1 gains <b>+%2 base CpS per %3</b>.":
    "Ogni %1 ottiene <b>+%2 B/s base ogni %3</b>.",
  ...
  "Time remaining until pledge runs out:":
    "Tempo restante alla conclusione del giuramento:",
  "You haven't pledged to the elders yet.":
    "Non hai ancora prestato giuramento alle anziane.",
  ...
  "Research takes only <b>5 seconds</b>.":
    "La ricerca impiega solo <b>5 secondi</b>.",
  ...
  "Golden cookies appear <b>really often</b>.":
    "I biscotti dorati compaiono <b>molto spesso</b>.",
  ...
  "Wrinklers spawn much more frequently.":
    "I divoratori vengono generati con maggiore frequenza.",
  ...
  "Wrinklers digest <b>%1% more cookies</b>.":
    "I divoratori digeriscono <b>%1% di biscotti in più</b>.",
  ...
  "a festive test tube<br>and <b>%1</b>.":
    "una provetta natalizia<br>e <b>%1</b>.",
  "Cost scales with CpS.": "Il costo varia in base ai B/s.",
  "Cost scales with Santa level.":
    "Il costo varia in base al livello di Babbo Natale.",
  ...
  "Reindeer appear <b>%1%</b> more often.":
    "Aumenta del <b>%1%</b> la frequenza delle renne.",
  "Reindeer appear <b>twice as frequently</b>.":
    "<b>Raddoppia</b> la frequenza delle renne.",
  "Reindeer are <b>twice as slow</b>.":
    "<b>Dimezza la velocità</b> delle renne.",
  "Reindeer give <b>twice as much</b>.":
    "<b>Raddoppia le ricompense</b> delle renne.",
  ...
  "Reindeer spawn much more frequently.":
    "Le renne vengono generate con maggiore frequenza.",
  ...
  "Click again to cancel season":
    "Fai di nuovo clic per interrompere la stagione",
  ...
  "The egg bursts into <b>%1</b> cookies!":
    "L'esplosione dell'uovo genera <b>%1</b> biscotti!",
  "You found an egg!": "Hai trovato un uovo!",
  "Eggs drop <b>%1%</b> more often.":
    "Aumenta del <b>%1%</b> il ritrovamento di uova.",
  ...
  "Contains an assortment of fancy biscuits.":
    "Contiene un sofisticato assortimento di biscotti.",
  "Contains an assortment of macarons.":
    "Contiene un assortimento di macarons.",
  "Contains an assortment of popular biscuits.":
    "Contiene un rinomato assortimento di biscotti.",
  ...
  "Contains an assortment of...something.":
    "Contiene un assortimento di... qualcosa.",
  ...
  "Pick an upgrade to make permanent":
    "Scegli un potenziamento da rendere permanente",
  ...
  "Unlocks the <b>cookie dragon egg</b>.":
    "Sblocca l'<b>uovo del drago biscottato</b>.",
  ...
  "Play through the game's sound files!":
    "Riproduci tutti i file audio del gioco!",
  Play: "Riproduci",
  Stop: "Arresta",
  Pause: "Pausa",
  ...
  "Contains more wallpapers for your background selector.":
    "Contiene altri sfondi per il tuo Selettore dello sfondo.",
  "Lets you pick which wallpaper to display.":
    "Ti permette di scegliere lo sfondo da mostrare.",
  ...
  "You can attract <b>%1 more wrinklers</b>.":
    "Puoi attrarre <b>%1 divoratori aggiuntivi</b>.",
  ...
  "Cookie production <b>reduced to 0</b>.":
    "La produzione di biscotti è <b>ridotta a 0</b>.",
  ...
  "May only be used once per ascension.":
    "Puoi utilizzarlo una singola volta per ogni ascensione.",
  ...
  "<b>+%1%</b> sugar lump growth.":
    "Crescita delle zollette di zucchero <b>aumentata del %1%</b>.",
  ...
  "Has a <b>%1%</b> chance to not break.":
    "Ha il <b>%1%</b> di probabilità di non lacerarsi.",
  ...
  "Hey, what's up. I'm a fortune cookie.":
    "Ehilà. Sono un biscotto della fortuna.",
  "You think you have it bad? Look at me.":
    "Credi che la tua vita sia difficile? Guardami.",
  ...
  "Kittens are <b>%1%</b> more effective.":
    "I felini sono più potenti del <b>%1%</b>.",
  ...
  "Seasonal cookies purchased: <b>%1</b>.":
    "Biscotti stagionali acquistati: <b>%1</b>.",
  "Reindeer cookies purchased: <b>%1</b>.":
    "Biscotti renna acquistati: <b>%1</b>.",
  ...
  "Some seasonal effects are boosted.":
    "Alcuni effetti stagionali vengono incrementati.",
  ...
  "Heavenly chips have %1% less effect.":
    "L'effetto delle scaglie celestiali è inferiore al %1%.",
  ...
  "You may now send and receive gifts with other players through buttons in the top-right of the %1 menu.":
    "Ora puoi inviare e ricevere regali con altri giocatori attraverso i pulsanti in alto a destra del menu %1.",
  "You need at least %1 cookies in bank to send and receive gifts.":
    "Ti servono almeno %1 biscotti nella banca per inviare e ricevere regali.",
  ...
  'Clicking "%1" will generate a text code you can send to others. Gift codes can be redeemed multiple times by anyone but expire after a day or two. You can only generate one gift code per hour. Your game will save after sending.':
    "Facendo clic su \"%1\", si genera un codice di testo che puoi inviare agli altri. I codici regalo possono essere riscattati più volte da chiunque, ma scadono dopo un paio di giorni. Puoi generare un solo codice regalo all'ora. Il gioco verrà salvato dopo l'invio.",
  "You may put between %1 and %2 cookies in the gift box.":
    "Puoi mettere tra %1 e %2 biscotti nella scatola regalo.",
  "You can leave a note. Don't be rude!<br>Maximum %1 lines and %2 characters.":
    "Puoi lasciare un biglietto. Non essere scortese!<br>Limite massimo di %1 righe e %2 caratteri.",
  "Once you redeem a gift, you will have to wait an hour before you can redeem another. Your game will save after redeeming.":
    "Dopo aver riscattato un regalo, dovrai aspettare un'ora prima di poterne riscattare un altro. Il gioco verrà salvato dopo la riscossione.",
  "Box design": "Design della scatola",
  Icon: "Icona",
  "Here's your gift code!<br>Make sure to copy it so you can share it.":
    "Ecco il tuo codice regalo!<br>Assicurati di copiarlo così da poterlo condividere.",
  "Code expired.": "Codice scaduto.",
  "Invalid code.": "Codice non valido.",
  "Gift redeemed!<br>Inside, you find:":
    "Regalo riscosso!<br>Al suo interno, trovi:",
  "There's a note too!": "C'è anche un biglietto!",
  "How nice!": "Che pensiero gentile!",
  "You've already sent or redeemed a gift recently.":
    "Hai già inviato o riscosso un regalo di recente.",
  Customize: "Personalizza",
  "Customize your clones": "Personalizza i tuoi cloni",
  "Sprung from your very DNA. Shape them in your image!":
    "Generati direttamente a partire dal tuo DNA. Plasmali a tua immagine e somiglianza!",
  Hair: "Capelli",
  ...
  "Won't you have some cookies too?":
    "Perché non prendi anche tu dei biscotti?",
  ...
  "Bake <b>%1</b> in one ascension.":
    "Inforna <b>%1</b> in una singola ascensione.",
  ...
  "Have at least <b>%1 of everything</b>.":
    "Possiedi almeno <b>%1 unità di ogni oggetto</b>.",
  ...
  "Trigger the grandmapocalypse for the first time.":
    "Attiva la nonnapocalisse per la prima volta.",
  ...
  "Declare a covenant with the grandmatriarchs.":
    "Stringi un'alleanza con le matriarche.",
  "Own at least <b>%1</b> grandma types.":
    "Possiedi almeno <b>%1</b> tipi di nonne.",
  ...
  "Reach <b>Santa's 7th form</b>.":
    "Raggiungi la <b>settima forma di Babbo Natale</b>.",
  "Reach <b>Santa's final form</b>.":
    "Raggiungi la <b>forma finale di Babbo Natale</b>.",
  ...
  "Poke a wrinkler <b>%1 times</b> without killing it.":
    "Infastidisci un divoratore <b>%1 volte</b> senza ucciderlo.",
  ...
  "Harvest a <b>bifurcated sugar lump</b>.":
    "Raccogli una <b>zolletta di zucchero biforcuta</b>.",
  "Harvest a <b>golden sugar lump</b>.":
    "Raccogli una <b>zolletta di zucchero dorata</b>.",
  "Harvest a <b>meaty sugar lump</b>.":
    "Raccogli una <b>zolletta di zucchero succosa</b>.",
  "Harvest a <b>caramelized sugar lump</b>.":
    "Raccogli una <b>zolletta di zucchero caramellata</b>.",
  "Reach level <b>%1</b> %2.":
    "Raggiungi il livello <b>%1</b> di queste strutture: %2.",
  ...
  "Harvest <b>%1</b> mature garden plants.":
    "Raccogli <b>%1</b> piante mature dal giardino.",
  ...
  "Make your first stock market profit.":
    "Guadagna i tuoi primi profitti nel mercato azionario.",
  ...
  "Take out a loan and ascend before incurring the CpS penalty.":
    "Richiedi un prestito prima di subire la penalità di B/s.",
  ...
  "Redeem a cookie gift code from a friend (or from yourself, we don't judge).":
    "Riscatta un codice regalo di biscotti da un amico (o anche da te, tanto non ti giudichiamo).",
  "Shape your clones to resemble %1.":
    "Plasma i tuoi cloni in modo che assumano le sembianze di %1.",
  Clone: "/",
  ...
  "Cookie production %1% slower for %2!":
    "Produzione di biscotti rallentata del %1% per %2!",
  "Cookie production halved for %1!":
    "Produzione di biscotti dimezzata per %1!",
  ...
  "Can't send or receive gifts again for %1.":
    "Non puoi inviare o ricevere ancora regali per %1.",
  ...
  "Combined effects of all your plants:":
    "Effetto combinato di tutte le tue piante:",
  "None.": "nessuno.",
  ...
  "%1 to harvest only mature, mortal plants.":
    "%1 per raccogliere solo piante mortali mature.",
  ...
  "Garden is frozen. Unfreeze to resume.":
    "Il giardino è congelato. Scongelalo per riprendere.",
  ...
  "harvest when mature for a sugar lump":
    "raccoglile da mature per 1 zolletta di zucchero",
  useless: "inutile",
  ...
  "may sometimes drop spores when uprooted":
    "a volte può far cadere spore se sradicata",
  ...
  "Your field is currently using this soil.":
    "Il tuo campo sta usando attualmente questo terreno.",
  ...
  "Click to select this seed for planting.":
    "Fai clic per selezionare questo seme per la semina.",
  ...
  "Mature plants harvested: %1 (total: %2)":
    "Piante mature raccolte: %1 (totale: %2)",
  ...
  "You magic <b>%1</b> out of thin air.":
    "<B>%1</b> della tua magia svanisce nel nulla.",
  ...
  "A new %1<br>bursts out of the ground.":
    "Un nuovo %1<br>è sbucato fuori dal terreno.",
  ...
  "Upgrades are %1% cheaper for 1 minute.":
    "I potenziamenti sono meno cari del %1% per 1 minuto.",
  ...
  "Buildings are %1% cheaper for 1 minute.":
    "Le strutture sono meno care del %1% per 1 minuto.",
  "Buildings are %1% more expensive for an hour.":
    "Le strutture sono più care del %1% per un'ora.",
  ...
  "That's too bad!<br>Magic refunded.":
    "È un vero peccato!<br>Magia rimborsata.",
  ...
  "[GOD 1 NAME]Holobore, Spirit of Asceticism":
    "Holobore, spirito dell'ascetismo",
  ...
  "[GOD 2 NAME]Vomitrax, Spirit of Decadence":
    "Vomitrax, spirito della decadenza",
  ...
  "[GOD 5 NAME]Selebrak, Spirit of Festivities":
    "Selebrak, spirito delle festività",
  ...
  "[GOD 6 NAME]Dotjeiess, Spirit of Creation":
    "Dotjeiess, spirito della creazione",
  ...
  "Release to assign %1 to this slot.":
    "Rilascia per assegnare %1 a questo slot.",
  ...
  "%1: currently worth <b>$%2</b> per unit.":
    "%1: attualmente vale <b>$%2</b> per unità.",
  "You currently own %1 (worth <b>$%2</b>).":
    "Attualmente possiedi %1 (valore: <b>$%2</b>).",
  "Your warehouses can store up to %1.":
    "Il tuo magazzino può ospitare fino a %1.",
  ...
  "+%1 warehouse space for all goods":
    "+%1 spazio di immagazzinamento per tutte le merci",
  ...
  "A nice broker to trade more cookies.":
    "Un abile broker per lo scambio di più biscotti.",
  Hire: "Assumi",
  ...
  "Hiring a new broker will cost you %1.":
    "Assumere un nuovo broker ti costerà %1.",
  ...
  "[Upgrade name 1]Carpal tunnel prevention cream":
    "Crema di prevenzione del tunnel carpale",
  ...
  "[Upgrade name 13]Sturdier conveyor belts":
    "Nastri trasportatori più robusti",
  ...
  "[Upgrade name 29]Time paradox resolver":
    "Risoluzione del paradosso temporale",
  ...
  "[Upgrade name 40]Double-chip cookies":
    "Biscotti con doppie scaglie di cioccolato",
  ...
  "[Upgrade name 45]Genetically-modified cookies":
    "Biscotti geneticamente modificati",
  ...
  "[Upgrade name 56]White chocolate-coated cookies":
    "Biscotti ricoperti di cioccolato bianco",
  ...
  "[Upgrade name 64]Bingo center/Research facility":
    "Sala bingo/struttura di ricerca",
  "[Upgrade name 65]Specialized chocolate chips":
    "Scaglie di cioccolato specializzate",
  ...
  "[Upgrade name 111]Gingerbread scarecrows":
    "Spaventapasseri di pan di zenzero",
  ...
  "[Upgrade name 147]Candy cane biscuits":
    "Biscotti a forma di bastoncino di zucchero",
  ...
  "[Upgrade name 163]Santa's bottomless bag":
    "Sacco senza fondo di Babbo Natale",
  ...
  "[Upgrade name 166]Santa's milk and cookies":
    "Latte e biscotti di Babbo Natale",
  ...
  "[Upgrade name 199]Far future enactment":
    "Rappresentazione di un futuro lontano",
  ...
  "[Upgrade name 236]Exponential interest rates":
    "Tassi d'interesse esponenziali",
  ...
  "[Upgrade name 256]Pure black chocolate cookies":
    "Biscotti al puro cioccolato fondente",
  "[Upgrade name 257]Pure white chocolate cookies":
    "Biscotti al puro cioccolato bianco",
  ...
  "[Upgrade name 281]Twin Gates of Transcendence":
    "Cancelli gemelli della trascendenza",
  ...
  "[Upgrade name 302]Theory of atomic fluidity":
    "Teoria della fluidità atomica",
  "[Upgrade name 303]End of times back-up plan":
    "Piano B per la fine dei tempi",
  ...
  "[Upgrade name 317]Cookietopian moments of maybe":
    "Storie di futuri biscottati alternativi",
  ...
  "[Upgrade name 335]Dark chocolate butter biscuit":
    "Biscotti al burro e cioccolato fondente",
  "[Upgrade name 336]White chocolate butter biscuit":
    "Biscotti al burro e cioccolato bianco",
  "[Upgrade name 337]Ruby chocolate butter biscuit":
    "Biscotti al burro e cioccolato rosa",
  ...
  "[Upgrade name 360]Golden cookie alert sound":
    "Avviso acustico dei biscotti dorati",
  "[Upgrade name 361]Golden cookie sound selector":
    "Selettore audio dei biscotti dorati",
  ...
  "[Upgrade name 397]Distilled essence of redoubled luck":
    "Essenza distillata di duplice fortuna",
  ...
  "[Upgrade name 454]Peanut butter blossoms":
    "Biscotti con topping al burro di arachidi",
  ...
  "[Upgrade name 487]Restaurants at the end of the universe":
    "Ristoranti ai confini dell'universo",
  ...
  "[Upgrade name 560]One lone chocolate chip":
    "Scaglia di cioccolato solitaria",
  ...
  "[Upgrade name 567]Chocolate chip mocha cookies":
    "Biscotti al caffè con scaglie di cioccolato",
  ...
  "[Upgrade name 591]Cosmic beginner's luck":
    "Fortuna del principiante cosmica",
  ...
  "[Upgrade name 594]The JavaScript console for dummies":
    "Console javascript per principianti",
  ...
  "[Upgrade name 655]Peanut butter cup cookies":
    "Biscotti farciti al burro di arachidi",
  ...
  "[Upgrade name 659]Cosmic chocolate butter biscuit":
    "Biscotti al burro e cioccolato cosmico",
  ...
  "[Upgrade name 696]Perforated mille-feuille cosmos":
    "Universi millefoglie perforati",
  ...
  "[Upgrade name 746]N-dimensional assembly lines":
    "Catene di montaggio n-dimensionali",
  ...
  "[Upgrade name 790]Unshackled chalcedhoney":
    "Miele di calcedonio senza catene",
  ...
  "[Upgrade name 794]Unshackled cherrysilver":
    "Ciliegia argentata senza catene",
  ...
  "[Upgrade name 798]Unshackled alabascream":
    "Panna all'alabastro senza catene",
  ...
  "[Upgrade name 815]Marshmallow sandwich cookies":
    "Biscotti ripieni di marshmallow",
  ...
  "[Upgrade name 847]At your doorstep in 30 minutes or your money back":
    "A casa tua in 30 minuti o riceverai un rimborso",
  ...
  "[Upgrade name 852]Lab goggles but like cool shades":
    "Occhiali da laboratorio, ma cool",
  ...
  "[Upgrade name 858]Reading your clones bedtime stories":
    "Lettura di fiabe della buonanotte ai tuoi cloni",
  ...
  "[Achievement name 2]So baked right now":
    "Biscotti fatti (e lo sono anch'io)",
  ...
  "[Achievement name 70]Cheated cookies taste awful":
    "I biscotti truccati sono disgustosi",
  ...
  "[Achievement name 235]Woops, you solved world hunger":
    "Ops, hai risolto la fame nel mondo",
  ...
  "[Achievement name 313]It belongs in a bakery":
    "Quella dovrebbe stare in una pasticceria",
  ...
  "[Achievement name 336]Let's leaf it at that":
    "Lasciamo le foglie come stanno",
  ...
  "[Achievement name 340]But wait 'til you get older":
    "Aspetta fin quando non diventi vecchio",
  ...
  "[Achievement name 347]That's just peanuts to space":
    "È una briciola in confronto allo spazio",
  "[Achievement name 348]Worth its weight in lead":
    "Vale il suo peso in piombo",
  ...
  "[Achievement name 371]Green cookies sleep furiously":
    "Verdi biscotti dormono furiosamente",
  "[Achievement name 372]Panic! at Nabisco":
    "Paura e delirio alla Mulino bianco",
  ...
  "[Achievement name 397]When the cookies ascend just right":
    "La perfetta ascensione dei biscotti",
  ...
  "[Achievement name 406]Only shooting stars":
    "Allora, ci sono dei ciuchini lassù?",
  ...
  "[Achievement name 467]What did we even eat before these":
    "Cosa mangiavamo prima dei biscotti?",
  ...
  "[Achievement name 472]It's only wafer-thin":
    "È solo una sfoglia sottilissima",
  ...
  "[Achievement name 484]Don't let me leave, Murph":
    "Murph, non lasciarmi andare via",
  ...
  "[Achievement name 502]Reduced to gibbering heaps":
    "Ridotto a un ammasso farfugliante",
  ...
  "[Achievement name 505]Making light of the situation":
    "Facciamo luce sulla situazione",
  ...
  "[Achievement name 521]Reject reality, substitute your own":
    "Rifiuta la realtà, imponi la tua",
  ...
  "[Achievement name 542]The organ that named itself":
    "L'organo che si è dato un nome da solo",
  ...
  "[Achievement name 548]Though fools seldom differ":
    "Gli sciocchi sono spesso in disaccordo",
  ...
  "[Achievement name 578]Fake it till you bake it":
    "Fingi fino a cottura ultimata",
  "[Achievement name 579]History in the baking":
    "La storia fatta dai panettieri",
  ...
  "[Achievement name 591]Speed's the name of the game (no it's not it's called Cookie Clicker)":
    "Velocità è il nome del gioco (non è vero, si chiama Cookie Clicker)",

AddLanguage("PT-BR", "portuguese", {
  ...
  "numbers that pop up when clicking the cookie":
    "números que são exibidos ao clicar no cookie ",
  "Milk [setting]": "Leite",
  ...
  "notifications disappear much faster":
    "as notificações desaparecem muito mais rápido",
  ...
  "add options on buildings like Mute":
    "adiciona opções em construções, como Silenciar",
  ...
  "note: this will save and reload your game":
    "obs.: isso fará o jogo salvar e reiniciar",
  ...
  "at %1% of its potential <b>(+%2% CpS)</b>":
    "Em %1% de seu potencial <b>(+%2% CpS)</b>",
  ...
  "Note: links will open in your web browser.":
    "Obs.: os links abrirão em seu navegador.",
  "Note: older update notes are in English.":
    "Obs.: notas de atualização antigas estão em inglês.",
  ...
  "Cookie Clicker is in sleep mode.":
    "O Cookie Clicker está no modo de suspensão.",
  ...
  "%1 to resume from your save file.":
    "%1 para continuar do seu arquivo de salvamento.",
  ...
  "Use this to keep backups on your computer":
    "Use isso para manter os backups no seu computador",
  ...
  "You earned <b>%1</b> while you were away.":
    "Você ganhou <b>%1</b> enquanto esteve fora.",
  Mods: "/",
  ...
  "Mods are loaded from top to bottom.":
    "Mods são carregados de cima para baixo.",
  ...
  "view and delete save data created by mods":
    "visualizar e excluir dados criados pelos mods",
  ...
  "What should your bakery's name be?":
    "Qual deve ser o nome da sua confeitaria?",
  ...
  "You harvested <b>%1</b> while you were away.":
    "Você colheu <b>%1</b> enquanto esteve fora.",
  ...
  "Sugar lump cooldowns cleared!":
    "Tempos de espera de torrões de açúcar zerados!",
  ...
  "Cookie chain over. You made %1.":
    "Corrente de cookies terminada. Você conseguiu %1.",
  ...
  "You find a present which contains...":
    "Você encontra um presente que contém...",
  Evolve: "Evoluir",
  ...
  "Set your dragon's secondary aura":
    "Determine a aura secundária do seu dragão",
  "Select an aura from those your dragon knows.":
    "Selecione uma das auras que seu dragão conhece.",
  ...
  "Your cookies are popular in the neighborhood.":
    "Seus cookies são populares na vizinhança.",
  ...
  "Your cookies are renowned in the whole town!":
    "Seus cookies são famosos na cidade toda!",
  "Your cookies bring all the boys to the yard.":
    "Seus cookies atraem todo mundo.",
  "Your cookies now have their own website!":
    "Agora seus cookies têm o próprio site.",
  ...
  "There are now museums dedicated to your cookies.":
    "Há novos museus dedicados aos seus cookies.",
  ...
  "The whole planet is enjoying your cookies!":
    "O planeta todo está curtindo os seus cookies!",
  ...
  "Your cookies have achieved sentience.":
    "Seus cookies adquiriram senciência.",
  ...
  "Wish granted. Golden cookie spawned.":
    "Desejo concedido. Um cookie dourado surgiu.",
  "help me!": "Me ajuda!",
  Ascend: "Ascender",
  "You've been on this run for <b>%1</b>.":
    "Você está nesta sequência há <b>%1</b>.",
  ...
  "Ascending now would grant you no prestige.":
    "Ascender agora não te daria nenhum prestígio.",
  ...
  "You will keep your achievements.":
    "Você vai continuar com as suas conquistas.",
  ...
  "Are you ready to return to the mortal world?":
    "Tudo pronto para voltar para o mundo mortal?",
  "Hello, cookies!": "Olá, cookies!",
  "Challenge mode for the next run:":
    "Modo de desafio para a próxima sequência:",
  ...
  "each %1 produces <b>%2</b> per second":
    "cada %1 produz <b>%2</b> por segundo",
  ...
  "...also boosting some other buildings:":
    "...também impulsionando algumas outras construções:",
  ...
  "[Factory quote]Produces large quantities of cookies.":
    "Produz grandes quantidades de cookies.",
  ...
  "[Bank quote]Generates cookies from interest.":
    "Gera cookies a partir dos juros.",
  ...
  "[Temple quote]Full of precious, ancient chocolate.":
    "Cheio de um antigo e precioso chocolate.",
  ...
  "[Portal quote]Opens a door to the Cookieverse.":
    "Abre um portal para o Cookieverso.",
  ...
  "[Prism quote]Converts light itself into cookies.":
    "Converte a própria luz em cookies.",
  ...
  "[You quote]You, alone, are the reason behind all these cookies. You figure if there were more of you... maybe you could make even more.":
    "Você, sozinho, é a razão por trás de todos esses cookies. Você imagina que se houvesse mais de você... talvez você pudesse fazer ainda mais.",
  ...
  "[You business quote]Your business is as great as it's gonna get. The only real way to improve it anymore is to improve yourself - and become the best CEO this world has ever seen.":
    "Seu negócio está tão bom quanto poderia ficar. A única maneira real de melhorá-lo mais é melhorar a si mesmo - e se tornar o melhor CEO que este mundo já viu.",
  CpS: "/",
  ...
  "Cookie production multiplier <b>+%1%</b>.":
    "Multiplicador da produção de cookies <b>+%1%</b>.",
  ...
  "Each %1 gains <b>+%2 base CpS per %3</b>.":
    "Cada %1 ganha <b>+%2 de CpS base por %3</b>.",
  ...
  "Time remaining until pledge runs out:":
    "Tempo restante até o juramento acabar: ",
  "You haven't pledged to the elders yet.":
    "Você ainda não fez um juramento para as ancestrais.",
  ...
  "Research takes only <b>5 seconds</b>.":
    "A pesquisa leva apenas <b>5 segundos</b>.",
  ...
  "Golden cookies stay <b>%1%</b> longer.":
    "Cookies dourados ficam por <b>%1%</b> mais tempo.",
  "Golden cookies give <b>%1%</b> more cookies.":
    "Cookies dourados dão <b>%1%</b> mais cookies.",
  "Wrath cookies give <b>%1%</b> more cookies.":
    "Cookies da ira dão <b>%1%</b> mais cookies.",
  ...
  "Elder pledges last <b>twice</b> as long.":
    "Juramentos ancestrais duram <b>duas vezes</b> mais.",
  ...
  "Wrinklers spawn much more frequently.":
    "Os enrugadores surgem com muito mais frequência.",
  ...
  "Wrinklers digest <b>%1% more cookies</b>.":
    "Enrugadores digerem <b>%1% mais cookies</b>.",
  ...
  "a festive test tube<br>and <b>%1</b>.":
    "um tubo de ensaio festivo<br>e <b>%1</b>.",
  ...
  "Cost scales with how many eggs you own.":
    "O custo aumenta com o número de ovos obtidos.",
  ...
  "Reindeer are <b>twice as slow</b>.":
    "As renas são <b>duas vezes mais lentas</b>.",
  "Reindeer give <b>twice as much</b>.":
    "As renas rendem <b>duas vezes mais</b>.",
  ...
  "All buildings are <b>%1% cheaper</b>.":
    "Todas as construções são <b>%1% mais baratas</b>.",
  "All upgrades are <b>%1% cheaper</b>.":
    "Todas as melhorias são <b>%1% mais baratas</b>.",
  ...
  "Random drops are <b>%1% more common</b>.":
    "Bônus aleatórios são <b>%1% mais comuns</b>.",
  "Reindeer spawn much more frequently.":
    "Renas surgem com muito mais frequência.",
  ...
  "The egg bursts into <b>%1</b> cookies!":
    "O ovo se divide em <b>%1</b> cookies!",
  "You found an egg!": "Você encontrou um ovo!",
  "Eggs drop <b>%1%</b> more often.":
    "Ovos aparecem com uma frequência <b>%1%</b> maior.",
  ...
  "Pick an upgrade to make permanent":
    "Escolha uma melhoria para tornar permanente",
  ...
  "Unlocks the <b>cookie dragon egg</b>.":
    "Desbloqueia o <b>ovo do dragão de cookie</b>.",
  ...
  "Contains more wallpapers for your background selector.":
    "Contém mais papéis de parede para seu seletor de planos de fundo.",
  "Lets you pick which wallpaper to display.":
    "Deixa você escolher qual papel de parede exibir.",
  ...
  "You can attract <b>%1 more wrinklers</b>.":
    "Você pode atrair <b>%1 mais enrugadores</b>.",
  ...
  "Cookie production <b>reduced to 0</b>.":
    "Produção de cookies <b>reduzida a 0</b>.",
  ...
  "May only be used once per ascension.":
    "Só pode ser usado uma vez por ascensão.",
  ...
  "<b>+%1%</b> sugar lump growth.":
    "<b>+%1%</b> de crescimento do torrão de açúcar.",
  "Sugar lumps ripen <b>%1</b> sooner.":
    "Torrões de açúcar ficam prontos <b>%1</b> mais rápido.",
  "Sugar lumps mature <b>%1</b> sooner.":
    "Torrões de açúcar amadurecem <b>%1</b> mais rápido.",
  ...
  "Has a <b>%1%</b> chance to not break.":
    "Tem uma chance de <b>%1%</b> de não partir.",
  ...
  "Remember to visit your %1 sometimes.":
    "Lembre de visitar %1 de vez em quando.",
  ...
  "Hey, what's up. I'm a fortune cookie.":
    "Ei, e aí? Eu sou um biscoito da sorte.",
  "You think you have it bad? Look at me.":
    "Você acha que tá ruim pra você? Olha pra mim.",
  ...
  "Kittens are <b>%1%</b> more effective.":
    "Gatinhos são <b>%1%</b> mais eficientes.",
  ...
  "Each rank of milk boosts %1 CpS by <b>%2%</b>.":
    "Nível da leite aumenta CpS %1 em <b>%2%</b>.",
  ...
  "Seasonal cookies purchased: <b>%1</b>.":
    "Cookies sazonais comprados: <b>%1</b>.",
  "Reindeer cookies purchased: <b>%1</b>.":
    "Cookies de rena comprados: <b>%1</b>.",
  ...
  "Golden and wrath cookies appear %1% more.":
    "Cookies dourados e furiosos aparecem %1% mais.",
  "Golden and wrath cookies appear %1% less.":
    "Cookies dourados e furiosos aparecem %1% menos.",
  ...
  "Some seasonal effects are boosted.":
    "Alguns efeitos de temporada são aumentados.",
  ...
  "Heavenly chips have %1% less effect.":
    "Gotas divinas são %1% menos eficientes.",
  ...
  "You may now send and receive gifts with other players through buttons in the top-right of the %1 menu.":
    "Agora você pode enviar e receber presentes de outros jogadores através dos botões no canto superior direito do menu %1.",
  "You need at least %1 cookies in bank to send and receive gifts.":
    "Você precisa ter pelo menos %1 cookies no banco para enviar e receber presentes.",
  ...
  'Clicking "%1" will generate a text code you can send to others. Gift codes can be redeemed multiple times by anyone but expire after a day or two. You can only generate one gift code per hour. Your game will save after sending.':
    'Clicar em "%1" gerará um código de texto que você pode enviar para outros. Os códigos de presente podem ser resgatados várias vezes por qualquer um, mas expiram após um ou dois dias. Você só pode gerar um código de presente por hora. Seu jogo será salvo após o envio.',
  "You may put between %1 and %2 cookies in the gift box.":
    "Você pode colocar entre %1 e %2 cookies na caixa de presente.",
  "You can leave a note. Don't be rude!<br>Maximum %1 lines and %2 characters.":
    "Você pode deixar um recado. Não seja grosso!<br>Máximo de %1 linhas e %2 caracteres.",
  "Once you redeem a gift, you will have to wait an hour before you can redeem another. Your game will save after redeeming.":
    "Depois de resgatar um presente, você terá que esperar uma hora antes de poder resgatar outro. Seu jogo será salvo após o resgate.",
  "Box design": "Design da caixa",
  Icon: "Ícone",
  "Here's your gift code!<br>Make sure to copy it so you can share it.":
    "Aqui está o seu código de presente!<br>Certifique-se de copiá-lo para poder compartilhar.",
  "Code expired.": "Código expirado.",
  "Invalid code.": "Código inválido.",
  "Gift redeemed!<br>Inside, you find:":
    "Presente resgatado!<br>Dentro, você encontra:",
  "There's a note too!": "Tem um recado também!",
  "How nice!": "Que legal!",
  "You've already sent or redeemed a gift recently.":
    "Você já enviou ou resgatou um presente recentemente.",
  Customize: "Personalizar",
  "Customize your clones": "Personalize seus clones",
  "Sprung from your very DNA. Shape them in your image!":
    "Criados a partir do seu próprio DNA. Molde-os à sua imagem!",
  Hair: "Cabelo",
  ...
  "Have at least <b>%1 of everything</b>.":
    "Tenha pelo menos <b>%1 de tudo</b>.",
  ...
  "Trigger the grandmapocalypse for the first time.":
    "Acione o vovócalipse pela primeira vez.",
  ...
  "Declare a covenant with the grandmatriarchs.":
    "Entre em um pacto com as vótriarcas.",
  "Own at least <b>%1</b> grandma types.":
    "Tenha pelo menos <b>%1</b> tipos de vovó.",
  ...
  "Reach <b>Santa's final form</b>.":
    "Alcance a <b>Forma final do Papai Noel</b>.",
  ...
  "Complete your <b>dragon's training</b>.":
    "Conclua o <b>treinamento do seu dragão</b>.",
  "Click on the news ticker <b>%1 times</b>.":
    "Clique no quadro de notícias <b>%1 vezes</b>.",
  ...
  "Poke a wrinkler <b>%1 times</b> without killing it.":
    "Cutuque um enrugador <b>%1 vezes</b> sem matá-lo.",
  ...
  "Harvest <b>%1 coalescing sugar lumps</b>.":
    "Colete <b>%1 torrões de açúcar coalescentes</b>.",
  ...
  "Harvest a <b>bifurcated sugar lump</b>.":
    "Colete um <b>torrão de açúcar bifurcado</b>.",
  "Harvest a <b>golden sugar lump</b>.":
    "Colete um <b>torrão de açúcar dourado</b>.",
  "Harvest a <b>meaty sugar lump</b>.":
    "Colete um <b>torrão de açúcar carnudo</b>.",
  "Harvest a <b>caramelized sugar lump</b>.":
    "Colete um <b>torrão de açúcar caramelizado</b>.",
  ...
  "Harvest <b>%1</b> mature garden plants.":
    "Colete <b>%1</b> plantas de jardim maduras.",
  ...
  "Make your first stock market profit.":
    "Faça seu primeiro lucro no mercado de ações.",
  ...
  "Take out a loan and ascend before incurring the CpS penalty.":
    "Pegue um empréstimo e ascenda antes de incorrer na penalidade de CpS.",
  "Own <b>%1</b> kitten upgrades.": "Adquira <b>%1</b> melhorias de gatinho.",
  "Find the <b>forgotten madeleine</b>.":
    "Encontre a <b>madeleine esquecida</b>.",
  ...
  "Redeem a cookie gift code from a friend (or from yourself, we don't judge).":
    "Resgate um código de presente de cookie de um amigo (ou de si mesmo, não julgamos).",
  "Shape your clones to resemble %1.":
    "Molde seus clones para se parecerem com %1.",
  Clone: "Clonar",
  ...
  "Cookie production %1% slower for %2!":
    "Produção de cookies %1% mais lenta por %2!",
  ...
  "All buildings are %1% cheaper for %2!":
    "Todas as construções são %1% mais baratas por %2!",
  "All buildings are %1% pricier for %2!":
    "Todas as construções são %1% mais caras por %2!",
  "All upgrades are %1% cheaper for %2!":
    "Todas as melhorias são %1% mais baratas por %2!",
  "All upgrades are %1% pricier for %2!":
    "Todas as melhorias são %1% mais caras por %2!",
  ...
  "Spells backfire %1 times less for %2.":
    "Feitiços dão errado %1 vezes menos por %2.",
  "Spells backfire %1 times more for %2.":
    "Feitiços dão errado %1 vezes mais por %2.",
  "Can't send or receive gifts again for %1.":
    "Não é possível enviar ou receber presentes novamente por %1.",
  ...
  "Combined effects of all your plants:":
    "Efeitos combinados de todas as suas plantas:",
  "None.": "Nenhum.",
  ...
  "%1 to harvest only mature, mortal plants.":
    "%1 para colher apenas plantas maduras e mortais.",
  ...
  "Garden is frozen. Unfreeze to resume.":
    "O jardim está congelado. Descongele-o para continuar.",
  ...
  "harvest when mature for a sugar lump":
    "colha quando estiver madura por um torrão de açúcar",
  useless: "inútil",
  ...
  "may sometimes drop spores when uprooted":
    "às vezes soltam esporos quando arrancadas",
  ...
  "Your field is currently using this soil.":
    "Seu campo já está utilizando esse solo.",
  ...
  "Click to select this seed for planting.":
    "Clique para selecionar essa semente para plantar.",
  ...
  "Mature plants harvested: %1 (total: %2)":
    "Plantas maduras colhidas: %1 (total: %2)",
  ...
  "Backfired, but no buildings to destroy!":
    "Falhou, mas não há construções a serem destruídas!",
  "A new %1<br>bursts out of the ground.":
    "Uma nova construção de %1<br>surge do chão.",
  ...
  "Upgrades are %1% cheaper for 1 minute.":
    "Melhorias ficam %1% mais baratas por 1 minuto.",
  "Upgrades are %1% more expensive for an hour.":
    "Melhorias ficam %1% mais caras por 1 hora.",
  ...
  "Buildings are %1% cheaper for 1 minute.":
    "Construções ficam %1% mais baratas por 1 minuto.",
  "Buildings are %1% more expensive for an hour.":
    "Construções ficam %1% mais caras por 1 hora.",
  ...
  "[GOD 1 NAME]Holobore, Spirit of Asceticism":
    "Holobore, Espírito do Asceticismo",
  ...
  "[GOD 2 NAME]Vomitrax, Spirit of Decadence":
    "Vomitrax, Espírito da Decadência",
  ...
  "[GOD 5 NAME]Selebrak, Spirit of Festivities":
    "Selebrak, Espírito das Festividades",
  ...
  "Drag a spirit onto this slot to assign it.":
    "Arraste um espírito pra atribuí-lo a esse espaço.",
  ...
  "%1: currently worth <b>$%2</b> per unit.":
    "%1: vale atualmente <b>$%2</b> por unidade.",
  "You currently own %1 (worth <b>$%2</b>).":
    "Atualmente você tem %1 (valendo <b>$%2</b>).",
  ...
  "+%1 warehouse space for all goods":
    "+%1 espaço de armazém pra todos os produtos",
  ...
  "A nice broker to trade more cookies.":
    "Um ótimo corretor para negociar mais cookies.",
  Hire: "Contratar",
  ...
  "Hiring a new broker will cost you %1.":
    "Contratar um novo corretor custará %1.",
  ...
  "[Upgrade name 1]Carpal tunnel prevention cream":
    "Creme preventivo do túnel do carpo",
  ...
  "[Upgrade name 13]Sturdier conveyor belts":
    "Correias transportadoras resistentes",
  ...
  "[Upgrade name 42]All-chocolate cookies":
    "Cookies de chocolate com massa de chocolate",
  ...
  "[Upgrade name 45]Genetically-modified cookies":
    "Cookies geneticamente modificados",
  ...
  "[Upgrade name 56]White chocolate-coated cookies":
    "Cookies com cobertura de chocolate branco",
  ...
  "[Upgrade name 64]Bingo center/Research facility":
    "Centro de bingo/Instalação de pesquisa",
  "[Upgrade name 65]Specialized chocolate chips":
    "Gotas de chocolate especializadas",
  ...
  "[Upgrade name 130]Heavenly cookie stand":
    "Barraquinha de cookies celestiais",
  ...
  "[Upgrade name 233]Scissor-resistant credit cards":
    "Cartões de crédito resistentes a tesouras",
  ...
  "[Upgrade name 256]Pure black chocolate cookies":
    "Cookies de puro chocolate meio-amargo",
  "[Upgrade name 257]Pure white chocolate cookies":
    "Cookies de puro chocolate branco",
  ...
  "[Upgrade name 281]Twin Gates of Transcendence":
    "Portões duplos da transcendência",
  ...
  "[Upgrade name 303]End of times back-up plan":
    "Plano de contingência do fim dos tempos",
  ...
  "[Upgrade name 317]Cookietopian moments of maybe":
    "Momentos cookietopicos do talvez",
  ...
  "[Upgrade name 329]Fanciful dairy selection":
    "Seleção extravagante de laticínios",
  ...
  "[Upgrade name 334]Milk chocolate butter biscuit":
    "Biscoito amanteigado de chocolate ao leite",
  ...
  "[Upgrade name 336]White chocolate butter biscuit":
    "Biscoito amanteigado de chocolate branco",
  "[Upgrade name 337]Ruby chocolate butter biscuit":
    "Biscoito amanteigado de chocolate rubi",
  ...
  "[Upgrade name 360]Golden cookie alert sound":
    "Som de notificação de cookie dourado",
  "[Upgrade name 361]Golden cookie sound selector":
    "Seletor de som de cookie dourado",
  "[Upgrade name 362]Basic wallpaper assortment":
    "Seleção de papéis de parede básicos",
  ...
  "[Upgrade name 397]Distilled essence of redoubled luck":
    "Essência destilada de sorte redobrada",
  ...
  "[Upgrade name 420]A recipe book about books":
    "Um livro de receitas sobre livros",
  ...
  "[Upgrade name 451]Sugar aging process":
    "Processo de amadurecimento do açúcar",
  ...
  "[Upgrade name 480]Timeproof hair dyes":
    "Tonalizante de cabelo à prova do tempo",
  ...
  "[Upgrade name 487]Restaurants at the end of the universe":
    "Restaurantes no fim do universo",
  ...
  "[Upgrade name 527]One particularly good-humored cow":
    "Uma vaca particularmente de bom-humor",
  ...
  "[Upgrade name 567]Chocolate chip mocha cookies":
    "Cookies de mocha e gotas de chocolate",
  ...
  "[Upgrade name 581]French pure butter cookies":
    "Biscoitos amanteigados franceses",
  ...
  "[Upgrade name 594]The JavaScript console for dummies":
    "Console JavaScript para leigos",
  ...
  "[Upgrade name 655]Peanut butter cup cookies":
    "Cookies de bombom de manteiga de amendoim",
  ...
  "[Upgrade name 659]Cosmic chocolate butter biscuit":
    "Biscoito amanteigado de chocolate cósmico",
  ...
  "[Upgrade name 682]Raspberry cheesecake cookies":
    "Cookies de cheesecake de framboesa",
  ...
  "[Upgrade name 696]Perforated mille-feuille cosmos":
    "Cosmos perfurado de mil-folhas",
  ...
  "[Upgrade name 699]Butter biscuit (with butter)":
    "Biscoito amanteigado (com manteiga)",
  ...
  "[Upgrade name 704]Diminishing tax returns":
    "Diminuição das declaração fiscais",
  ...
  "[Upgrade name 746]N-dimensional assembly lines":
    "Linhas de montagem N-dimensionais",
  ...
  "[Upgrade name 777]Unshackled alchemy labs":
    "Laboratórios de alquimia libertados",
  ...
  "[Upgrade name 780]Unshackled antimatter condensers":
    "Condensadores antimatéria libertados",
  ...
  "[Upgrade name 804]Distinguished wallpaper assortment":
    "Seleção de papéis de parede distintos",
  ...
  "[Upgrade name 815]Marshmallow sandwich cookies":
    "Cookies de sanduíche de marshmallow",
  ...
  "[Upgrade name 847]At your doorstep in 30 minutes or your money back":
    "Na sua porta em 30 minutos ou seu dinheiro de volta",
  ...
  "[Upgrade name 852]Lab goggles but like cool shades":
    "Óculos de laboratório, mas igual óculos maneiros",
  "[Upgrade name 853]Gambler's fallacy fallacy":
    "Falácia da falácia do apostador",
  ...
  "[Upgrade name 858]Reading your clones bedtime stories":
    "Ler histórias de ninar para seus clones",
  ...
  "[Achievement name 70]Cheated cookies taste awful":
    "Cookies trapaceados têm um gosto horrível",
  ...
  "[Achievement name 149]The old never bothered me anyway":
    "As idosas não vão mesmo me incomodar",
  ...
  "[Achievement name 196]Too many rabbits, not enough hats":
    "Muitos coelhos para poucas cartolas",
  ...
  "[Achievement name 202]A still more glorious dawn":
    "Um amanhecer ainda mais glorioso",
  ...
  "[Achievement name 224]The land of milk and cookies":
    "A terra do leite e dos cookies",
  ...
  "[Achievement name 226]Tonight on Hoarders":
    "Hoje em Acumuladores Compulsivos",
  ...
  "[Achievement name 235]Woops, you solved world hunger":
    "Ops, você solucionou a fome mundial",
  ...
  "[Achievement name 260]Scientists baffled everywhere":
    "Cientistas perplexos pelo mundo inteiro",
  ...
  "[Achievement name 313]It belongs in a bakery":
    "Deveria estar em uma confeitaria",
  ...
  "[Achievement name 328]Million to one shot, doc":
    "Uma chance em um milhão, doutor",
  ...
  "[Achievement name 347]That's just peanuts to space":
    "É só um amendoim em relação ao espaço",
  ...
  "[Achievement name 350]Invited to yesterday's party":
    "Convidado para a festa de ontem",
  ...
  "[Achievement name 371]Green cookies sleep furiously":
    "Cookies verdes dormem furiosamente",
  ...
  "[Achievement name 397]When the cookies ascend just right":
    "Quando os cookies ascendem no ponto",
  "[Achievement name 398]With her finger and her thumb":
    "Com seu dedo e seu dedão",
  ...
  "[Achievement name 411]You'll never shine if you don't glow":
    "Você não vai brilhar desse jeito",
  ...
  "[Achievement name 449]You're #1 so why try harder":
    "Sou o nº 1, então para que me esforçar?",
  "[Achievement name 450]Haven't even begun to peak":
    "Nem comecei a me destacar",
  ...
  "[Achievement name 466]Quincentennial and a half":
    "Um quinto centenário e meio",
  "[Achievement name 467]What did we even eat before these":
    "E o que a gente comia antes disso?",
  ...
  "[Achievement name 509]They'll never know what hit 'em":
    "Nunca vão saber o que os atingiu",
  ...
  "[Achievement name 558]Don't let the walls cave in on you":
    "Não deixe os muros caírem em você",
  ...
  "[Achievement name 561]And I will pray to a big god":
    "E eu vou rezar para um deus grande",
  ...
  "[Achievement name 566]But the future refused to change":
    "Mas o futuro se recusou a mudar",
  "[Achievement name 567]What's the dark matter with you":
    "Que matéria escura é essa",
  ...
  "[Achievement name 574]Ain't that a click in the head":
    "Isso não é um clique na cabeça",
  ...
  "[Achievement name 585]I'll rest when I'm dead":
    "Vou descansar quando tiver morrido",
  ...
  "[Achievement name 591]Speed's the name of the game (no it's not it's called Cookie Clicker)":
    "Velocidade é o nome do jogo (não é, na verdade se chama Cookie Clicker)",
  ...
  "[Achievement name 613]Everyone everywhere all at once":
    "Todo mundo em todos os lugares ao mesmo tempo",
  ...
  "[Achievement name 618]And now you're even older":
    "E agora você está ainda mais velho",
  ...
  "[Achievement name 623]The leader is good, the leader is great":
    "O líder é bom, o líder é ótimo",
  "[Achievement name 624]You don't think they could've used... it couldn't have been ma-":
    "Você não acha que poderiam ter usado... não poderia ter sido ma-",
  ...
  "[Achievement name 627]Not even remotely close to Kansas anymore":
    "Não estamos nem um pouco perto do Kansas agora",
  ...
  "[Achievement name 638]Oft we mar what's well":
    "Geralmente estragamos o que está bom",

AddLanguage("ES", "spanish", {
  ...
  "numbers that pop up when clicking the cookie":
    "números que aparecen al clicar una galleta",
  "Milk [setting]": "Leche",
  ...
  "notifications disappear much faster":
    "las notificaciones desaparecen mucho más rápido",
  ...
  "add options on buildings like Mute":
    "añade opciones en edificios, como Silenciar",
  ...
  "note: this will save and reload your game":
    "nota: se guardará y recargará la partida",
  ...
  "at %1% of its potential <b>(+%2% CpS)</b>":
    "al %1% de su potencial <b>(+%2% g/s)</b>",
  ...
  "Note: links will open in your web browser.":
    "Nota: los enlaces se abrirán en tu navegador.",
  ...
  "Are you sure you want to close Cookie Clicker?":
    "¿Seguro que quieres cerrar Cookie Clicker?",
  ...
  "You earned <b>%1</b> while you were away.":
    "Has ganado <b>%1</b> durante tu ausencia.",
  Mods: "Modificaciones",
  ...
  "Mods are loaded from top to bottom.":
    "Los mods se cargan de arriba a abajo.",
  ...
  "What should your bakery's name be?":
    "¿Qué nombre le pondrías a tu confitería?",
  ...
  "You harvested <b>%1</b> while you were away.":
    "Has cosechado <b>%1</b> durante tu ausencia.",
  ...
  "Cookie chain over. You made %1.":
    "Cadena de galletas terminada. Has conseguido %1.",
  ...
  "Select an aura from those your dragon knows.":
    "Selecciona un aura que tu dragón conozca.",
  ...
  "Your cookies are popular in the neighborhood.":
    "Tus galletas se hacen populares en el barrio.",
  "People are starting to talk about your cookies.":
    "La gente empieza a hablar de tus galletas.",
  ...
  "Your cookies bring all the boys to the yard.":
    "Tus galletas atraen a todos los niños.",
  "Your cookies now have their own website!":
    "¡Tus galletas tienen página web propia!",
  ...
  "There are now museums dedicated to your cookies.":
    "Ya hay museos dedicados a tus galletas.",
  ...
  "The whole planet is enjoying your cookies!":
    "¡Todo el planeta disfruta de tus galletas!",
  ...
  "Your cookies have achieved sentience.":
    "Tus galletas han desarrollado conciencia.",
  ...
  "Wish granted. Golden cookie spawned.":
    "Deseo concedido. Ha aparecido una galleta dorada.",
  "help me!": "¡ayúdame!",
  Ascend: "Ascender",
  ...
  "Ascending now would grant you no prestige.":
    "Ascender ahora no te otorgará ningún prestigio.",
  ...
  "Are you ready to return to the mortal world?":
    "¿Listo para regresar al mundo de los mortales?",
  ...
  "each %1 produces <b>%2</b> per second":
    "cada %1 produce <b>%2</b> por segundo",
  ...
  "...also boosting some other buildings:":
    "…y también aumenta otros edificios:",
  ...
  "[Cursor quote]Autoclicks once every 10 seconds.":
    "Clic automático cada 10 segundos.",
  ...
  "[Factory quote]Produces large quantities of cookies.":
    "Produce grandes cantidades de galletas.",
  ...
  "[Bank quote]Generates cookies from interest.":
    "Genera galletas a partir de los intereses.",
  ...
  "[Temple quote]Full of precious, ancient chocolate.":
    "Lleno de chocolate antiguo y valioso.",
  ...
  "[Portal quote]Opens a door to the Cookieverse.":
    "Abre una puerta al galletiverso.",
  ...
  "[You quote]You, alone, are the reason behind all these cookies. You figure if there were more of you... maybe you could make even more.":
    "Tú eres el motivo detrás de tantas galletas, nadie más. Averigua si hay más como tú… podrías incluso hacer más.",
  ...
  "[You business quote]Your business is as great as it's gonna get. The only real way to improve it anymore is to improve yourself - and become the best CEO this world has ever seen.":
    "Tu negocio llegará donde llegue. La única mejora posible es mejorarte a ti mismo y conviértete en el mejor CEO que este mundo haya conocido.",
  CpS: "g/s",
  ...
  "Clicking is <b>%1%</b> more powerful.":
    "Los clics son un <b>%1%</b> más potentes.",
  ...
  "Unshackled! <b>+%1%</b> extra production.":
    "¡Desatado! <b>+%1%</b> de producción adicional.",
  ...
  "Each %1 gains <b>+%2 base CpS per %3</b>.":
    "Cada %1 consigue <b>+%2 g/s básicas por %3</b>.",
  ...
  "Time remaining until pledge runs out:":
    "Tiempo restante para que termine la promesa:",
  "You haven't pledged to the elders yet.":
    "No has hecho ninguna promesa a las ancianas.",
  ...
  "Research takes only <b>5 seconds</b>.":
    "La investigación solo requiere <b>5 segundos</b>.",
  ...
  "Golden cookies stay <b>%1%</b> longer.":
    "Las galletas doradas duran un <b>%1%</b> más.",
  ...
  "Elder pledges last <b>twice</b> as long.":
    "Las promesas a las ancianas duran <b>el doble</b>.",
  ...
  "Wrinklers spawn much more frequently.":
    "Los devoradores aparecen con mucha más frecuencia.",
  ...
  "Wrinklers digest <b>%1% more cookies</b>.":
    "Los devoradores digieren <b>%1% galletas más</b>.",
  ...
  "All buildings are <b>%1% cheaper</b>.":
    "Todos los edificios son un <b>%1% más baratos</b>.",
  "All upgrades are <b>%1% cheaper</b>.":
    "Todas las mejoras son un <b>%1% más baratas</b>.",
  ...
  "Random drops are <b>%1% more common</b>.":
    "Los botines son un <b>%1% más comunes</b>.",
  "Reindeer spawn much more frequently.":
    "Los renos aparecen con mucha más frecuencia.",
  ...
  "Click again to cancel season":
    "Haz clic de nuevo para cancelar la temporada.",
  ...
  "The egg bursts into <b>%1</b> cookies!":
    "¡El huevo se transforma en <b>%1</b> galletas!",
  "You found an egg!": "¡Has encontrado un huevo!",
  "Eggs drop <b>%1%</b> more often.":
    "Los huevos aparecen con un <b>%1%</b> más de frecuencia.",
  ...
  "Contains an assortment of delicious pastries.":
    "Contiene un surtido de deliciosa repostería.",
  ...
  "Pick an upgrade to make permanent":
    "Elige una mejora para hacerla permanente",
  ...
  "Unlocks the <b>cookie dragon egg</b>.":
    "Desbloquea el <b>huevo de dragón de galleta</b>.",
  ...
  "Lets you pick what flavor of milk to display.":
    "Te permite elegir qué sabor de leche mostrar.",
  ...
  "Play through the game's sound files!":
    "¡Escucha todos los archivos de sonido del juego!",
  Play: "Reproducir",
  Stop: "Detener",
  Pause: "Pausa",
  Shuffle: "Aleatorio",
  ...
  "Contains more wallpapers for your background selector.":
    "Contiene más fondos de pantalla para tu selector de fondos.",
  "Lets you pick which wallpaper to display.":
    "Te permite elegir el fondo de pantalla.",
  ...
  "You can attract <b>%1 more wrinklers</b>.":
    "Puedes atraer un <b>%1 más devoradores</b>.",
  ...
  "Cookie production <b>reduced to 0</b>.":
    "La producción de galletas <b>se reduce a 0</b>.",
  ...
  "May only be used once per ascension.":
    "Solo se puede usar una vez por ascensión.",
  ...
  "<b>+%1%</b> sugar lump growth.":
    "<b>+%1%</b> de crecimiento de terrones de azúcar.",
  ...
  "Has a <b>%1%</b> chance to not break.":
    "Tiene un <b>%1%</b> de probabilidad de no romperse.",
  ...
  "Hey, what's up. I'm a fortune cookie.":
    "Hola, ¿qué tal? Soy una galleta de la fortuna.",
  "You think you have it bad? Look at me.":
    "¿Crees que estás mal? Mírame a mí.",
  ...
  "Kittens are <b>%1%</b> more effective.":
    "Los gatitos son un <b>%1%</b> más efectivos.",
  ...
  "Seasonal cookies purchased: <b>%1</b>.":
    "Galletas de temporada compradas: <b>%1</b>.",
  "Reindeer cookies purchased: <b>%1</b>.":
    "Galletas de reno compradas: <b>%1</b>.",
  ...
  "Some seasonal effects are boosted.":
    "Algunos efectos de temporada han aumentado.",
  ...
  "Switching seasons is %1% pricier.":
    "Cambiar de temporada es un %1 % más caro.",
  "Switching seasons is %1% cheaper.":
    "Cambiar de temporada es un %1 % más barato.",
  "Heavenly chips have %1% less effect.":
    "Las pepitas celestiales tienen un %1 % menos de efecto.",
  ...
  "You may now send and receive gifts with other players through buttons in the top-right of the %1 menu.":
    "Ahora puedes enviar y recibir regalos de otros jugadores con los botones situados en la parte superior derecha del menú %1.",
  "You need at least %1 cookies in bank to send and receive gifts.":
    "Necesitas tener al menos %1 galletas en el banco para enviar y recibir regalos.",
  ...
  'Clicking "%1" will generate a text code you can send to others. Gift codes can be redeemed multiple times by anyone but expire after a day or two. You can only generate one gift code per hour. Your game will save after sending.':
    'Haz clic en "%1" y se generará un código de texto que podrás enviar a otros. Cualquiera puede reclamar varias veces los códigos de regalo, pero caducan después de un día o dos. Solo puedes generar un código de regalo cada hora. Tu partida se guardará después de enviar.',
  "You may put between %1 and %2 cookies in the gift box.":
    "Puedes meter entre %1 y %2 galletas en la caja regalo.",
  "You can leave a note. Don't be rude!<br>Maximum %1 lines and %2 characters.":
    "Puedes dejar una nota. ¡Ten un poco de educación!<br>Usa un máximo de %1 líneas y %2 caracteres.",
  "Once you redeem a gift, you will have to wait an hour before you can redeem another. Your game will save after redeeming.":
    "Cuando reclames un regalo, tendrás que esperar una hora antes de poder reclamar otro. Tu partida se guardará después de reclamarlo.",
  "Box design": "Diseño de caja",
  Icon: "Icono",
  "Here's your gift code!<br>Make sure to copy it so you can share it.":
    "¡Aquí tienes tu código de regalo!<br>No olvides copiarlo para poder compartirlo.",
  "Code expired.": "Código caducado.",
  "Invalid code.": "Código no válido.",
  "Gift redeemed!<br>Inside, you find:":
    "¡Regalo reclamado!<br>Dentro, encontrarás:",
  "There's a note too!": "¡También tienes una nota!",
  "How nice!": "¡Qué guay!",
  "You've already sent or redeemed a gift recently.":
    "Has enviado o reclamado un regalo recientemente.",
  Customize: "Personalizar",
  "Customize your clones": "Personaliza tus clones",
  "Sprung from your very DNA. Shape them in your image!":
    "Producto de tu propio ADN. ¡Hazlos a tu imagen y semejanza!",
  Hair: "Pelo",
  ...
  "Trigger the grandmapocalypse for the first time.":
    "Desencadena el yayapocalipsis por primera vez.",
  ...
  "Declare a covenant with the grandmatriarchs.":
    "Declara un pacto con las abumatriarcas.",
  "Own at least <b>%1</b> grandma types.":
    "Ten al menos <b>%1</b> tipos de abuelas.",
  ...
  "Reach <b>Santa's final form</b>.":
    "Alcanza la <b>forma final de Papá Noel</b>.",
  ...
  "Complete your <b>dragon's training</b>.":
    "Completa el <b>adiestramiento de tu dragón</b>.",
  ...
  "Own <b>%1</b> upgrades and <b>%2</b> buildings.":
    "Ten <b>%1</b> mejoras y <b>%2</b> edificios.",
  ...
  "Poke a wrinkler <b>%1 times</b> without killing it.":
    "Pincha a un devorador <b>%1 veces</b> sin matarlo.",
  ...
  "Harvest <b>%1 coalescing sugar lumps</b>.":
    "Cosecha <b>%1 terrones de azúcar fusionados</b>.",
  ...
  "Harvest a <b>bifurcated sugar lump</b>.":
    "Cosecha un <b>terrón de azúcar bifurcado</b>.",
  "Harvest a <b>golden sugar lump</b>.":
    "Cosecha un <b>terrón de azúcar dorado</b>.",
  "Harvest a <b>meaty sugar lump</b>.":
    "Cosecha un <b>terrón de azúcar carnoso</b>.",
  "Harvest a <b>caramelized sugar lump</b>.":
    "Cosecha un <b>terrón de azúcar caramelizado</b>.",
  ...
  "Harvest <b>%1</b> mature garden plants.":
    "Cosecha <b>%1</b> plantas de jardín maduras.",
  ...
  "Make your first stock market profit.":
    "Obtén tu primera ganancia en la bolsa.",
  ...
  "Take out a loan and ascend before incurring the CpS penalty.":
    "Retira un préstamo y asciende antes de recibir la penalización de g/s.",
  "Own <b>%1</b> kitten upgrades.": "Ten <b>%1</b> mejoras para gatitos.",
  "Find the <b>forgotten madeleine</b>.":
    "Encuentra la <b>magdalena olvidada</b>.",
  ...
  "Redeem a cookie gift code from a friend (or from yourself, we don't judge).":
    "Reclama un código de regalo de galleta de algún amigo (o de ti mismo, no te vamos a criticar).",
  "Shape your clones to resemble %1.":
    "Da forma a tus clones para que se parezcan a %1.",
  Clone: "Clonar",
  ...
  "Cookie production %1% slower for %2!":
    "¡Producción de galletas %1% más lenta durante %2!",
  "Cookie production halved for %1!":
    "¡Producción de galletas reducida a la mitad durante %1!",
  ...
  "All buildings are %1% pricier for %2!":
    "¡Todos los edificios son un %1% más caros durante %2!",
  "All upgrades are %1% cheaper for %2!":
    "¡Todas las mejoras son un %1% más baratas durante %2!",
  "All upgrades are %1% pricier for %2!":
    "¡Todas las mejoras son un %1% más caras durante %2!",
  ...
  "Spells backfire %1 times less for %2.":
    "Los hechizos se lanzan %1 veces menos durante %2.",
  "Spells backfire %1 times more for %2.":
    "Los hechizos se lanzan %1 veces más durante %2.",
  "Can't send or receive gifts again for %1.":
    "No puedes enviar ni recibir regalos de nuevo en %1.",
  ...
  "Your garden is frozen, providing no effects.":
    "Tu jardín está congelado, no tiene efectos.",
  "Combined effects of all your plants:":
    "Efectos combinados de todas tus plantas:",
  "None.": "Ninguno.",
  ...
  "%1 to harvest only mature, mortal plants.":
    "%1 para cosechar solo plantas mortales maduras.",
  ...
  "Garden is frozen. Unfreeze to resume.":
    "El jardín está congelado. Descongélalo para retomarlo.",
  ...
  "harvest when mature for a sugar lump":
    "cosechar cuando maduren por un terrón de azúcar",
  useless: "inservible",
  ...
  "may sometimes drop spores when uprooted":
    "puede que caigan esporas al arrancarla",
  ...
  "Your field is currently using this soil.":
    "Tu jardín está usando esta tierra.",
  "You will be able to change your soil again in %1.":
    "Puedes volver a cambiar la tierra en %1.",
  ...
  "Click to select this seed for planting.":
    "Haz clic para seleccionar esta semilla y plantarla.",
  ...
  "Mature plants harvested: %1 (total: %2)":
    "Plantas maduras cosechadas: %1 (total: %2)",
  ...
  "Backfired, but no buildings to destroy!":
    "Ha explotado, pero no hay edificios que destruir.",
  "A new %1<br>bursts out of the ground.":
    "Sale del suelo por primera vez: <br>%1.",
  "One of your %1<br>disappears in a puff of smoke.":
    "Tu %1<br>desaparece en una humareda.",
  "Haggler's Charm": "Encanto de regateador",
  "Upgrades are %1% cheaper for 1 minute.":
    "Las mejoras son un %1 % más baratas durante 1 minuto.",
  ...
  "[GOD 1 NAME]Holobore, Spirit of Asceticism":
    "Holobore, espíritu del ascetismo",
  ...
  "[GOD 2 NAME]Vomitrax, Spirit of Decadence":
    "Vomitrax, espíritu de la decadencia",
  ...
  "[GOD 5 NAME]Selebrak, Spirit of Festivities":
    "Selebrak, espíritu de las festividades",
  ...
  "[GOD 6 NAME]Dotjeiess, Spirit of Creation":
    "Dotjeiess, espíritu de la creación",
  ...
  "Release to assign %1 to this slot.":
    "Libera para asignar a %1 a esta ranura.",
  ...
  "%1: currently worth <b>$%2</b> per unit.":
    "%1: vale actualmente <b>$%2</b> por unidad.",
  "You currently own %1 (worth <b>$%2</b>).":
    "Ahora mismo tienes %1 (se valora en <b>$%2</b>).",
  "Your warehouses can store up to %1.":
    "Tus almacenes pueden guardar hasta %1.",
  ...
  "+%1 warehouse space for all goods":
    "+%1 espacio(s) en el almacén para todos los productos",
  ...
  "A nice broker to trade more cookies.":
    "Un buen bróker para vender más galletas.",
  Hire: "Contratar",
  ...
  "Hiring a new broker will cost you %1.":
    "Contratar a un nuevo bróker te costará %1.",
  "Take out %1": "Saca %1",
  "Loan #%1": "Prestar #%1",
  ...
  "[Upgrade name 1]Carpal tunnel prevention cream":
    "Crema para la prevención del túnel carpiano",
  ...
  "[Upgrade name 8]Steel-plated rolling pins":
    "Rodillos de amasar chapados en acero",
  ...
  "[Upgrade name 13]Sturdier conveyor belts":
    "Cintas transportadoras más resistentes",
  ...
  "[Upgrade name 29]Time paradox resolver":
    "Solucionador de la paradoja del tiempo",
  ...
  "[Upgrade name 45]Genetically-modified cookies":
    "Galletas modificadas genéticamente",
  ...
  "[Upgrade name 55]Dark chocolate-coated cookies":
    "Galletas cubiertas de chocolate negro",
  ...
  "[Upgrade name 64]Bingo center/Research facility":
    "Bingo/Centro de investigación",
  "[Upgrade name 65]Specialized chocolate chips":
    "Pepitas de chocolate especializadas",
  ...
  "[Upgrade name 87]Sacrificial rolling pins":
    "Rodillos de amasar de sacrificio",
  ...
  "[Upgrade name 94]Chocolate british tea biscuits":
    "Galletas de té británicas de chocolate",
  "[Upgrade name 95]Round british tea biscuits":
    "Galletas de té británicas redondas",
  ...
  "[Upgrade name 101]Large macaron collider":
    "Colisionador de macarrones grande",
  ...
  "[Upgrade name 111]Gingerbread scarecrows":
    "Espantapájaros de pan de jengibre",
  ...
  "[Upgrade name 236]Exponential interest rates":
    "Tasas de interés exponenciales",
  ...
  "[Upgrade name 253]Tin of british tea biscuits":
    "Caja de galletas de té británicas",
  ...
  "[Upgrade name 256]Pure black chocolate cookies":
    "Galletas de chocolate negro puro",
  "[Upgrade name 257]Pure white chocolate cookies":
    "Galletas de chocolate blanco puro",
  ...
  "[Upgrade name 281]Twin Gates of Transcendence":
    "Puertas gemelas de la trascendencia",
  ...
  "[Upgrade name 303]End of times back-up plan":
    "Plan B para el fin de los tiempos",
  ...
  "[Upgrade name 317]Cookietopian moments of maybe":
    "Momentos galletopianos del quizás",
  ...
  "[Upgrade name 329]Fanciful dairy selection":
    "Surtido de lácteos extravagante",
  ...
  "[Upgrade name 360]Golden cookie alert sound":
    "Sonido de alerta de galleta dorada",
  "[Upgrade name 361]Golden cookie sound selector":
    "Selector de sonido de galleta dorada",
  "[Upgrade name 362]Basic wallpaper assortment":
    "Surtido de fondo de pantalla básico",
  ...
  "[Upgrade name 397]Distilled essence of redoubled luck":
    "Esencia destilada de suerte redoblada",
  ...
  "[Upgrade name 400]Lavender chocolate butter biscuit":
    "Galleta danesa de chocolate y lavanda",
  ...
  "[Upgrade name 451]Sugar aging process":
    "Proceso de envejecimiento de azúcar",
  ...
  "[Upgrade name 487]Restaurants at the end of the universe":
    "Restaurantes en el fin del universo",
  ...
  "[Upgrade name 527]One particularly good-humored cow":
    "Una vaca particularmente de buen humor",
  ...
  "[Upgrade name 567]Chocolate chip mocha cookies":
    "Galletas de moca con pepitas de chocolate",
  ...
  "[Upgrade name 581]French pure butter cookies":
    "Galletas de mantequilla pura francesa",
  ...
  "[Upgrade name 594]The JavaScript console for dummies":
    "La consola de JavaScript para tontos",
  ...
  "[Upgrade name 655]Peanut butter cup cookies":
    "Galletas bombón de mantequilla de cacahuete",
  ...
  "[Upgrade name 659]Cosmic chocolate butter biscuit":
    "Galleta danesa de chocolate cósmica",
  ...
  "[Upgrade name 682]Raspberry cheesecake cookies":
    "Galletas de tarta de queso y frambuesa",
  ...
  "[Upgrade name 685]The multiverse in a nutshell":
    "El multiverso en pocas palabras",
  ...
  "[Upgrade name 699]Butter biscuit (with butter)":
    "Galleta danesa (con mantequilla extra)",
  ...
  "[Upgrade name 704]Diminishing tax returns":
    "Disminución de la declaración fiscal",
  ...
  "[Upgrade name 746]N-dimensional assembly lines":
    "Líneas de montaje N-dimensionales",
  ...
  "[Upgrade name 750]Cosmic foreground radiation":
    "Radiación cósmica de primer plano",
  ...
  "[Upgrade name 756]Silver lining maximization":
    "Maximización del lado positivo",
  ...
  "[Upgrade name 777]Unshackled alchemy labs":
    "Laboratorios de alquimia desatados",
  ...
  "[Upgrade name 780]Unshackled antimatter condensers":
    "Condensadores de antimateria desatados",
  ...
  "[Upgrade name 804]Distinguished wallpaper assortment":
    "Distinguido surtido de papeles pintados",
  ...
  "[Upgrade name 839]Fine-tuned body plans":
    "Patrones corporales bien definidos",
  ...
  "[Upgrade name 847]At your doorstep in 30 minutes or your money back":
    "En tu puerta en 30 minutos o recuperas el dinero",
  "[Upgrade name 848]The dose makes the poison":
    "La dosis es la clave del veneno",
  ...
  "[Upgrade name 852]Lab goggles but like cool shades":
    "Gafas de laboratorio, pero molonas",
  "[Upgrade name 853]Gambler's fallacy fallacy":
    "La falacia de la falacia del jugador",
  ...
  "[Achievement name 149]The old never bothered me anyway":
    "Las abuelas nunca me molestaron",
  ...
  "[Achievement name 224]The land of milk and cookies":
    "La tierra de la leche y las galletas",
  ...
  "[Achievement name 243]Tabloid addiction":
    "Adicción a la prensa sensacionalista",
  ...
  "[Achievement name 246]Thumbs, phalanges, metacarpals":
    "Pulgares, falanges, metacarpianos",
  ...
  "[Achievement name 293]Click (starring Adam Sandler)":
    "Click (protagonizada por Adam Sandler)",
  ...
  "[Achievement name 327]Grandma needs a new pair of shoes":
    "La abuela necesita zapatos nuevos",
  "[Achievement name 328]Million to one shot, doc":
    "Había una probabilidad entre un millón",
  ...
  "[Achievement name 371]Green cookies sleep furiously":
    "Las galletas verdes duermen furiosamente",
  ...
  "[Achievement name 380]In the garden of Eden (baby)":
    "En el jardín del Edén (bebé)",
  "[Achievement name 381]Keeper of the conservatory":
    "Cuidador del invernadero",
  ...
  "[Achievement name 397]When the cookies ascend just right":
    "Cuando las galletas ascienden bien",
  ...
  "[Achievement name 422]I'm so meta, even this achievement":
    "Soy tan meta, incluso en este logro",
  ...
  "[Achievement name 449]You're #1 so why try harder":
    "Eres el número 1, ¿por qué esforzarte más?",
  ...
  "[Achievement name 485]Caveman to cosmos":
    "Del hombre de las cavernas al espacio",
  ...
  "[Achievement name 509]They'll never know what hit 'em":
    "Nunca sabrán lo que les golpeó",
  ...
  "[Achievement name 513]Once you've seen one":
    "Cuando has visto uno, son todos iguales",
  ...
  "[Achievement name 531]Keep going until I say stop":
    "Sigue hasta que te diga que te pares",
  "[Achievement name 532]But I didn't say stop, did I?":
    "¿Te he dicho que te pares?",
  ...
  "[Achievement name 542]The organ that named itself":
    "El órgano que se nombró a sí mismo",
  ...
  "[Achievement name 548]Though fools seldom differ":
    "Aunque los tontos rara vez discrepan",
  ...
  "[Achievement name 566]But the future refused to change":
    "Pero el futuro se negó a cambiar",
  "[Achievement name 567]What's the dark matter with you":
    "¿Qué te pasa con la materia oscura?",
  ...
  "[Achievement name 596]No more room in hell":
    "No cabe un alma más en el infierno",
  ...
  "[Achievement name 618]And now you're even older":
    "Y ahora eres más viejo todavía",
  ...
  "[Achievement name 629]Not 20 years away forever":
    "No a 20 años de distancia eternamente",
  "[Achievement name 630]Bright side of the Moon":
    "La cara brillante de la luna",
  "[Achievement name 631]Riding the Mersenne twister":
    "Dentro del generador Mersenne Twister",
  ...
  "[Achievement name 634]Greener on the other sides":
    "Al vecino siempre le va todo mejor",

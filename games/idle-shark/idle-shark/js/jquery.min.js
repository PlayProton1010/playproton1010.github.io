...
!(function (e, t) {
      ...
      function (e, t) {
        d.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 && (j[e] || d.unique(i), S.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      },
      ...
      return (
        A ||
          ...
          "complete" === f.readyState
            ? setTimeout(d.ready)
            : (f.addEventListener("DOMContentLoaded", H, !1),
              e.addEventListener("load", H, !1))),
        A.promise(t)
      );
    }),
    d.ready.promise();
  var O = (d.access = function (e, t, n, r, i, o, s) {
    var a = 0,
      u = e.length,
      l = null == n;
    if ("object" === d.type(n))
          ...
          if (
            ...
            for (n = s.length; n--; )
              s[n] &&
                ...
                ((r = d.camelCase(r.slice(5))), $(o, r, i[r]));
  ...
  (d.event = {
        ...
        for (
          n.handler && ((n = (o = n).handler), (i = o.selector)),
            ...
            (s = v.handle) ||
              (s = v.handle =
                function (t) {
                  return typeof d !== X && d.event.triggered !== t.type
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (v && (u = v.events)) {
        ...
        d.isEmptyObject(u) && (delete v.handle, P.remove(e, "events"));
      }
    },
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !h.noBubble && !d.isWindow(r)) {
          for (
            u = h.delegateType || m, Y.test(u + m) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            g.push(s), (a = s);
        ...
        for (o = 0; (s = g[o++]) && !t.isPropagationStopped(); )
          (t.type = o > 1 ? u : h.bindType || m),
            (p = (P.get(s, "events") || {})[t.type] && P.get(s, "handle")) &&
              p.apply(s, n),
            (p = c && s[c]) &&
              p.apply &&
              d.acceptData(s) &&
    ...
    d.extend({
      ...
      cleanData: function (e) {
        for (
          ...
          if (d.acceptData(n) && (i = n[P.expando]) && (t = P.cache[i])) {
            if (t.events)
              for (r in t.events)
                o[r] ? d.event.remove(n, r) : d.removeEvent(n, r, t.handle);
            P.cache[i] && delete P.cache[i];
          }
    ...
    d.fn.extend({
      ...
      remove: function (e, t) {
        for (
          ...
          t || 1 !== n.nodeType || d.cleanData(de(n)),
            n.parentNode &&
              (t && d.contains(n.ownerDocument, n) && fe(de(n, "script")),
              n.parentNode.removeChild(n));
        return this;
      },
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (d.cleanData(de(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
      ...
      domManip: function (e, t) {
        ...
        var n,
          ...
          g = e[0],
          m = d.isFunction(g);
        if (m || (f > 1 && "string" == typeof g && !c.checkClone && re.test(g)))
        ...
        if (
          ...
          for (s = (o = d.map(de(n, "script"), le)).length; f > l; l++)
            (a = n),
              l !== h &&
                ((a = d.clone(a, !0, !0)), s && d.merge(o, de(a, "script"))),
              t.call(this[l], a, l);
          if (s)
            for (
              u = o[o.length - 1].ownerDocument, d.map(o, ce), l = 0;
              s > l;
              l++
            )
              (a = o[l]),
                ie.test(a.type || "") &&
                  ...
                  (a.src
                    ...
                    : d.globalEval(a.textContent.replace(se, "")));
        }
        return this;
      },
    }),
  ...
  function qe(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (s += d.css(e, n + I[o], !0, i)),
        r
          ? ("content" === n && (s -= d.css(e, "padding" + I[o], !0, i)),
            "margin" !== n && (s -= d.css(e, "border" + I[o] + "Width", !0, i)))
          : ((s += d.css(e, "padding" + I[o], !0, i)),
            "padding" !== n &&
              (s += d.css(e, "border" + I[o] + "Width", !0, i)));
    return s;
  }
  function He(e, t, n) {
    var r = !0,
    ...
    for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)
      (r = e[s]).style &&
        ...
        t
          ...
          : ((i = _(r)),
            ("none" === n && i) ||
              P.set(r, "olddisplay", i ? n : d.css(r, "display"))));
    for (s = 0; a > s; s++)
      (r = e[s]).style &&
  ...
  d.extend({
    ...
    d.each(["height", "width"], function (e, t) {
      d.cssHooks[t] = {
        get: function (e, n, r) {
          return n
            ? Ne.test(d.css(e, "display")) && 0 === e.offsetWidth
    ...
    (d.cssHooks.marginRight = Ce(c.reliableMarginRight, function (e, t) {
      return t
        ? d.swap(e, { display: "inline-block" }, Te, [e, "marginRight"])
        : void 0;
    })),
    ...
    Be = [
      function (e, t, n) {
        ...
        1 === e.nodeType &&
          ...
          (l = d.css(e, "display")),
          "inline" ===
            ("none" === l ? P.get(e, "olddisplay") || ye(e.nodeName) : l) &&
            "none" === d.css(e, "float") &&
        ...
        if (d.isEmptyObject(f))
          ...
          c.done(function () {
            var t;
            for (t in (P.remove(e, "fxshow"), f)) d.style(e, t, f[t]);
          }),
          f))
            (s = Xe(h ? g[r] : 0, r, c)),
              r in g ||
        ...
        : this.each(
            d.isFunction(e)
              ...
              : function () {
                  if ("string" === n)
                    for (
                      var t, r = 0, i = d(this), o = e.match(L) || [];
                      (t = o[r++]);
  ...
  e.ActiveXObject &&
    ...
    d.ajaxTransport(function (e) {
      var t;
      return c.cors || (Ct && !e.crossDomain)
        ? {
            send: function (n, r) {
              var i,
                o = e.xhr(),
  ...
  (d.offset = {
    ...
    d.each(["top", "left"], function (e, t) {
      d.cssHooks[t] = Ce(c.pixelPosition, function (e, n) {
        return n
          ? ((n = Te(e, t)), be.test(n) ? d(e).position()[t] + "px" : n)
          : void 0;
      });
    }),

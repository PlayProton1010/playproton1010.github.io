SharkGame.WorldTypes = {
  ...
  marine: {
    ...
    entry:
      "You enter a familiar blue sea, all your previous knowledge a dim memory.",
    style: "default",
    absentResources: ["tar", "ice", "heater", "shrimp", "chimaera", "eel"],
    modifiers: [
  ...
  chaotic: {
    ...
    modifiers: [
      { modifier: "planetaryIncome", resource: "frenzy", amount: 1e-4 },
      { modifier: "planetaryIncome", resource: "animals", amount: -1e-4 },
  ...
  haven: {
    ...
    entry:
      "Remembering nothing, you find yourself in a beautiful atoll teeming with life. Life will be good here.",
    style: "haven",
    absentResources: ["tar", "ice", "heater", "chimaera", "eel"],
    modifiers: [
      {
  ...
  violent: {
    ...
    modifiers: [
      ...
      { modifier: "planetaryIncome", resource: "coral", amount: 1e-5 },
      { modifier: "planetaryIncome", resource: "algae", amount: 1e-4 },
    ],
    gateCosts: {
      sand: 1e10,
      kelp: 1e9,
  ...
  frigid: {
    ...
    entry:
      "As you struggle with sudden amnesia, you notice crystals forming in front of you. So cold.",
    style: "frigid",
    absentResources: [
      "tar",
      "dolphin",

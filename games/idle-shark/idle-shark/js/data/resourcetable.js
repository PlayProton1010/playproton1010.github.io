(SharkGame.ResourceTable = {
  numen: { name: "numina", singleName: "numen", color: "#FFFFFF", value: -1 },
  essence: {
    name: "essence",
    singleName: "essence",
    color: "#ACE3D1",
  ...
  crab: {
    ...
    singleName: "crab",
    color: "#9C2424",
    income: { crystal: 0.01, coral: 0.02 },
    jobs: ["planter", "brood"],
    value: 1e3,
  },
  shrimp: {
  ...
  dolphin: {
    ...
    singleName: "dolphin",
    color: "#C6BAC6",
    income: { fish: 1, sponge: 0.1, jellyfish: 0.05 },
  ...
  diver: {
    ...
    color: "#6A74AB",
    income: { crystal: 0.5, jellyfish: 0.5 },
    value: 3e3,
  },
  laser: {
    name: "laser rays",
  ...
  transmuter: {
    ...
    color: "#6A4BA3",
    income: { sharkonium: 1, sand: -5, crystal: -15 },
    value: 3e3,
  },
  explorer: {
    ...
    color: "#64685A",
    income: { science: 5, jellyfish: 0.5 },
    value: 3e3,
  },
  collector: {
  ...
  sifter: {
    ...
    color: "#473E21",
    income: { sand: 0.2, crystal: 0.9, kelp: 0.5 },
    value: 3e3,
  },
  crystalMiner: {
    name: "crystal miners",
  ...
  autoTransmuter: {
    ...
    color: "#B5A7D1",
    income: { crystal: -50, sand: -150, sharkonium: 20, tar: 1e-5 },
    value: 155e3,
  },
  fishMachine: {
    name: "fish machines",
  ...
  skimmer: {
    ...
    singleName: "skimmer",
    color: "#8D4863",
    income: { junk: 10, sand: -8, fish: -3, tar: 5e-5 },
    value: 5e4,
  },
  purifier: {
    name: "purifiers",
  ...
  glassMaker: {
    ...
    color: "#E39E66",
    income: { coralglass: 10, coral: -150, sand: -150 },
    value: 5e4,
  },
  silentArchivist: {
  ...
  tirelessCrafter: {
    ...
    color: "#9AEBCF",
    income: { delphinium: 10, coral: -150, crystal: -50, tar: 1e-6 },
    value: 5e4,
  },
  clamCollector: {
  ...
  sprongeSmelter: {
    ...
    color: "#76614C",
    income: { spronge: 30, sponge: -50, junk: -150, tar: 1e-4 },
    value: 5e4,
  },
  seaScourer: {
    name: "sea scourers",
  ...
  fish: { name: "fish", singleName: "fish", color: "#E3D85B", value: 3 },
  seaApple: {
    name: "sea apples",
  ...
  sponge: {
    ...
    singleName: "sponge",
    color: "#ED9847",
    income: { sponge: 1e-4, algae: -0.001 },
    value: 3,
  },
  jellyfish: {
    name: "jellyfish",
  ...
  clam: { name: "clams", singleName: "clam", color: "#828FB5", value: 3 },
  sand: { name: "sand", singleName: "sand", color: "#C7BD75", value: 3 },
  crystal: {
    name: "crystals",
    singleName: "crystal",
    color: "#6FD9CC",
  ...
  kelp: {
    ...
    singleName: "kelp",
    color: "#9CC232",
    income: { seaApple: 0.001 },
    value: 3,
  },
  coral: { name: "coral", singleName: "coral", color: "#CA354F", value: 3 },
  algae: { name: "algae", singleName: "algae", color: "#549572", value: 0.5 },
  sharkonium: {
    name: "sharkonium",
  ...
  junk: { name: "residue", singleName: "residue", color: "#605050", value: 1 },
  tar: {
    name: "tar",
    singleName: "tar",
    color: "#3B3B3B",
  ...
  (SharkGame.ResourceCategories = {
    ...
    stuff: {
      ...
      resources: ["sand", "crystal", "kelp", "coral", "algae"],
    },
    processed: {
      name: "Processed",
      disposeMessage: [

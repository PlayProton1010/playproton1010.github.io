SharkGame.Upgrades = {
  crystalBite: {
    ...
    cost: { science: 50, fish: 10 },
    effect: { multiplier: { shark: 2 } },
  },
  crystalSpade: {
    name: "Crystal Spades",
    ...
    cost: { science: 50, sand: 20 },
    effect: { multiplier: { ray: 2 } },
  },
  crystalContainer: {
    ...
    cost: { science: 100, crystal: 50 },
    effect: { multiplier: { scientist: 2 } },
  },
  statsDiscovery: {
    ...
    cost: { science: 150 },
    required: { upgrades: ["crystalContainer"] },
  },
  underwaterChemistry: {
  ...
  thermalVents: {
    ...
    cost: { science: 300, sand: 500 },
    required: { upgrades: ["seabedGeology"] },
  },
  spongeCollection: {
    ...
    cost: { science: 400 },
    required: { upgrades: ["seabedGeology"], resources: ["sponge"] },
  },
  clamScooping: {
    name: "Clam Scooping",
    ...
    effectDesc:
      "Clams can be collected like fish. The rays do a better job of scooping things, for some reason.",
    cost: { science: 600 },
    required: { upgrades: ["seabedGeology"], resources: ["clam"] },
  },
  pearlConversion: {
  ...
  jellyfishHunting: {
    ...
    cost: { science: 800 },
    required: { upgrades: ["seabedGeology"], resources: ["jellyfish"] },
  },
  laserRays: {
    name: "Laser Rays",
    ...
    cost: { science: 100, sand: 2e3, crystal: 100 },
    required: { upgrades: ["thermalVents"], resources: ["ray"] },
  },
  automation: {
    name: "Automation",
    ...
    cost: { science: 1e3, sharkonium: 100 },
    required: { upgrades: ["thermalVents", "transmutation"] },
  },
  environmentalism: {
  ...
  engineering: {
    ...
    cost: { science: 2e3, sharkonium: 2e3 },
    required: { upgrades: ["automation"] },
    effect: { multiplier: { crystalMiner: 3, fishMachine: 3, sandDigger: 3 } },
  },
  recyclerDiscovery: {
    name: "Recycler",
    ...
    cost: { science: 3e3, sharkonium: 3e3 },
    required: { upgrades: ["automation"] },
  },
  coralCircuitry: {
    ...
    effectDesc:
      "We can copy some of the safe but slow machines used by the lobsters and shrimp.",
    cost: { science: 3e3, coralglass: 3e3 },
    required: {
  ...
  dolphinTechnology: {
    ...
    cost: { science: 3e3, delphinium: 3e3 },
    required: {
  ...
  agriculture: {
    ...
    cost: { science: 500, sand: 1e3 },
    required: { upgrades: ["seabedGeology"] },
    effect: {
      multiplier: { worker: 2, harvester: 2, treasurer: 2, scavenger: 2 },
    },
  },
  kelpHorticulture: {
    ...
    cost: { science: 1e3, sand: 2e3 },
    required: { upgrades: ["agriculture"], resources: ["kelp"] },
  },
  biology: {
    name: "Biology",
    ...
    cost: { science: 400 },
    required: { upgrades: ["underwaterChemistry", "agriculture"] },
    effect: { multiplier: { shark: 2 } },
  },
  xenobiology: {
    name: "Xenobiology",
    ...
    effectDesc:
      "Kelp produces sea apples twice as fast. Also, sea apple isn't a fruit. We can also dissect sea apples, jellyfish and sponge for science.",
    cost: { science: 600 },
    required: {
      upgrades: ["agriculture"],
      resources: ["seaApple", "jellyfish", "sponge"],
    },
    effect: { multiplier: { kelp: 2 } },
  },
  rayBiology: {
    name: "Ray Biology",
    ...
    cost: { science: 700, sand: 600 },
    required: { upgrades: ["biology", "laserRays"], resources: ["ray"] },
    effect: { multiplier: { ray: 2, laser: 2 } },
  },
  crabBiology: {
    name: "Crab Biology",
    ...
    cost: { science: 500, kelp: 100 },
    required: { upgrades: ["biology", "sunObservation"], resources: ["crab"] },
    effect: { multiplier: { crab: 4, planter: 2 } },
  },
  crustaceanBiology: {
    ...
    cost: { science: 500, clam: 100 },
    required: { upgrades: ["biology"], resources: ["shrimp", "lobster"] },
    effect: { multiplier: { shrimp: 2, lobster: 2 } },
  },
  eusociality: {
    name: "Eusociality",
    ...
    cost: { science: 1e3, sponge: 500 },
    required: { upgrades: ["crustaceanBiology"], resources: ["shrimp"] },
    effect: { multiplier: { shrimp: 2 } },
  },
  wormWarriors: {
    name: "Worm Warriors",
    ...
    cost: { science: 3e3, shrimp: 300 },
    required: { upgrades: ["eusociality"], resources: ["shrimp"] },
    effect: { multiplier: { shrimp: 2, queen: 2, worker: 2 } },
  },
  cetaceanAwareness: {
    ...
    cost: { science: 2e3, fish: 500 },
    required: { upgrades: ["biology"], resources: ["dolphin", "whale"] },
    effect: { multiplier: { dolphin: 2, whale: 2 } },
  },
  dolphinBiology: {
    ...
    cost: { science: 3e3, fish: 1e3 },
    required: { upgrades: ["cetaceanAwareness"], resources: ["dolphin"] },
    effect: { multiplier: { dolphin: 2 } },
  },
  delphinePhilosophy: {
    ...
    cost: { science: 5e3, fish: 1e3 },
    required: { upgrades: ["dolphinBiology"], resources: ["dolphin"] },
    effect: { multiplier: { biologist: 2 } },
  },
  coralHalls: {
    name: "Coral Halls",
    ...
    cost: { science: 1e4, coral: 2e3 },
    required: { upgrades: ["delphinePhilosophy"], resources: ["dolphin"] },
    effect: { multiplier: { dolphin: 2, philosopher: 2, treasurer: 2 } },
  },
  eternalSong: {
    name: "Eternal Song",
    ...
    researchedMessage:
      "We have determined the eternal song of the gates. We don't know what it does yet.",
    effectDesc:
      "A chorus of whales can be assembled to sing the eternal song, but we have no clue what it will do.",
    cost: { science: 1e9 },
    required: { upgrades: ["cetaceanAwareness"], resources: ["whale"] },
  },
  eelHabitats: {
    name: "Eel Habitats",
    ...
    cost: { science: 800, clam: 200 },
    required: { upgrades: ["biology", "seabedGeology"], resources: ["eel"] },
    effect: { multiplier: { eel: 2 } },
  },
  creviceCreches: {
    ...
    effectDesc:
      "Eels are twice as effective, and so are eel pits. Expect many baby eels in the future.",
    cost: { science: 800, clam: 200 },
    required: { upgrades: ["eelHabitats"], resources: ["eel"] },
    effect: { multiplier: { eel: 2, pit: 2 } },
  },
  bioelectricity: {
    name: "Bioelectricity",
    ...
    effectDesc:
      "Eel technicians are twice as effective. So are our machines. Convenient!",
    cost: { science: 1600, clam: 400 },
    required: { upgrades: ["eelHabitats", "engineering"], resources: ["eel"] },
    effect: {
      multiplier: {
        technician: 2,
        fishMachine: 2,
  ...
  octopusMethodology: {
    ...
    cost: { science: 8888, clam: 88 },
    required: { upgrades: ["exploration"], resources: ["octopus"] },
    effect: {
      multiplier: {
        clamCollector: 2,
        eggBrooder: 2,
  ...
  octalEfficiency: {
    ...
    cost: { science: 88888, clam: 888 },
    required: { upgrades: ["octopusMethodology"], resources: ["octopus"] },
    effect: {
      multiplier: {
        clamCollector: 2,
        eggBrooder: 2,
  ...
  chimaeraMysticism: {
    ...
    cost: { science: 12e3, jellyfish: 700 },
    required: { upgrades: ["farExploration"], resources: ["chimaera"] },
  },
  abyssalEnigmas: {
    ...
    cost: { science: 4e4, jellyfish: 2e3 },
    required: { upgrades: ["chimaeraMysticism"], resources: ["chimaera"] },
    effect: { multiplier: { chimaera: 4, transmuter: 4, explorer: 4 } },
  },
  sunObservation: {
    ...
    cost: { science: 5e3 },
    required: { upgrades: ["agriculture"] },
    effect: { multiplier: { planter: 2, shrimp: 4 } },
  },
  transmutation: {
    name: "Transmutation",
    ...
    cost: { science: 1e3, crystal: 2e3, sand: 4e3 },
    required: { upgrades: ["thermalVents", "underwaterChemistry"] },
  },
  coralglassSmelting: {
    ...
    effectDesc:
      "Enables smelting of coralglass, a vital component in crustacean technology.",
    cost: { science: 1e3, coral: 3e3, sand: 3e3 },
    required: {
  ...
  industrialGradeSponge: {
    ...
    cost: { science: 1e3, sponge: 2e3, junk: 4e3 },
    required: {
      upgrades: ["thermalVents", "octopusMethodology"],
      resources: ["sponge", "junk"],
    },
  },
  aquamarineFusion: {
    ...
    cost: { science: 1e3, coral: 4e3, crystal: 4e3 },
    required: {
  ...
  exploration: {
    ...
    cost: { science: 5e3, fish: 5e3 },
    required: { upgrades: ["seabedGeology", "sunObservation"] },
    effect: { multiplier: { shark: 3, ray: 3 } },
  },
  farExploration: {
    ...
    cost: { science: 8e3, fish: 15e3 },
    required: { upgrades: ["exploration"] },
    effect: { multiplier: { crab: 5 } },
  },
  gateDiscovery: {
    ...
    cost: { science: 1e6, shark: 1e3, fish: 5e4 },
  ...
  leviathanHeart: {
    ...
    effect: { multiplier: { eel: 4, pit: 4, sifter: 4, technician: 4 } },
  },
  ...
  mechanisedAlchemy: {
    ...
    cost: { science: 1e10 },
    required: {
      upgrades: ["gateDiscovery", "engineering"],
  ...
  mobiusShells: {
    ...
    effect: { multiplier: { spongeFarmer: 5, berrySprayer: 5, glassMaker: 5 } },
  },
  imperialDesigns: {
    ...
    effect: { multiplier: { tirelessCrafter: 10, silentArchivist: 10 } },
  },
};

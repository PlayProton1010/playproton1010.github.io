(SharkGame.HomeActions = {
  ...
  prySponge: {
    name: "Pry sponge",
    effect: { resource: { sponge: 1 } },
    cost: {},
    prereq: { upgrade: ["spongeCollection"] },
    outcomes: [
      "You got a sponge.",
  ...
  getClam: {
    name: "Get clam",
    effect: { resource: { clam: 1 } },
    cost: {},
    prereq: { upgrade: ["clamScooping"] },
    outcomes: [
  ...
  getJellyfish: {
    name: "Grab jellyfish",
    effect: { resource: { jellyfish: 1 } },
    cost: {},
    prereq: { upgrade: ["jellyfishHunting"] },
    outcomes: [
  ...
  seaApplesToScience: {
    ...
    effect: { resource: { science: 5 } },
    cost: [
      { resource: "seaApple", costFunction: "constant", priceIncrease: 1 },
    ],
    max: "seaApple",
    prereq: { resource: { seaApple: 1 }, upgrade: ["xenobiology"] },
    outcomes: [
  ...
  spongeToScience: {
    name: "Dissect sponge",
    effect: { resource: { science: 5 } },
    cost: [{ resource: "sponge", costFunction: "constant", priceIncrease: 1 }],
    max: "sponge",
    prereq: { resource: { sponge: 1 }, upgrade: ["xenobiology"] },
    outcomes: [
      "Did we learn anything from this?",
      "I got got 100 more IQ points from that.",
      "SCIENCE!",
  ...
  jellyfishToScience: {
    ...
    max: "jellyfish",
    prereq: { resource: { jellyfish: 1 }, upgrade: ["xenobiology"] },
    outcomes: [
      "Did we learn anything from this?",
  ...
  fuseDelphinium: {
    ...
    effect: { resource: { delphinium: 1 } },
    cost: [
      { resource: "coral", costFunction: "constant", priceIncrease: 15 },
      { resource: "crystal", costFunction: "constant", priceIncrease: 5 },
    ],
    max: "delphinium",
    prereq: { upgrade: ["aquamarineFusion"] },
    outcomes: [
      "Fusion confusion.",
      "Fission's fishy.",
  ...
  getShrimp: {
    name: "Acquire shrimp",
    effect: { resource: { shrimp: 1 } },
    cost: [{ resource: "sponge", costFunction: "linear", priceIncrease: 5 }],
    max: "shrimp",
    prereq: { resource: { sponge: 5 }, upgrade: ["seabedGeology"] },
    outcomes: [
    ...
    helpText:
      "Convince shrimp to assist you in the gathering of algae, which helps boost sponge production.",
  },
  getLobster: {
    name: "Gain lobster",
    effect: { resource: { lobster: 1 } },
    cost: [{ resource: "clam", costFunction: "linear", priceIncrease: 10 }],
    max: "lobster",
    prereq: { resource: { clam: 10 }, upgrade: ["seabedGeology"] },
    outcomes: [
      "A scampi joins you.",
  ...
  getDolphin: {
    name: "Fetch dolphin",
    effect: { resource: { dolphin: 1 } },
    cost: [{ resource: "fish", costFunction: "linear", priceIncrease: 10 }],
    max: "dolphin",
    prereq: {
      resource: { fish: 10, shark: 50 },
    ...
    helpText:
      "Pay a dolphin to help us catch fish. Prepare to put up with whining.",
  },
  getWhale: {
    name: "Reach whale",
    effect: { resource: { whale: 1 } },
    cost: [{ resource: "fish", costFunction: "linear", priceIncrease: 1e5 }],
    max: "whale",
    prereq: { resource: { fish: 1e5 }, upgrade: ["cetaceanAwareness"] },
    outcomes: [
  ...
  getEel: {
    name: "Hire eel",
    effect: { resource: { eel: 1 } },
    cost: [{ resource: "fish", costFunction: "linear", priceIncrease: 15 }],
    max: "eel",
    prereq: { resource: { fish: 50 }, upgrade: ["seabedGeology"] },
    outcomes: [
  ...
  getChimaera: {
    ...
    effect: { resource: { chimaera: 1 } },
    cost: [
      { resource: "jellyfish", costFunction: "linear", priceIncrease: 20 },
    ],
    max: "chimaera",
    prereq: { resource: { jellyfish: 20 }, upgrade: ["exploration"] },
    outcomes: [
  ...
  getOctopus: {
    name: "Employ octopus",
    effect: { resource: { octopus: 1 } },
    cost: [{ resource: "clam", costFunction: "linear", priceIncrease: 15 }],
    max: "octopus",
    prereq: { resource: { clam: 20 }, upgrade: ["exploration"] },
    outcomes: [
  ...
  getScientist: {
    ...
    effect: { resource: { scientist: 1 } },
    cost: [
      { resource: "shark", costFunction: "constant", priceIncrease: 1 },
      { resource: "crystal", costFunction: "linear", priceIncrease: 20 },
    ],
    max: "scientist",
    prereq: { resource: { crystal: 20, shark: 1 } },
    outcomes: [
  ...
  getNurse: {
    ...
    effect: { resource: { nurse: 1 } },
    cost: [
      { resource: "shark", costFunction: "constant", priceIncrease: 1 },
      { resource: "fish", costFunction: "linear", priceIncrease: 100 },
    ],
    max: "nurse",
    prereq: { resource: { shark: 1 }, upgrade: ["biology"] },
    outcomes: [
  ...
  getMaker: {
    ...
    max: "maker",
    prereq: { resource: { ray: 1 }, upgrade: ["rayBiology"] },
    outcomes: [
  ...
  getHarvester: {
    ...
    helpText:
      "Train a lobster to cut down kelp faster than anything can plant it. Sustainable!",
  },
  getPhilosopher: {
    name: "Qualify dolphin philosopher",
    effect: { resource: { philosopher: 1 } },
    cost: [
    ...
    max: "philosopher",
    prereq: { resource: { dolphin: 1 }, upgrade: ["delphinePhilosophy"] },
    outcomes: [
    ...
    helpText:
      "Determine which of these dolphins is actually smart, and not just repeating empty phrases.",
  },
  getTreasurer: {
    name: "Promote dolphin treasurer",
    effect: { resource: { treasurer: 1 } },
    cost: [
      { resource: "dolphin", costFunction: "constant", priceIncrease: 1 },
  ...
  getBiologist: {
    ...
    max: "biologist",
    prereq: { resource: { dolphin: 1 }, upgrade: ["dolphinBiology"] },
    outcomes: [
  ...
  getChorus: {
    ...
    effect: { resource: { chorus: 1 } },
    cost: [{ resource: "whale", costFunction: "unique", priceIncrease: 1e3 }],
    max: "chorus",
    prereq: { resource: { whale: 1 }, upgrade: ["eternalSong"] },
    outcomes: [
      "The chorus is made.",
  ...
  getPit: {
    ...
    max: "pit",
    prereq: { resource: { eel: 1 }, upgrade: ["eelHabitats"] },
    outcomes: [
  ...
  getTransmuter: {
    ...
    max: "transmuter",
    prereq: { resource: { chimaera: 1 }, upgrade: ["chimaeraMysticism"] },
    outcomes: [
      "Transmuter taught.",
  ...
  getCrystalMiner: {
    ...
    effect: { resource: { crystalMiner: 1 } },
    cost: [
    ...
    max: "crystalMiner",
    prereq: { resource: { sharkonium: 20 }, upgrade: ["automation"] },
    outcomes: [
  ...
  getFishMachine: {
    ...
    effect: { resource: { fishMachine: 1 } },
    cost: [
      { resource: "sharkonium", costFunction: "linear", priceIncrease: 100 },
    ],
    max: "fishMachine",
    prereq: { resource: { sharkonium: 100 }, upgrade: ["automation"] },
    outcomes: [
  ...
  getAutoTransmuter: {
    ...
    effect: { resource: { autoTransmuter: 1 } },
    cost: [
      { resource: "crystal", costFunction: "linear", priceIncrease: 100 },
      { resource: "sharkonium", costFunction: "linear", priceIncrease: 200 },
    ],
    max: "autoTransmuter",
    prereq: { resource: { sharkonium: 200 }, upgrade: ["engineering"] },
    outcomes: [
    ...
    helpText:
      "Construct a machine to automatically transmute sand and crystal to sharkonium.",
  },
  getSkimmer: {
    name: "Build skimmer",
    effect: { resource: { skimmer: 1 } },
    cost: [
      { resource: "junk", costFunction: "linear", priceIncrease: 300 },
      { resource: "sharkonium", costFunction: "linear", priceIncrease: 200 },
    ],
    max: "skimmer",
    prereq: { resource: { junk: 100 }, upgrade: ["engineering"] },
    outcomes: [
      "Skimmer activated.",
      "Skimmer constructed.",
    ...
    helpText:
      "Construct a machine to automatically recycle kelp and sand into residue.",
  },
  getPurifier: {
    name: "Build purifier",
    effect: { resource: { purifier: 1 } },
    cost: [
      { resource: "sharkonium", costFunction: "linear", priceIncrease: 500 },
    ],
    max: "purifier",
    prereq: { resource: { sharkonium: 500 }, upgrade: ["environmentalism"] },
    outcomes: [
      "Purifier activated.",
    ...
    helpText:
      "Construct a machine to restore vitality to our increasingly murky waters.",
  },
  getHeater: {
    name: "Build heater",
    effect: { resource: { heater: 1 } },
    cost: [
      { resource: "sharkonium", costFunction: "linear", priceIncrease: 300 },
    ],
    max: "heater",
    prereq: {
      resource: { ice: 1, sharkonium: 300 },
  ...
  getSpongeFarmer: {
    ...
    effect: { resource: { spongeFarmer: 1 } },
    cost: [
      { resource: "coralglass", costFunction: "linear", priceIncrease: 200 },
    ],
    max: "spongeFarmer",
    prereq: { resource: { coralglass: 200 }, upgrade: ["coralCircuitry"] },
    outcomes: [
    ...
    helpText:
      "This crustacean machine automatically farms and harvests sponge.",
  },
  getBerrySprayer: {
    name: "Build berry sprayer",
    effect: { resource: { berrySprayer: 1 } },
    cost: [
      { resource: "coralglass", costFunction: "linear", priceIncrease: 500 },
    ],
    max: "berrySprayer",
    prereq: {
      resource: { coralglass: 500, lobster: 2 },
    ...
    helpText:
      "This crustacean machine distributes lobster eggs for optimal hatching conditions.",
  },
  getGlassMaker: {
    name: "Build glass maker",
    effect: { resource: { glassMaker: 1 } },
    cost: [
    ...
    max: "glassMaker",
    prereq: { resource: { coralglass: 400 }, upgrade: ["coralCircuitry"] },
    outcomes: [
  ...
  getSilentArchivist: {
    ...
    helpText:
      "This dolphin machine archives, critiques, and catalogues our science.",
  },
  getTirelessCrafter: {
    name: "Build tireless crafter",
    effect: { resource: { tirelessCrafter: 1 } },
    cost: [
    ...
    max: "tirelessCrafter",
    prereq: { resource: { delphinium: 200 }, upgrade: ["dolphinTechnology"] },
    outcomes: [
  ...
  getClamCollector: {
    ...
    effect: { resource: { clamCollector: 1 } },
    cost: [{ resource: "spronge", costFunction: "linear", priceIncrease: 50 }],
    max: "clamCollector",
    prereq: { resource: { spronge: 50 }, upgrade: ["sprongeBiomimicry"] },
    outcomes: [
  ...
  getEggBrooder: {
    ...
    max: "eggBrooder",
    prereq: {
      resource: { spronge: 150, octopus: 10 },
  ...
  getSprongeSmelter: {
    ...
    effect: { resource: { sprongeSmelter: 1 } },
    cost: [{ resource: "spronge", costFunction: "linear", priceIncrease: 100 }],
    max: "sprongeSmelter",
    prereq: { resource: { spronge: 100 }, upgrade: ["sprongeBiomimicry"] },
    outcomes: [
  ...
  getSeaScourer: {
    ...
    helpText:
      "This octopus machine converts pollution into more useful resources.",
  },
  getProstheticPolyp: {
    name: "Build prosthetic polyp",
    effect: { resource: { prostheticPolyp: 1 } },
    cost: [
      { resource: "spronge", costFunction: "linear", priceIncrease: 100 },
    ...
    helpText:
      "This octopus machine synthesizes coral faster than an entire colony of polyps ever could.",
  },
}),
  (SharkGame.HomeActionCategories = {
    all: { name: "All", actions: [] },
    basic: {
      name: "Basic",
    ...
    unique: { name: "Unique", actions: ["getChorus"] },
  });

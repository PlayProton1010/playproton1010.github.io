pc.script.create("ui_gameover", function (context) {
  ...
  Ui_gameover.prototype = {
    initialize: function () {
      ...
      this.restartButton =
        this.entity.findByName("SpriteRestart").script.sprite;
      this.shareButton = this.entity.findByName("SpriteShare").script.sprite;
      this.spriteGameover =
        this.entity.findByName("SpriteGameover").script.sprite;
      this.spriteHighscore =
        this.entity.findByName("SpriteHiscore").script.sprite;
      this.spriteScoreBg =
        this.entity.findByName("SpriteScoreBg").script.sprite;
      this.spriteHighScoreBg =
        this.entity.findByName("SpriteHiScoreBg").script.sprite;
      this.shareButton = this.entity.findByName("SpriteShare").script.sprite;
      this.scoreText = this.entity.findByName("TextScore").script.font_renderer;
      this.scoreTextShadow =
        this.entity.findByName("TextScoreShadow").script.font_renderer;
    ...
    onShareClicked: function () {
      ...
      window.open(
        pc.string.format(
          "https://twitter.com/intent/tweet?text=I%20just%20scored%20{0}%20in%20Swooop%20by%20@playcanvas.%20Beat%20that!%20http://swooop.playcanvas.com",
          this.score,
        ),
      );
    },

pc.script.create("ui_paused", function (context) {
  ...
  Ui_paused.prototype = {
    initialize: function () {
      ...
      this.soundOnButton =
        this.entity.findByName("SpriteSoundOn").script.sprite;
      this.soundOffButton =
        this.entity.findByName("SpriteSoundOff").script.sprite;
      this.musicOnButton =
        this.entity.findByName("SpriteMusicOn").script.sprite;
      this.musicOffButton =
        this.entity.findByName("SpriteMusicOff").script.sprite;

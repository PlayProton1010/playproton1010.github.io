  ...
  Particle_emitter.prototype = {
    ...
    reset: function () {
      ...
      this.emitter = new pc.scene.ParticleEmitter(context.graphicsDevice, {
        ...
        positionRange: new pc.Vec3(
          this.positionRange[0],
          this.positionRange[1],
          this.positionRange[2],
        ),
        ...
        velocityRange: new pc.Vec3(
          this.velocityRange[0],
          this.velocityRange[1],
          this.velocityRange[2],
        ),
        acceleration: new pc.Vec3(
          this.acceleration[0],
          this.acceleration[1],
          this.acceleration[2],
        ),
        accelerationRange: new pc.Vec3(
          this.accelerationRange[0],
          this.accelerationRange[1],
          this.accelerationRange[2],
        ),
        worldVelocity: new pc.Vec3(
          this.worldVelocity[0],
          this.worldVelocity[1],
          this.worldVelocity[2],
        ),
        worldAcceleration: new pc.Vec3(
          this.worldAcceleration[0],
          this.worldAcceleration[1],
          this.worldAcceleration[2],
        ),
      });

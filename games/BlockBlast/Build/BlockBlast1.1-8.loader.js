function createUnityInstance(t, n, l) {
      ...
      (document.addEventListener("webkitfullscreenchange", function (e) {
        document.webkitCurrentFullScreenElement === t
          ? t.style.width &&
            ...
            (t.style.width = "100%"),
            (t.style.height = "100%"))
          : v && ((t.style.width = v), (t.style.height = y), (y = v = ""));
      }),
  ...
  (u.SystemInfo = (function () {
    ...
    (u.UnityCache =
      ((s = { name: "UnityCache", version: 4 }),
      (d = { name: "RequestMetaDataStore", version: 1 }),
      (f = "RequestStore"),
      (h = "WebAssembly"),
      (m =
        window.indexedDB ||
      ...
      (S.UnityCacheDatabase = s),
      (S.RequestMetaDataStore = d),
      (S.MaximumCacheSize = 1073741824),
      ...
      (S.prototype.loadRequestMetaData = function (e) {
        e = "string" == typeof e ? e : e.url;
        return this.execute(d.name, "get", [e]);
      }),
      (S.prototype.updateRequestMetaData = function (e) {
        return this.execute(d.name, "put", [e]);
      }),
      (S.prototype.storeRequest = function (e, t) {
        var n = this;
        ...
        return void 0 === m
          ...
          : void 0 === window.caches
            ...
            : new Promise(function (t, n) {
                ...
                .then(function () {
                  var e = s.name + "_" + u.companyName + "_" + u.productName;
      ...
      (S.prototype.upgradeDatabase = function (e) {
        var t,
          e = e.target.result;
        e.objectStoreNames.contains(d.name) ||
          ((t = e.createObjectStore(d.name, { keyPath: "url" })),
      ...
      (S.prototype.execute = function (a, i, s) {
        return this.isConnected.then(
          function () {
            return new Promise(
              function (t, n) {
      ...
      (S.prototype.getMetaDataEntries = function () {
        var r = this,
          o = 0,
          a = [];
        return new Promise(function (t, n) {
          var e = r.database
            .transaction([d.name], "readonly")
            .objectStore(d.name)
            .openCursor();
          (e.onsuccess = function (e) {
            e = e.target.result;
      ...
      (S.prototype.cleanUpCache = function () {
        var i = this;
        return this.getMetaDataEntries().then(function (e) {
          ...
          for (a = 0; a < o.length && !(n < S.MaximumCacheSize); ++a)
                    ...
                    if (e)
                      return (
                        ...
                        new Promise(function (e, t) {
                          var n = i.database.transaction([d.name], "readwrite");
                          n.objectStore(d.name).delete(r),
                            (n.oncomplete = e),
                            (n.onerror = t);
                        })
                      );
    ...
    (u.cachedFetch =
      ((g = u.UnityCache),
      (p = u.fetchWithProgress),
      (w = u.readBodyWithProgress),
      function (o, a) {
        var e,
          t,
          i = g.getInstance(),
            ...
            return !l.enabled || l.revalidated
              ...
              : 304 === e.status
                ? ((l.revalidated = !0),
                  ...
                  w(l.response, r.onProgress, r.enableStreamingDownload))
                : 200 == e.status
                  ? ((l.response = e),
                    (l.metaData.updatedAt = l.metaData.accessedAt),
                    (l.revalidated = !0),
                    (t = e.clone()),
                    w(e, r.onProgress, r.enableStreamingDownload).then(
                      function (e) {
                        return (
                  ...
                  : (C(
                    ...
                    w(e, r.onProgress, r.enableStreamingDownload));
          });
        }
        return (
          a &&
                    ...
                    ? ((n = e.response),
                      ...
                      "immutable" == l.control
                        ? ((l.revalidated = !0),
                          ...
                          w(n, a.onProgress, a.enableStreamingDownload))
                        : ((e = s),
                          ((t =
        ...
        : u.SystemInfo.hasWasm
          ? ((u.startupErrorHandler = t),
            ...
            u.postRun.push(function () {
              l(1), delete u.startupErrorHandler, e(k);
            }),
            B())

...
(window.g_aYk = class {
  ...
  g_aYt(e, g, a) {
    this.g_ars.g_aYu()
      ? this.g_aYp(e, g, a)
      : this.g_ars.g_aYv()._OnMessageFromDOM({
          type: "event",
  ...
  (window.g_aYD = class extends g_aYk {
    ...
    g_aYH(e) {
      const g = e.elementId,
        a = this.g_aYE.get(g);
      this.g_aYO(a),
        this.g_aYF && a.parentElement.removeChild(a),
        this.g_aYE.delete(g);
    }
    g_aYP(e, g, a) {
  ...
  window.g_aYV = class e {
    ...
    g_ek() {
      this.g_ask(),
        ...
        this.g_ano &&
          (this.g_ano.parentElement.removeChild(this.g_ano),
          (this.g_ano = null));
    }
    g_aZn() {
      return this.g_ano;
    ...
    async g_ac$(e) {
      if ("playable-ad" === this.g_aps) {
        (this.g_aZj = self.c3_base64files),
          (this.g_aZk = {}),
          await this.g_aZo();
        for (let g = 0, a = e.g_aZp.length; g < a; ++g) {
          ...
          this.g_aZk.hasOwnProperty(a)
            ...
            : this.g_aZj.hasOwnProperty(a) &&
              (e.g_aZp[g] = URL.createObjectURL(this.g_aZj[a]));
        }
      }
      ...
      if (e.g_aZr)
        for (const [g, a] of Object.entries(e.g_aZr))
          this.g_aY$[g] = URL.createObjectURL(a);
      const g = new MessageChannel();
      (this.g_aYY = g.port1),
        (this.g_aYY.onmessage = (e) => this._OnMessageFromRuntime(e.data)),
        window.c3_addPortMessageHandler &&
          window.c3_addPortMessageHandler((e) => this.g_aZs(e)),
        ...
        await this.g_aZv(),
        this.g_aYW
          ? await this.g_aZw(e, g.port2)
          : await this.g_aZx(e, g.port2);
    }
    g_aZy(e) {
      return this.g_aY$.hasOwnProperty(e)
        ? this.g_aY$[e]
        : e.endsWith("/workermain.js") &&
            this.g_aY$.hasOwnProperty("workermain.js")
          ? this.g_aY$["workermain.js"]
          : "playable-ad" === this.g_aps &&
              this.g_aZj.hasOwnProperty(e.toLowerCase())
    ...
    g_aZA(g) {
      return {
        ...
        opusWasmScriptUrl:
          window.cr_opusWasmScriptUrl || this.g_aYZ + "opus.wasm.js",
        opusWasmBinaryUrl:
          window.cr_opusWasmBinaryUrl || this.g_aYZ + "opus.wasm.wasm",
      ...
      document.body.appendChild(this.g_ano),
        ...
        "preview" === this.g_aps &&
          (self.goToLastErrorScript = () =>
            this.g_aYq("runtime", "go-to-last-error-script"));
    }
    async g_aZx(g, a) {
      (this.g_ano = document.createElement("canvas")),
        (this.g_ano.style.display = "none"),
        ...
        (this.g_aZc = i.map((e) => new e(this))),
        this.g_aZI();
      const t = g.g_aZp.map((e) =>
        "string" == typeof e ? new URL(e, this.g_apn).toString() : e,
      );
      if (
        ...
        try {
          if (
            (await Promise.all(g.g_aZJ.map((e) => _(e[1]))),
      ...
      (this.g_aZb = self.C3_CreateRuntime(n)),
        await self.C3_InitRuntime(this.g_aZb, n);
    }
    g_aZK(e) {
    ...
    g_aZP(e, g, a) {
      ...
      a && a.transferables && (_ = a.transferables),
        this.g_aYY.postMessage(
          { type: "result", responseId: e, isOk: g, result: a },
          _,
        );
    }
    g_aZN(g) {
    ...
    g_asj() {
      -1 === this.g_anX &&
        this.g_aZg.length &&
        (this.g_anX = requestAnimationFrame(this.g_aZe));
    }
    g_ask() {
      -1 !== this.g_anX &&
        (cancelAnimationFrame(this.g_anX), (this.g_anX = -1));
    }
    g_aZf() {
      this.g_anX = -1;
    ...
    async g_a_d(e, g) {
      if ("object" == typeof g)
        (this.g_aZj[e] = new Blob([g.str], { type: g.type })),
          (this.g_aZk[e] = g.str);
      else {
    ...
    g_a_g(_) {
      ...
      return (
        (o =
          "base64" === c || "base64" === g ? atob(n) : decodeURIComponent(n)),
        { g_gq: e, data: o }
      );
    }
    g_a_h(_, a) {
...
}
{
  ...
  async function u(e, _, t) {
    ...
    return (
      (n = i.serializeToString(g)),
      (e = new Blob([n], { type: "image/svg+xml" })),
      await s(e)
    );
  }
  function e(e) {
  ...
  function i() {
    ...
    return (
      "textarea" === a ||
      ("input" === a ? _.has(g.type.toLowerCase() || "text") : e(g))
    );
  }
  const h = new Map([
      ["OSLeft", "MetaLeft"],
  ...
  const p = class extends g_aYk {
    ...
    g_aYo() {
      window.addEventListener("focus", () => this.g_a_G("window-focus")),
        ...
        window.addEventListener("dblclick", (e) =>
          this.g_a_I("dblclick", e, l),
        ),
        window.addEventListener("wheel", (e) => this.g_a_J("wheel", e)),
        "undefined" == typeof PointerEvent
          ? (window.addEventListener("mousedown", (e) =>
              this.g_a_K("pointerdown", e),
            ),
            window.addEventListener("mousemove", (e) =>
              this.g_a_K("pointermove", e),
            ),
            window.addEventListener("mouseup", (e) =>
              this.g_a_K("pointerup", e),
            ),
            window.addEventListener("touchstart", (e) =>
              this.g_a_L("pointerdown", e),
            ),
            window.addEventListener("touchmove", (e) =>
              this.g_a_L("pointermove", e),
            ),
            window.addEventListener("touchend", (e) =>
              this.g_a_L("pointerup", e),
            ),
            window.addEventListener("touchcancel", (e) =>
              this.g_a_L("pointercancel", e),
            ))
          : (window.addEventListener("pointerdown", (e) =>
              this.g_a_M("pointerdown", e),
            ),
            this.g_ars.g_aYu() &&
            ...
            self === self.top
              ...
              : window.addEventListener("pointermove", (e) =>
                  this.g_a_M("pointermove", e),
                ),
            window.addEventListener("pointerup", (e) =>
              this.g_a_M("pointerup", e),
            ),
            window.addEventListener("pointercancel", (e) =>
              this.g_a_M("pointercancel", e),
            ));
      const e = () => this.g_aZU();
    ...
    g_aom() {
      ...
      this.g_a_G("window-resize", {
        ...
        this.g_ars.g_as_() &&
          (-1 !== this.g_a_j && clearTimeout(this.g_a_j), this.g_a_R(e, g, 0));
    }
    g_a_S(e, g, a) {
    ...
    g_aro(e) {
      e ? this.g_ars.g_ask() : this.g_ars.g_asj(),
        this.g_aYp("visibilitychange", { hidden: e });
    }
    g_a_H(e, a) {
      "Backspace" === a.key && g(a);
    ...
    g_a_z() {
      this.g_a_l ||
        ((this.g_a_l = !0),
        window.addEventListener("deviceorientation", (e) => this.g_aKc(e)));
    }
    g_a_A() {
      this.g_a_m ||
        ((this.g_a_m = !0),
        window.addEventListener("devicemotion", (e) => this.g_aKd(e)));
    }
    g_aKc(e) {
      this.g_aYp(
        "deviceorientation",
    ...
    g_aKd(_) {
      ...
      c &&
        (e = { alpha: c.alpha || 0, beta: c.beta || 0, gamma: c.gamma || 0 }),
        this.g_aYp(
          "devicemotion",
          {
            acceleration: a,
...
}
{
  ...
  self.g_aZt = class {
    ...
    async g_akw() {
      ...
      const g = new MessageChannel();
      (this.g_atE = g.port1),
        this.g_a_V.postMessage({ type: "_init", "in-port": g.port2 }, [
          g.port2,
        ]),
    ...
    async g_aZL() {
      ...
      return (
        this.g_a_V.postMessage({ type: "_addJobWorker", port: t.port1 }, [
          t.port1,
        ]),
        _.postMessage(
          {
...
}
{
  function e(e, g) {
    return (
      e.length === g.length && (e === g || e.toLowerCase() === g.toLowerCase())
    );
  }
  const g = class extends g_aYk {
    ...
    async g_a$u(e) {
      ...
      if ("undefined" != typeof AudioContext) this.g_a_Z = new AudioContext(g);
        ...
        this.g_a_Z = new webkitAudioContext(g);
      else throw new Error("Web Audio API not supported");
      (this.g_a__ = this.g_a_Z.createGain()),
        this.g_a__.connect(this.g_a_Z.destination);
      ...
      try {
        await Promise.all(
          e.preloadList.map((e) =>
            this.g_a$P(e.originalUrl, e.url, e.type, !1),
          ),
        );
      } catch (e) {
    ...
    g_a$U(e) {
      ...
      this.g_a$q &&
        this.g_a$p === e &&
        (this.g_a$q.disconnect(), this.g_a$q.connect(g));
    }
    g_a$Y() {
      return this.g_azV;
    }
    ...
    *g_a$W(g) {
    ...
    g_JX(e) {
      ...
      for (const g of e.instPans) {
        const e = g.uid;
        for (const a of this.g_a$d)
          a.g_Ei() === e && a.g_baH(g.x, g.y, g.angle);
      }
    }
    async g_a$K(g) {
      const a = g.type,
    ...
    g_baV() {
      this.g_a$o ||
        ((this.g_a$o = !0), Promise.resolve().then(() => this.g_baZ()));
    }
    g_baZ() {
      const e = {};
    ...
    async g_a$N(e) {
      ...
      if (3 !== g)
        for (const e of this.g_a$d)
          (e.g_bak() && 1 === g) || (!e.g_bak() && 2 === g) || e.g_Kg();
      ...
      const _ = [];
      for (const g of Object.values(e.effects))
        _.push(Promise.all(g.map((e) => this.g_a$K(e))));
      await Promise.all(_),
        await Promise.all(e.playing.map((e) => this.g_ba_(e, g))),
        this.g_baw();
    }
    async g_ba_(_, a) {
      if (3 === a) return;
...
"use strict",
  ...
  (self.g_bbg = class extends g_bao {
    ...
    async g_bbB() {
      ...
      if ("cordova" === e.g_asZ() && e.g_f_(this.g_CE))
        this.g_bby = await e.g_BT(this.g_CE);
      else {
    ...
    async g_bbC() {
      return this.g_bbz
        ? this.g_bbz
        : void ((this.g_bbz = await this.g_bbb.g_bag(this.g_bby, this.g_bbA)),
          (this.g_bby = null));
    }
    async g_Hw() {
      try {
        ...
        (this.g_bbf = "failed"),
          console.error(
            `[Construct 3] Failed to load audio '${this.g_CE}': `,
            e,
          );
      }
    }
  ...
  "use strict";
{
  ...
  self.g_bbD = class {
    ...
    g_baH(e, g, a) {
      this.g_bbI &&
        (this.g_bbH.setPosition(e, g, 0),
        this.g_bbH.setOrientation(Math.cos(a), Math.sin(a), 0));
    }
    g_baC(e) {
      this.g_bbN = e;
    }
...
"use strict",
  (self.g_bbi = class extends g_bbD {
    ...
    g_bbR(e) {
      ...
      return (
        e && (g *= this.g_Lz), this.g_aad || (g = Math.min(g, this.g_aio())), g
      );
    }
    g_MW(e, g, _) {
      const a = this.g_bbw();
    ...
    g_aAH(e) {
      (e = !!e),
        this.g_aad === e || ((this.g_aad = e), (this.g_bbw().loop = e));
    }
    g_baG() {
      let e = this.g_Lz;
  ...
  (self.g_bbj = class extends g_bbD {
    ...
    g_bcb() {
      this.g_bbX && this.g_bbX.disconnect(),
        (this.g_bbX = null),
        (this.g_bb_ = null);
    }
    g_bbW(e) {
    ...
    g_bam() {
      return (
        !(!this.g_UO && this.g_bbX && this.g_bbX.loop) &&
        !this.g_aRp &&
        this.g_bbZ
      );
    }
    ...
    g_aAH(e) {
      (e = !!e),
        this.g_aad === e ||
          ((this.g_aad = e), this.g_bbX && (this.g_bbX.loop = e));
    }
    g_baG() {
      let e = this.g_Lz;
      this.g_bbM && (e *= this.g_bbb.g_KX()),
        this.g_bbX && (this.g_bbX.playbackRate.value = e);
    }
    g_aAP(e) {
      this.g_UO ||
        this.g_bam() ||
        (this.g_aRp
          ? (this.g_bb$ = e)
          : (this.g_baD(), (this.g_bb$ = e), this.g_MV()));
    }
    g_bbU() {
      return this.g_bb$;
    }
          ...
          : 1 === _
            ...
            : 2 === _
              ? (g.setValueAtTime(g.value, n),
                g.exponentialRampToValueAtTime(a, t))
              : void 0;
    }
    g_bax() {
  ...
  (self.g_baI = class extends e {
    ...
    (self.g_baK = class extends e {
      ...
      g_bax() {
        const e = super.g_bax();
        return (
          (e.bufferOriginalUrl = this.g_bcm),
          (e.bufferUrl = ""),
          (e.bufferType = this.g_bco),
          e
        );
      }
    }),
    (self.g_baN = class extends e {
      ...
      g_baW(e, g, a, _) {
        0 === e
          ...
          : 6 === e
            ? ((this.g_bcc[1] = g / 1e3),
              this.g_bce(this.g_bcs.gain, g / 1e3, a, _))
            : 7 === e
              ? ((this.g_bcc[2] = g), this.g_bce(this.g_bcr.frequency, g, a, _))
              : 8 === e
                ? ((this.g_bcc[3] = g / 100),
                  this.g_bce(this.g_bcq.gain, g / 100, a, _))
                : void 0;
      }
    }),
            ...
            : 2 === e
              ...
              : 3 === e
                ...
                : 6 === e
                  ...
                  : 7 === e
                    ? ((this.g_bcc[4] = g),
                      this.g_bce(this.g_bcr.frequency, g, a, _))
                    : void 0;
      }
    }),
    (self.g_baP = class extends e {
      ...
      g_baW(g, a, t, n) {
        4 === g
          ? ((this.g_bcc[0] = _(a)), this.g_bce(this.g_bct.gain, _(a), t, n))
          : void 0;
      }
    }),
    ...
    (self.g_baU = class extends e {
      ...
      g_KZ() {
        this.g_bct.getFloatFrequencyData(this.g_bcC),
          this.g_bct.getByteTimeDomainData(this.g_bcD);
  ...
  const e = class extends g_aYk {
    ...
    async g_bcJ() {
      ...
      try {
        ...
        return (
          console.warn("[Touch] Failed to request motion permission: ", e), !1
        );
      }
    }
  };

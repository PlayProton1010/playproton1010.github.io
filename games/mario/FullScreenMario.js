...
(function (FullScreenMario_1) {
  ...
  var FullScreenMario = (function (_super) {
    ...
    FullScreenMario.prototype.resetAudioPlayer = function (FSM, settings) {
      ...
      FSM.AudioPlayer.setGetThemeDefault(
        FSM.getAudioThemeDefault.bind(FSM, FSM),
      );
    };
    /**
    ...
    FullScreenMario.prototype.resetItemsHolder = function (FSM, settings) {
      ...
      if (settings.width < 560) {
        FSM.ItemsHolder.getContainer().children[0].cells[4].style.display =
          "none";
      }
    };
    /**
    ...
    FullScreenMario.prototype.gameStart = function () {
      ...
      FSM.setMap(
        FSM.settings.maps.mapDefault,
        FSM.settings.maps.locationDefault,
      );
      FSM.ItemsHolder.setItem(
        "lives",
        FSM.settings.items.values.lives.valueDefault,
      );
    ...
    FullScreenMario.prototype.gameOver = function () {
      var FSM = FullScreenMario.prototype.ensureCorrectCaller(this),
        text = FSM.ObjectMaker.make("CustomText", {
          texts: [
            {
              text: "GAME OVER",
            },
     ...
     */
    FullScreenMario.prototype.thingProcess = function (
      thing,
      title,
      settings,
      defaults,
      ...
      if (thing.height === "Infinity" || thing.height === Infinity) {
        thing.height =
          thing.FSM.getAbsoluteHeight(thing.y) / thing.FSM.unitsize;
      }
      _super.prototype.thingProcess.call(
        this,
        thing,
        title,
        settings,
    ...
    FullScreenMario.prototype.generateThingKey = function (thing) {
      return (
        thing.GameStarter.AreaSpawner.getArea().setting +
        " " +
        thing.groupType +
        " " +
        thing.title +
    ...
    FullScreenMario.prototype.addPreThing = function (prething) {
      ...
      thing.FSM.addThing(
        ...
        (thing.FSM.MapScreener.floor - prething.top) * thing.FSM.unitsize,
      );
    ...
    FullScreenMario.prototype.addPlayer = function (left, bottom) {
      if (left === void 0) {
        left = this.unitsize * 16;
      }
      if (bottom === void 0) {
        bottom = this.unitsize * 16;
      }
      var FSM = FullScreenMario.prototype.ensureCorrectCaller(this),
        player;
    ...
    FullScreenMario.prototype.deviceMotion = function (FSM, event) {
      var player = FSM.player,
        deviceMotionStatus = FSM.deviceMotionStatus,
    ...
    FullScreenMario.prototype.maintainScenery = function (FSM) {
      var things = FSM.GroupHolder.getGroup("Scenery"),
        delx = FSM.QuadsKeeper.left,
        thing,
        i;
    ...
    FullScreenMario.prototype.maintainCharacters = function (FSM, characters) {
      var delx = FSM.QuadsKeeper.right,
        character,
        i;
     ...
     */
    FullScreenMario.prototype.generateIsCharacterTouchingCharacter =
      function () {
        /**
     ...
     */
    FullScreenMario.prototype.isCharacterBumpingSolid = function (
      thing,
      other,
    ) {
     ...
     */
    FullScreenMario.prototype.isCharacterOverlappingSolid = function (
      thing,
      other,
    ) {
    ...
    FullScreenMario.prototype.jumpEnemy = function (thing, other) {
      ...
      if (!thing.item || other.shell) {
        thing.jumpcount += 1;
        thing.FSM.scoreOn(
          thing.FSM.findScore(thing.jumpcount + thing.jumpers),
          other,
        );
      }
      thing.jumpers += 1;
    ...
    FullScreenMario.prototype.spawnLakitu = function (thing) {
      ...
      thing.FSM.TimeHandler.addEventInterval(
        thing.FSM.animateLakituThrowingSpiny,
        140,
        Infinity,
        thing,
      );
    ...
    FullScreenMario.prototype.spawnMoveFloating = function (thing) {
      ...
      thing.begin =
        thing.FSM.MapScreener.floor * thing.FSM.unitsize - thing.begin;
    ...
    FullScreenMario.prototype.spawnRandomCheep = function (FSM) {
      ...
      FSM.addThing(
        spawn,
        FSM.NumberMaker.random() * FSM.MapScreener.width,
        FSM.MapScreener.height,
      );
    ...
    FullScreenMario.prototype.spawnCustomText = function (thing) {
      var top = thing.top,
        ...
        spacingHorizontal = thing.spacingHorizontal * thing.FSM.unitsize,
        spacingVertical = thing.spacingVertical * thing.FSM.unitsize,
        spacingVerticalBlank = thing.spacingVerticalBlank * thing.FSM.unitsize,
        children = [],
        textChild,
        left,
        text,
     ...
     */
    FullScreenMario.prototype.spawnCollectionComponent = function (
      collection,
      thing,
    ) {
    ...
    FullScreenMario.prototype.spawnRandomSpawner = function (thing) {
      var FSM = thing.FSM,
        left = (thing.left + FSM.MapScreener.left) / FSM.unitsize;
    ...
    FullScreenMario.prototype.activateBulletBillsStart = function (thing) {
      ...
      thing.FSM.TimeHandler.addEventInterval(
        thing.FSM.spawnRandomBulletBill,
        210,
        Infinity,
        thing.FSM,
      );
    ...
    FullScreenMario.prototype.activateWindowDetector = function (thing) {
      if (
        thing.FSM.MapScreener.right - thing.FSM.MapScreener.left <
        thing.left
      ) {
        return;
      }
    ...
    FullScreenMario.prototype.activateSectionBefore = function (thing) {
      var FSM = thing.FSM,
        MapsCreator = FSM.MapsCreator,
        MapScreener = FSM.MapScreener,
        AreaSpawner = FSM.AreaSpawner,
        area = AreaSpawner.getArea(),
        map = AreaSpawner.getMap(),
        prethings = AreaSpawner.getPreThings(),
    ...
    FullScreenMario.prototype.activateSectionStretch = function (thing) {
      var FSM = thing.FSM,
        ...
        left = (thing.left + MapScreener.left) / FSM.unitsize,
        width = MapScreener.width / FSM.unitsize,
        command,
        i;
     ...
     * @param other   A Solid being touched by thing.
     */
    FullScreenMario.prototype.collideCharacterSolidUp = function (
      thing,
      other,
    ) {
    ...
    FullScreenMario.prototype.collideShellPlayer = function (thing, other) {
      var shelltoleft = thing.FSM.objectToLeft(other, thing),
        playerjump =
          thing.yvel > 0 && thing.bottom <= other.top + thing.FSM.unitsize * 2;
    ...
    FullScreenMario.prototype.collideBottomBlock = function (thing, other) {
      ...
      thing.FSM.TimeHandler.addEvent(
        thing.FSM.animateSolidContents,
        7,
        thing,
        other,
      );
    ...
    FullScreenMario.prototype.collideCastleAxe = function (thing, other) {
      if (
        !thing.FSM.MathDecider.compute("canPlayerTouchCastleAxe", thing, other)
      ) {
        return;
      }
    ...
    FullScreenMario.prototype.moveSmart = function (thing) {
      ...
      if (
        !thing.resting ||
        !thing.FSM.isCharacterOnResting(thing, thing.resting)
      ) {
        if (thing.moveleft) {
    ...
    FullScreenMario.prototype.moveFloating = function (thing) {
      ...
      if (thing.top <= thing.end) {
        thing.yvel = Math.min(
          thing.yvel + thing.FSM.unitsize / 64,
          thing.maxvel,
        );
    ...
    FullScreenMario.prototype.moveSliding = function (thing) {
      ...
      if (thing.FSM.MapScreener.left + thing.left <= thing.begin) {
        thing.xvel = Math.min(
          thing.xvel + thing.FSM.unitsize / 64,
          thing.maxvel,
        );
    ...
    FullScreenMario.prototype.movePlatformSpawn = function (thing) {
      ...
      if (thing.FSM.player && thing.FSM.player.resting === thing) {
    ...
    FullScreenMario.prototype.moveFalling = function (thing) {
      ...
      if (
        thing.yvel >= (thing.fallThresholdStart || thing.FSM.unitsize * 2.8)
      ) {
        thing.freefall = true;
    ...
    FullScreenMario.prototype.moveSpringboardUp = function (thing) {
      ...
      if (thing.height > thing.heightNormal) {
        ...
        if (thing === player.spring) {
          player.yvel = thing.FSM.MathDecider.compute(
            "springboardYvelUp",
            thing,
          );
    ...
    FullScreenMario.prototype.movePiranha = function (thing) {
      ...
      if (thing.resting && !thing.FSM.isThingAlive(thing.resting)) {
        bottom =
          thing.constructor.prototype.height * thing.FSM.unitsize + thing.top;
        height = Infinity;
        thing.resting = undefined;
      }
      if (height <= 0) {
    ...
    FullScreenMario.prototype.movePlayer = function (thing) {
      ...
      if (thing.keys.crouch && !thing.crouching && thing.resting) {
        ...
        if (thing.resting.actionTop) {
          thing.FSM.ModAttacher.fireEvent(
            "onPlayerActionTop",
            thing,
            thing.resting,
          );
      ...
      if (thing.xvel > 0) {
        ...
        if (
          thing.moveleft &&
          (thing.resting || thing.FSM.MapScreener.underwater)
        ) {
          thing.FSM.unflipHoriz(thing);
          thing.moveleft = false;
        }
    ...
    FullScreenMario.prototype.animateBrickShards = function (thing) {
      var unitsize = thing.FSM.unitsize,
        shard,
        left,
        top,
        i;
      for (i = 0; i < 4; i += 1) {
        left =
          thing.left + Number(i < 2) * thing.width * unitsize - unitsize * 2;
    ...
    FullScreenMario.prototype.animateEmerge = function (thing, other) {
      ...
      thing.FSM.arraySwitch(
        thing,
        thing.FSM.GroupHolder.getGroup("Character"),
        thing.FSM.GroupHolder.getGroup("Scenery"),
      );
      thing.FSM.TimeHandler.addEventInterval(
        function () {
          ...
          thing.FSM.setBottom(thing, other.top);
          thing.FSM.GroupHolder.switchMemberGroup(
            thing,
            "Scenery",
            "Character",
          );
     ...
     */
    FullScreenMario.prototype.animateFlicker = function (
      thing,
      cleartime,
      interval,
    ) {
    ...
    FullScreenMario.prototype.animateBowserFire = function (thing) {
      ...
      thing.FSM.TimeHandler.addEvent(
        thing.FSM.animateBowserFireOpen,
        14,
        thing,
      );
      return false;
    ...
    FullScreenMario.prototype.animateBowserFireOpen = function (thing) {
      var unitsize = thing.FSM.unitsize,
        ylev = Math.max(
          ...
          Math.round(thing.FSM.player.bottom / (unitsize * 8)) * unitsize * 8,
        );
      if (!thing.FSM.isThingAlive(thing)) {
        return true;
      }
    ...
    FullScreenMario.prototype.animatePlayerFire = function (thing) {
      ...
      var xloc = thing.moveleft
        ...
        ball = thing.FSM.ObjectMaker.make("Fireball", {
    ...
    FullScreenMario.prototype.animateCastleBlock = function (thing, balls) {
      var midx = thing.EightBitter.getMidX(thing),
        midy = thing.EightBitter.getMidY(thing),
        ax = Math.cos(thing.angle * Math.PI) * thing.FSM.unitsize * 4,
        ay = Math.sin(thing.angle * Math.PI) * thing.FSM.unitsize * 4,
        i;
    ...
    FullScreenMario.prototype.animatePlayerRunningCycle = function (thing) {
      ...
      thing.running = thing.FSM.TimeHandler.addClassCycle(
        thing,
        ["one", "two", "three", "two"],
        "running",
        function () {
     ...
     *                       (by default, false).
     */
    FullScreenMario.prototype.animateCharacterPauseVelocity = function (
      thing,
      keepMovement,
    ) {
     ...
     *                     (by default, false).
     */
    FullScreenMario.prototype.animateCharacterResumeVelocity = function (
      thing,
      noVelocity,
    ) {
      if (!noVelocity) {
     ...
     */
    FullScreenMario.prototype.killReplace = function (
      thing,
      title,
      attributes,
      attributesCopied,
    ...
    FullScreenMario.prototype.killKoopa = function (thing, big) {
      ...
      if (thing.jumping || thing.floating) {
        spawn = thing.FSM.killReplace(thing, "Koopa", undefined, [
          "smart",
          "direction",
          "moveleft",
        ]);
    ...
    FullScreenMario.prototype.killLakitu = function (thing) {
      var characters = thing.FSM.GroupHolder.getGroup("Character"),
        i;
      thing.FSM.killFlip(thing);
    ...
    FullScreenMario.prototype.killPlayer = function (thing, big) {
      ...
      var FSM = thing.FSM,
        area = thing.FSM.AreaSpawner.getArea();
    ...
    FullScreenMario.prototype.setMap = function (name, location) {
      ...
      FSM.setLocation(
        location || map.locationDefault || FSM.settings.maps.locationDefault,
      );
    ...
    FullScreenMario.prototype.mapEntranceVine = function (FSM) {
      var threshold = FSM.MapScreener.bottom - FSM.unitsize * 40,
        vine = FSM.addThing(
          "Vine",
          FSM.unitsize * 32,
    ...
    FullScreenMario.prototype.mapEntranceVinePlayer = function (FSM, vine) {
      var threshold = FSM.MapScreener.bottom - FSM.unitsize * 24,
        speed = FSM.unitsize / -4,
        player = FSM.addPlayer(
          FSM.unitsize * 29,
     ...
     *                   not used).
     */
    FullScreenMario.prototype.mapEntrancePipeVertical = function (
      FSM,
      location,
    ) {
      if (location && location.xloc) {
     ...
     *                   not used).
     */
    FullScreenMario.prototype.mapEntrancePipeHorizontal = function (
      FSM,
      location,
    ) {
     ...
     */
    FullScreenMario.prototype.mapExitPipeHorizontal = function (
      thing,
      other,
      shouldTransport,
    ) {
     ...
     */
    FullScreenMario.prototype.getAbsoluteHeight = function (
      yloc,
      correctUnitsize,
    ) {
      var FSM = FullScreenMario.prototype.ensureCorrectCaller(this),
    ...
    FullScreenMario.prototype.mapAddStretched = function (prethingRaw) {
      var FSM = FullScreenMario.prototype.ensureCorrectCaller(this),
        boundaries = FSM.AreaSpawner.getArea().boundaries,
        prething =
          prethingRaw instanceof String ? { thing: prething } : prethingRaw,
        y = (FSM.MapScreener.floor - prething.y) * FSM.unitsize,
     ...
     */
    FullScreenMario.prototype.cutsceneFlagpoleStartSlidingDown = function (
      FSM,
      settings,
    ) {
      var thing = settings.player,
        other = settings.collider,
        height = (other.bottom - thing.bottom) | 0,
        scoreAmount = FSM.scorePlayerFlag(thing, height / FSM.unitsize),
        scoreThing = FSM.ObjectMaker.make("Text" + scoreAmount);
     ...
     * @param settings   Storage for the cutscene from ScenePlayr.
     */
    FullScreenMario.prototype.cutsceneFlagpoleHitBottom = function (
      FSM,
      settings,
    ) {
      var thing = settings.player;
     ...
     * @param settings   Storage for the cutscene from ScenePlayr.
     */
    FullScreenMario.prototype.cutsceneFlagpoleCountdown = function (
      FSM,
      settings,
    ) {
      FSM.TimeHandler.addEventInterval(
        function () {
          ...
          FSM.TimeHandler.addEvent(
            FSM.ScenePlayer.bindRoutine("Fireworks"),
            35,
          );
          return true;
        },
     ...
     * @param settings   Storage for the cutscene from ScenePlayr.
     */
    FullScreenMario.prototype.cutsceneFlagpoleFireworks = function (
      FSM,
      settings,
    ) {
      var numFireworks = FSM.MathDecider.compute(
          "numberOfFireworks",
          settings.time,
        ),
        player = settings.player,
        detector = settings.detector,
        doorRight = detector.left,
        doorLeft = doorRight - FSM.unitsize * 8,
        doorBottom = detector.bottom,
        doorTop = doorBottom - FSM.unitsize * 16,
        flag = FSM.ObjectMaker.make("CastleFlag", {
          position: "beginning",
        }),
        flagMovements = 28,
        fireInterval = 28,
     ...
     * @param settings   Storage for the cutscene from ScenePlayr.
     */
    FullScreenMario.prototype.cutsceneBowserVictoryCollideCastleAxe = function (
      FSM,
      settings,
    ) {
     ...
     */
    FullScreenMario.prototype.cutsceneBowserVictoryCastleBridgeOpen = function (
      FSM,
      settings,
    ) {
     ...
     */
    FullScreenMario.prototype.cutsceneBowserVictoryBowserFalls = function (
      FSM,
      settings,
    ) {
     ...
     */
    FullScreenMario.prototype.cutsceneBowserVictoryDialog = function (
      FSM,
      settings,
    ) {
      var player = settings.player,
     ...
     */
    FullScreenMario.prototype.macroFillPreThings = function (
      reference,
      prethings,
      area,
      map,
      ...
      var defaults = FSM.ObjectMaker.getFullPropertiesOf(reference.thing),
     ...
     */
    FullScreenMario.prototype.macroFillPrePattern = function (
      reference,
      prethings,
      area,
      map,
      ...
      var pattern = FSM.settings.maps.patterns[reference.pattern],
        length = pattern.length,
        defaults = FSM.ObjectMaker.getFullProperties(),
     ...
     */
    FullScreenMario.prototype.macroFloor = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroPipe = function (
      reference,
      prethings,
      area,
      map,
      ...
      var x = reference.x || 0,
        ...
        pipe = FullScreenMario.prototype.proliferate(
          {
            thing: "Pipe",
            x: x,
            y: y,
     ...
     */
    FullScreenMario.prototype.macroPipeCorner = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroTree = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroShroom = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroWater = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroScale = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroPlatformGenerator = function (
      reference,
      prethings,
      area,
      map,
      ...
      var output = [],
        ...
        x = reference.x || 0,
        yvel = direction * FSM.unitsize * 0.42,
        i;
     ...
     */
    FullScreenMario.prototype.macroWarpWorld = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroCheepsStart = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroCheepsStop = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroBulletBillsStart = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroBulletBillsStop = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroLakituStop = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroCastleSmall = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroCastleLarge = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroEndOutsideCastle = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    FullScreenMario.prototype.macroEndInsideCastle = function (
      reference,
      prethings,
      area,
      map,
     ...
     * @returns A section.
     */
    FullScreenMario.prototype.macroSection = function (
      reference,
      prethings,
      area,
      map,
    ...
    FullScreenMario.prototype.ensureCorrectCaller = function (current) {
      if (!(current instanceof FullScreenMario)) {
        throw new Error(
          "A function requires the scope ('this') to be the " +

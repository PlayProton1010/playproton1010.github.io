...
(function (GroupHoldr_1) {
  ...
  var GroupHoldr = (function () {
     ...
     */
    GroupHoldr.prototype.switchMemberGroup = function (
      value,
      groupNameOld,
      groupNameNew,
      keyOld,
    ...
    GroupHoldr.prototype.createFunctionSetGroup = function (name) {
       ...
       */
      this.functions.setGroup[name] = this["set" + name + "Group"] = function (
        value,
      ) {
    ...
    GroupHoldr.prototype.createFunctionGetGroup = function (name) {
       ...
       */
      this.functions.getGroup[name] = this["get" + name + "Group"] =
        function () {

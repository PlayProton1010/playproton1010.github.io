...
(function (InputWritr_1) {
  ...
  var InputWritr = (function () {
     ...
     *                    now be callable.
     */
    InputWritr.prototype.switchAliasValues = function (
      name,
      valuesOld,
      valuesNew,
    ) {
    ...
    InputWritr.prototype.saveHistory = function (name) {
      if (name === void 0) {
        name = Object.keys(this.histories).length.toString();
      }
     ...
     */
    InputWritr.prototype.makePipe = function (
      trigger,
      codeLabel,
      preventDefaults,
    ) {

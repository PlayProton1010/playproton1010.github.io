...
(function (ThingHittr_1) {
  ...
  var ThingHittr = (function () {
    ...
    ThingHittr.prototype.cacheChecksForType = function (typeName, groupName) {
      if (
        !this.generatedGlobalChecks.hasOwnProperty(typeName) &&
        this.globalCheckGenerators.hasOwnProperty(groupName)
      ) {
        this.generatedGlobalChecks[typeName] =
          this.globalCheckGenerators[groupName]();
    ...
    ThingHittr.prototype.generateHitsCheck = function (typeName) {
      ...
      return function (thing) {
        ...
        var groupNames = _this.groupHitLists[thing[_this.keyGroupName]],
          groupName,
          others,
          other,
          i,
        ...
        for (i = 0; i < thing[_this.keyNumQuads]; i += 1) {
          for (j = 0; j < groupNames.length; j += 1) {
            ...
            for (k = 0; k < others.length; k += 1) {
              ...
              if (
                !_this.generatedGlobalChecks[other[_this.keyTypeName]](other)
              ) {
                continue;
              }
     ...
     */
    ThingHittr.prototype.runThingsFunctionSafely = function (
      group,
      thing,
      other,
      generators,
    ) {
      var typeThing = thing[this.keyTypeName],
        typeOther = other[this.keyTypeName],
      ...
      if (!check) {
        check = container[typeOther] =
          generators[thing[this.keyGroupName]][other[this.keyGroupName]]();
      }

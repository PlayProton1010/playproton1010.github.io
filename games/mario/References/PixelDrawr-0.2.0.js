...
(function (PixelDrawr_1) {
  ...
  var PixelDrawr = (function () {
     ...
     */
    PixelDrawr.prototype.drawThingOnContextSingle = function (
      context,
      canvas,
      thing,
      left,
     ...
     * @param top   The y-position to draw the Thing from.
     */
    PixelDrawr.prototype.drawThingOnContextMultiple = function (
      context,
      canvases,
      thing,
      left,
     ...
     */
    PixelDrawr.prototype.drawPatternOnContext = function (
      context,
      source,
      left,
      top,

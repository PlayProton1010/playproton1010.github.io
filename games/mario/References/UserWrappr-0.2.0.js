...
(function (UserWrappr) {
  ...
  (function (UISchemas) {
    ...
    var ButtonsGenerator = (function (_super) {
       ...
       * @param schema
       */
      ButtonsGenerator.prototype.ensureLocalStorageButtonValue = function (
        child,
        details,
        schema,
      ) {
        var key = schema.title + "::" + details.title,
          valueDefault = details.source.call(this, this.GameStarter).toString(),
          value;
    ...
    var LevelEditorGenerator = (function (_super) {
      ...
      LevelEditorGenerator.prototype.generate = function (schema) {
        var output = document.createElement("div"),
          ...
          betweenOne = document.createElement("div"),
          betweenTwo = document.createElement("div"),
          uploader = this.createUploaderDiv(),
          mapper = this.createMapSelectorDiv(schema),
          scope = this;
      ...
      LevelEditorGenerator.prototype.createMapSelectorDiv = function (schema) {
        var expanded = true,
          ...
          mapsIn = this.UserWrapper.getGenerators()[generatorName].generate(
        ...
        toggler.onclick = function (event) {
          ...
          [].slice
            .call(container.parentElement.children)
       ...
       */
      LevelEditorGenerator.prototype.handleFileDragEnter = function (
        uploader,
        event,
      ) {
       ...
       * @param event   The event caused by the dragging.
       */
      LevelEditorGenerator.prototype.handleFileDragOver = function (
        uploader,
        event,
      ) {
       ...
       * @param event   The event caused by the dragging.
       */
      LevelEditorGenerator.prototype.handleFileDragLeave = function (
        uploader,
        event,
      ) {
        if (event.dataTransfer) {
       ...
       * @param event   The event caused by the dragging.
       */
      LevelEditorGenerator.prototype.handleFileDrop = function (
        input,
        uploader,
        event,
      ) {
       ...
       */
      LevelEditorGenerator.prototype.handleFileUploadProgress = function (
        file,
        uploader,
        event,
      ) {
       ...
       */
      LevelEditorGenerator.prototype.handleFileUploadCompletion = function (
        file,
        uploader,
        event,
      ) {
...
(function (UserWrappr) {
  ...
  (function (UISchemas) {
    ...
    var TableGenerator = (function (_super) {
       ...
       */
      TableGenerator.prototype.setBooleanInput = function (
        input,
        details,
        schema,
      ) {
        var status = details.source.call(this, this.GameStarter),
      ...
      TableGenerator.prototype.setKeyInput = function (input, details, schema) {
        var values = details.source.call(this, this.GameStarter),
          possibleKeys = this.UserWrapper.getAllPossibleKeys(),
          children = [],
          child,
          scope = this,
          valueLower,
       ...
       * @returns An HTML element containing the input.
       */
      TableGenerator.prototype.setNumberInput = function (
        input,
        details,
        schema,
      ) {
       ...
       * @returns An HTML element containing the input.
       */
      TableGenerator.prototype.setSelectInput = function (
        input,
        details,
        schema,
      ) {
        var child = document.createElement("select"),
          options = details.options(this.GameStarter),
          scope = this,
          i;
        for (i = 0; i < options.length; i += 1) {
       ...
       * @returns An HTML element containing the input.
       */
      TableGenerator.prototype.setScreenSizeInput = function (
        input,
        details,
        schema,
      ) {
       ...
       */
      TableGenerator.prototype.ensureLocalStorageInputValue = function (
        childRaw,
        details,
        schema,
      ) {
        ...
        var child = childRaw,
          key = schema.title + "::" + details.title,
          valueDefault = details.source.call(this, this.GameStarter).toString(),
          value;
        child.setAttribute("localStorageKey", key);
        this.GameStarter.ItemsHolder.addItem(key, {
       ...
       * @param schema   The container schema this child is within.
       */
      TableGenerator.prototype.ensureLocalStorageValues = function (
        children,
        details,
        schema,
      ) {
       ...
       */
      TableGenerator.prototype.storeLocalStorageValue = function (
        child,
        value,
      ) {
...
(function (UserWrappr_1) {
  ...
  var UserWrappr = (function () {
    ...
    UserWrappr.prototype.importSizes = function (sizesRaw) {
      var sizes = this.GameStartrConstructor.prototype.proliferate(
          {},
          sizesRaw,
        ),
        i;
    ...
    UserWrappr.prototype.fixCustoms = function (customsRaw) {
      var customs = this.GameStartrConstructor.prototype.proliferate(
        {},
        customsRaw,
      );
      this.GameStartrConstructor.prototype.proliferate(
    ...
    UserWrappr.prototype.loadControls = function (schemas) {
      var section = document.querySelector(this.gameControlsSelector),

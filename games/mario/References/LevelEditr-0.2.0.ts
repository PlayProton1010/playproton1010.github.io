...
namespace LevelEditr {
  ...
  export class LevelEditr implements ILevelEditr {
     ...
     */
    downloadCurrentJSON(): void {
      var link: HTMLLinkElement = this.downloadFile(
    ...
    private resetCurrentThings(event?: MouseEvent): void {
      var currentThing: IPreThing, i: number;
    ...
    private onClickEditingThing(event: MouseEvent): void {
      ...
      var coordinates: number[] = this.getNormalizedMouseEventCoordinates(
          event,
          true,
        ),
    ...
    private onClickEditingMacro(event: MouseEvent): void {
      ...
      var coordinates: number[] =
          this.getNormalizedMouseEventCoordinates(event),
        x: number = coordinates[0],
        y: number = coordinates[1],
        prething: IPreThing,
        i: number;
     ...
     *
     */
    private onClickEditingGenericAdd(
      x: number,
      y: number,
      title: string,
      args: any,
    ...
    private onThingIconClick(title: string, event: MouseEvent): void {
      var x: number = event.x || event.clientX || 0,
        y: number = event.y || event.clientY || 0,
        target: IThingIcon =
          (<HTMLDivElement>event.target).nodeName === "DIV"
     ...
     *
     */
    private createPrethingsHolder(
      prethings: IPreThing[],
    ): MapsCreatr.IPreThingsRawContainer {
    ...
    private generateCurrentArgs(): any {
      var args: any = {},
        ...
        children: NodeList =
          container.getElementsByClassName("VisualOptionsList"),
     ...
     *
     */
    private resetAllVisualOptionSelects(
      className: string,
      options: any[],
    ): void {
      var map: IMapsCreatrMapRaw = this.getMapObject(),
        elements: NodeList =
          this.display.container.getElementsByClassName(className),
        attributes: any = {
    ...
    private getMapObject(): IMapsCreatrMapRaw {
      ...
      try {
        map = <IMapsCreatrMapRaw>(
          this.parseSmart(this.display.stringer.textarea.value)
        );
        (<HTMLDivElement>this.display.stringer.messenger).textContent = "";
        (<HTMLInputElement>this.display.namer).value =
          map.name || this.mapNameDefault;
      } catch (error) {
        this.setSectionJSON();
        (<HTMLDivElement>this.display.stringer.messenger).textContent =
          error.message;
     ...
     *
     */
    private getCurrentLocationObject(
      map: IMapsCreatrMapRaw,
    ): MapsCreatr.IMapsCreatrLocationRaw {
    ...
    private resetDisplaySectionChoosers(): void {
      var sectionChoosers: HTMLDivElement = this.GameStarter.createElement(
        "div",
        {
          ...
          children: [
            ...
            (this.display.sections.buttons.JSON =
              this.GameStarter.createElement("div", {
                className:
                  "EditorMenuOption EditorSectionChooser EditorMenuOptionThird",
                style: {
    ...
    private resetDisplayJSON(): void {
      this.display.sections.JSON = this.GameStarter.createElement("div", {
        ...
        children: [
          (this.display.stringer.textarea = <HTMLTextAreaElement>(
            this.GameStarter.createElement("textarea", {
      ...
      this.display.gui.appendChild(
        this.GameStarter.createElement("div", {
          ...
          children: (function (actions: any): HTMLDivElement[] {
            return Object.keys(actions).map(function (
              key: string,
            ): HTMLDivElement {
        ...
        this.GameStarter.createElement("div", {
          ...
          children: (function (): HTMLElement[] {
            var selectedIndex: number = 0,
              containers: HTMLElement[] = Object.keys(scope.prethings).map(
                function (key: string): HTMLDivElement {
                  var prethings: IPreThingDimensionDescriptor[] =
                      scope.prethings[key],
                    children: HTMLDivElement[] = Object.keys(prethings).map(
                      function (title: string): HTMLDivElement {
                        var prething: IPreThing = prethings[title],
                          ...
                          sizeMax: number = 70,
                          widthThing: number =
                            thing.width * scope.GameStarter.unitsize,
                          heightThing: number =
                            thing.height * scope.GameStarter.unitsize,
                  ...
                  return <HTMLDivElement>scope.GameStarter.createElement(
                    "div",
                    {
              ...
              switcher: HTMLSelectElement = scope.createSelect(
                Object.keys(scope.prethings),
                {
    ...
    private resetDisplayOptionsListSubOptionsMacros(): void {
      ...
      scope.display.sections.ClickToPlace.Macros =
        scope.GameStarter.createElement("div", {
          ...
          children: Object.keys(scope.macros).map(function (
            key: string,
          ): HTMLDivElement {
     ...
     *
     */
    private setVisualOptions(
      name: string,
      description: string,
      options: any,
    ): void {
      var visual: HTMLDivElement =
          this.display.sections.ClickToPlace.VisualOptions,
      ...
      if (options) {
        visual.appendChild(
          scope.GameStarter.createElement("div", {
            ...
            children: Object.keys(options).map(function (
              key: string,
            ): HTMLDivElement {
     ...
     *
     */
    private createVisualOption(
      optionRaw: number | string | any | any[],
     ...
     *
     */
    private createVisualOptionObject(
      optionRaw: number | string | any | any[],
    ): HTMLElement {
      var option: any;
        ...
        children: (function (): HTMLElement[] {
          var modReal: number = option.mod || 1,
            input: HTMLInputElement = <HTMLInputElement>(
              scope.GameStarter.createElement("input", {
                type: "Number",
                "data:type": "Number",
     ...
     *
     */
    private createVisualOptionLocation(
      option: any,
    ): HTMLDivElement | HTMLSelectElement {
      var map: IMapsCreatrMapRaw = this.getMapObject(),
        locations: string[],
     ...
     *
     */
    private createVisualOptionArea(
      option: any,
    ): HTMLDivElement | HTMLSelectElement {
      var map: IMapsCreatrMapRaw = this.getMapObject(),
        areas: string[],
    ...
    private createVisualOptionEverything(option: any): HTMLSelectElement {
      var select: HTMLSelectElement = this.createSelect(
        Object.keys(this.things),
        {
    ...
    private disableAllThings(): void {
      var scope: LevelEditr = this,
        groups: GroupHoldr.IGroupHoldrGroups<IThing> =
          this.GameStarter.GroupHolder.getGroups(),
        i: string;
     ...
     *
     */
    private addThingAndDisableEvents(
      thing: IThing,
      x?: number,
      y?: number,
    ): void {
    ...
    private getNormalizedY(raw: number): number {
      return (
        (<any>this.GameStarter.MapScreener).floor -
     ...
     *
     */
    private getNormalizedMouseEventCoordinates(
      event: MouseEvent,
      referenceThing?: boolean,
    ): number[] {
      var x: number = this.roundTo(
          event.x || event.clientX || 0,
          this.blocksize,
        ),
     ...
     *
     */
    private getPrethingSizeArgument(
      descriptor: IPreThingDimensionDescriptor,
    ): number {
      if (!descriptor) {
        return undefined;
      }
    ...
    private createSelect(
      ...
      var select: HTMLSelectElement = this.GameStarter.createElement(
          "select",
          attributes,
        ),
        i: number;
     ...
     *
     */
    private applyElementAttributes(
      element: HTMLElement,
      attributes: any,
    ): void {
      var i: string;
    ...
    private handleUploadStart(event: IDataMouseEvent): void {
      var file: File, reader: FileReader;

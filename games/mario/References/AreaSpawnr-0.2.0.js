  ...
  var AreaSpawnr = (function () {
    ...
    AreaSpawnr.prototype.setStretches = function (stretchesRaw) {
      ...
      for (i = 0; i < stretchesRaw.length; i += 1) {
        this.stretchAdd.call(
          this.commandScope || this,
          stretchesRaw[i],
          i,
          stretchesRaw,
        );
     ...
     */
    AreaSpawnr.prototype.spawnArea = function (
      direction,
      top,
      right,
      bottom,
     ...
     * @param left    The left-most bound to spawn within.
     */
    AreaSpawnr.prototype.unspawnArea = function (
      direction,
      top,
      right,
      bottom,
     ...
     */
    AreaSpawnr.prototype.applySpawnAction = function (
      callback,
      status,
      direction,
      top,
      ...
      for (name in this.prethings) {
        ...
        start = this.findPreThingsSpawnStart(
          direction,
          group,
          mid,
          top,
        ...
        end = this.findPreThingsSpawnEnd(
          direction,
          group,
          mid,
          top,
     ...
     */
    AreaSpawnr.prototype.findPreThingsSpawnStart = function (
      direction,
      group,
      mid,
      top,
      ...
      var directionKey = AreaSpawnr.directionKeys[direction],
        directionEnd = this.getDirectionEnd(
          directionKey,
          top,
          right,
          bottom,
     ...
     */
    AreaSpawnr.prototype.findPreThingsSpawnEnd = function (
      direction,
      group,
      mid,
      top,
      ...
      var directionKey = AreaSpawnr.directionKeys[direction],
        directionKeyOpposite =
          AreaSpawnr.directionKeys[AreaSpawnr.directionOpposites[direction]],
        directionEnd = this.getDirectionEnd(
          directionKeyOpposite,
          top,
          right,
     ...
     */
    AreaSpawnr.prototype.getDirectionEnd = function (
      directionKey,
      top,
      right,
      bottom,

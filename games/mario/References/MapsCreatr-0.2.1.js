...
(function (MapsCreatr) {
  ...
  var PreThing = (function () {
    ...
    function PreThing(thing, reference, ObjectMaker) {
      ...
      this.right =
        this.left +
        (reference.width || ObjectMaker.getFullPropertiesOf(this.title).width);
      this.bottom =
        this.top +
        (reference.height ||
  ...
  var MapsCreatr = (function () {
    ...
    MapsCreatr.prototype.getPreThings = function (area) {
      var map = area.map,
        ...
        prethings = this.createObjectFromStringArray(this.groupTypes),
        i;
      area.collections = {};
     ...
     */
    MapsCreatr.prototype.analyzePreSwitch = function (
      reference,
      prethings,
      area,
      map,
     ...
     * @param {Map} map   The Map containing the Area.
     */
    MapsCreatr.prototype.analyzePreMacro = function (
      reference,
      prethings,
      area,
      map,
     ...
     */
    MapsCreatr.prototype.analyzePreThing = function (
      reference,
      prethings,
      area,
      map,
      ...
      prething = new MapsCreatr_1.PreThing(
        this.ObjectMaker.make(title, reference),
        reference,
        this.ObjectMaker,
      );
      ...
      if (
        thing[this.keyEntrance] !== undefined &&
        typeof thing[this.keyEntrance] !== "object"
      ) {
        if (typeof map.locations[thing[this.keyEntrance]] !== "undefined") {
          if (
            typeof map.locations[thing[this.keyEntrance]].xloc === "undefined"
          ) {
            map.locations[thing[this.keyEntrance]].xloc = prething.left;
          }
          if (
            typeof map.locations[thing[this.keyEntrance]].yloc === "undefined"
          ) {
     ...
     */
    MapsCreatr.prototype.ensureThingCollection = function (
      thing,
      collectionName,
      collectionKey,
      area,
          ...
          var children = prethings[i],
            array = {
              ...
              push: function (prething) {
                _this.addArraySorted(
                  array.xInc,
                  prething,
                  _this.sortPreThingsXInc,
                );
                _this.addArraySorted(
                  array.xDec,
                  prething,
                  _this.sortPreThingsXDec,
                );
                _this.addArraySorted(
                  array.yInc,
                  prething,
                  _this.sortPreThingsYInc,
                );
                _this.addArraySorted(
                  array.yDec,
                  prething,
                  _this.sortPreThingsYDec,
                );
              },
            };
          output[i] = array;

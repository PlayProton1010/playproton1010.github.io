...
(function (DeviceLayr_1) {
  ...
  var DeviceLayr = (function () {
     ...
     */
    DeviceLayr.prototype.activateAxisTrigger = function (
      gamepad,
      name,
      axis,
      magnitude,
     ...
     */
    DeviceLayr.prototype.activateButtonTrigger = function (
      gamepad,
      name,
      status,
    ) {
     ...
     */
    DeviceLayr.prototype.setDefaultTriggerStatuses = function (
      gamepad,
      triggers,
    ) {
      var mapping =

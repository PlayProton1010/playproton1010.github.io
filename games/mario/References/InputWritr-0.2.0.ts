declare namespace InputWritr {
  ...
  export interface IInputWritr {
    ...
    addEvent(
      trigger: string,
      label: any,
      callback: IInputWritrTriggerCallback,
    ): void;
...
namespace InputWritr {
  ...
  export class InputWritr implements IInputWritr {
    ...
    getAliasAsKeyStrings(alias: string): string[] {
      return this.aliases[alias].map<string>(
        this.convertAliasToKeyString.bind(this),
      );
    }
     ...
     */
    saveHistory(
      name: string = Object.keys(this.histories).length.toString(),
    ): void {

...
(function (TouchPassr) {
  ...
  var Control = (function () {
     ...
     * @returns recipient
     */
    Control.prototype.proliferateElement = function (
      recipient,
      donor,
      noOverride,
    ) {
      if (noOverride === void 0) {
        noOverride = false;
      }
      var setting, i, j;
    ...
    Control.prototype.resetElement = function (styles, customType) {
      ...
      setTimeout(function () {
        if (position.horizontal === "center") {
          _this.elementInner.style.left = _this.createHalfSizeMeasurement(
            _this.elementInner,
            "width",
            "offsetWidth",
          );
        ...
        if (position.vertical === "center") {
          _this.elementInner.style.top = _this.createHalfSizeMeasurement(
            _this.elementInner,
            "height",
            "offsetHeight",
          );
     ...
     *          "3.5em" or "10px".
     */
    Control.prototype.createHalfSizeMeasurement = function (
      element,
      styleTag,
      attributeBackup,
    ) {
      ...
      amountRaw =
        element.style[styleTag] ||
        (attributeBackup && element[attributeBackup]);
      if (!amountRaw) {
        return "0px";
      }
...
(function (TouchPassr) {
  ...
  var ButtonControl = (function (_super) {
    ...
    ButtonControl.prototype.onEvent = function (which, event) {
      var events = this.schema.pipes[which],
        i,
        j;
      if (!events) {
        return;
...
(function (TouchPassr) {
  ...
  var JoystickControl = (function (_super) {
    ...
    JoystickControl.prototype.resetElement = function (styles) {
      ...
      var directions = this.schema.directions,
        element,
        degrees,
        sin,
        cos,
    ...
    JoystickControl.prototype.triggerDragger = function (event) {
      ...
      var coordinates = this.getEventCoordinates(event),
        ...
        direction = this.schema.directions[directionNumber],
    ...
    JoystickControl.prototype.findClosestDirection = function (degrees) {
      var directions = this.schema.directions,
        difference = Math.abs(directions[0].degrees - degrees),
     ...
     * @param event   A user-triggered event.
     */
    JoystickControl.prototype.setCurrentDirection = function (
      direction,
      event,
    ) {
...
(function (TouchPassr_1) {
  ...
  var TouchPassr = (function () {
    ...
    TouchPassr.prototype.addControl = function (schema) {
      ...
      var control = new TouchPassr.controlClasses[schema.control](
        this.InputWriter,
        schema,
        this.styles,
      );

declare namespace GroupHoldr {
   ...
   */
  export interface IGroupHoldrArrayDeleteFunction
    extends IGroupHoldrDeleteFunction {
   ...
   */
  export interface IGroupHoldrObjectDeleteFunction
    extends IGroupHoldrDeleteFunction {
    (key: string): void;
  }
...
namespace GroupHoldr {
  ...
  export class GroupHoldr {
    ...
    private createFunctionSetGroup(name: string): void {
       ...
       */
      this.functions.setGroup[name] = (<any>this)["set" + name + "Group"] =
        function (value: any | any[]): void {
    ...
    private createFunctionGetGroup(name: string): void {
       ...
       */
      this.functions.getGroup[name] = (<any>this)["get" + name + "Group"] =
        function (): any | any[] {
    ...
    private createFunctionSet(name: string): void {
       ...
       */
      this.functions.set[name] = (<any>this)["set" + name] = function (
        key: string | number,
        value: any = undefined,
      ): void {
    ...
    private createFunctionGet(name: string): void {
       ...
       */
      this.functions.get[<string>name] = this["get" + name] = function (
        key: string | number,
      ): void {
    ...
    private createFunctionAdd(name: string): void {
      ...
      if (this.groupTypes[name] === Object) {
         ...
         */
        this.functions.add[name] = this["add" + name] = function (
          value: any,
          key: string,
        ): void {
          group[key] = value;
    ...
    private createFunctionDelete(name: string): void {
      ...
      if (this.groupTypes[name] === Object) {
         ...
         *              deleted.
         */
        this.functions.delete[name] = this["delete" + name] = function (
          key: string,
        ): void {
          delete group[key];
        };
        ...
        this.functions.delete[name] = this["delete" + name] = function (
          value: any,
          index: number = group.indexOf(value),
        ): void {
          if (index !== -1) {

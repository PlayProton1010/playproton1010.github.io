...
(function (GameStartr_1) {
  ...
  var GameStartr = (function (_super) {
    ...
    GameStartr.prototype.resetTimed = function (GameStarter, settings) {
      _super.prototype.resetTimed.call(
        this,
        GameStarter,
        GameStarter.resets,
        settings,
     ...
     */
    GameStartr.prototype.onAreaSpawn = function (
      GameStarter,
      direction,
      top,
      right,
     ...
     * @remarks This is generally called by a QuadsKeepr during a screen update.
     */
    GameStartr.prototype.onAreaUnspawn = function (
      GameStarter,
      direction,
      top,
      right,
     ...
     */
    GameStartr.prototype.thingProcess = function (
      thing,
      title,
      settings,
      defaults,
     ...
     */
    GameStartr.prototype.mapPlaceRandomCommands = function (
      GameStarter,
      generatedCommands,
    ) {
      var MapsCreator = GameStarter.MapsCreator,
        AreaSpawner = GameStarter.AreaSpawner,
     ...
     *                     default, false).
     */
    GameStartr.prototype.setWidth = function (
      thing,
      width,
      updateSprite,
      updateSize,
     ...
     *                     default, false).
     */
    GameStartr.prototype.setHeight = function (
      thing,
      height,
      updateSprite,
      updateSize,
     ...
     *                     default, false).
     */
    GameStartr.prototype.setSize = function (
      thing,
      width,
      height,
      updateSprite,
     ...
     */
    GameStartr.prototype.switchClass = function (
      thing,
      classNameOut,
      classNameIn,
    ) {
    ...
    GameStartr.prototype.takeScreenshot = function (name, format) {
      ...
      var GameStarter = GameStartr.prototype.ensureCorrectCaller(this),
        link = GameStarter.createElement("a", {
    ...
    GameStartr.prototype.addPageStyles = function (styles) {
      var GameStarter = GameStartr.prototype.ensureCorrectCaller(this),
        sheet = GameStarter.createElement("style", {
          type: "text/css",
        }),
        compiled = "",
        i,

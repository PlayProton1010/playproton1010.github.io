  ...
  var EightBittr = (function () {
    ...
    function EightBittr(settings) {
      ...
      var EightBitter = EightBittr.prototype.ensureCorrectCaller(this),
        ...
        constantsSource = settings.constantsSource || EightBitter,
        i;
    ...
    EightBittr.prototype.resetTimed = function (EightBitter, resets, customs) {
      var timeStartTotal = performance.now(),
        timeEndTotal,
        timeStart,
        timeEnd,
        i;
     ...
     * @returns recipient
     */
    EightBittr.prototype.proliferateHard = function (
      recipient,
      donor,
      noOverride,
    ) {
     ...
     * @returns recipient
     */
    EightBittr.prototype.proliferateElement = function (
      recipient,
      donor,
      noOverride,
    ) {

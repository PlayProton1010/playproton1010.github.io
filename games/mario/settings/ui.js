    ...
    schemas: [
      {
        ...
        options: [
          ...
          },
          {
            ...
            enable: function (FSM) {
              setTimeout(function () {
                return FSM.TouchPasser.enable();
              });
            },
            disable: function (FSM) {
              setTimeout(function () {
                return FSM.TouchPasser.disable();
              });
            },
          },
          {
            ...
            enable: function (FSM) {
              window.ondevicemotion = FSM.InputWriter.makePipe(
                "ondevicemotion",
                "type",
              );
            },
      ...
      },
      {
        ...
        assumeInactive: true,
        options: function (FSM) {
          var mods = FSM.ModAttacher.getMods(),
            output = [],
            mod,
            i;
          for (i in mods) {
        ...
        callback: function (FSM, schema, button) {
          var name = button.textContent,
            ...
            mod = FSM.ModAttacher.getMod(name);

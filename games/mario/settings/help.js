...
(function (FullScreenMario) {
  ...
  FullScreenMario.FullScreenMario.settings.help = {
    ...
    openings: [
      ...
      [
        "If you'd like to know the common cheats, enter %c{GAME}.UsageHelper.displayHelpOptions();%c here.",
        "code",
      ],
    ...
    optionHelp:
      'To focus on a group, enter %c{GAME}.UsageHelper.displayHelpOption("<group-name>");%c',
  };

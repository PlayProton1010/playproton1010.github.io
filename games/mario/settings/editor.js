FullScreenMario.FullScreenMario.settings.editor = (function (
  prethings,
  macros,
) {
  return {
    ...
    mapDefault: {
      ...
      areas: [
        {
          setting: "Overworld",
          creation: [{ macro: "Floor", x: 0, y: 0, width: 128 }],
        },
      ],
    },
    prethings: prethings,
    ...
    Characters: {
      ...
      Bowser: {
        options: {
          contents: {
            type: "String",
            options: ["Gooma", "Koopa", "HammerBro", "Bowser"],
          },
        },
      },
    },
  ...
  },
  {
    ...
    Pipe: {
      description:
        "Add a pipe with the option for piranhas and moving to locations.",
      options: {
        height: {
          type: "Number",
          value: 2,

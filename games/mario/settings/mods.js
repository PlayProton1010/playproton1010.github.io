FullScreenMario.FullScreenMario.settings.mods = {
  ...
  mods: [
    ...
    },
    {
      ...
      description:
        "The night is darkest before the dawn, but I promise you: the dawn is coming.",
      author: {
        name: "Josh Goldberg",
        email: "josh@fullscreenmario.com",
      },
      ...
      events: {
        ...
        onPreSetLocation: function (mod) {
          ...
          this.GroupHolder.callOnAll(
            this,
            this.PixelDrawer.setThingSprite.bind(this.PixelDrawer),
          );
      ...
      events: {
        onAddThing: function (mod, thing) {
          ...
          if (thing.title === "Goomba") {
            spawn = thing.FSM.killReplace(thing, "Beetle", undefined, [
              "direction",
              "moveleft",
              "lookleft",
              "xvel",
        ...
        onModEnable: function (mod) {
          var FSM =
              FullScreenMario.FullScreenMario.prototype.ensureCorrectCaller(
                this,
              ),
        ...
        onModDisable: function (mod) {
          ...
          for (i = 0; i < characters.length; i += 1) {
            ...
            if (thing.title === "Beetle" && thing.mod === "Hard Mode") {
              thing.FSM.killReplace(thing, "Goomba", undefined, attributes);
            } else {
              thing.speed /= 1.4;
            }
          }
    ...
    },
    {
      ...
      events: {
        ...
        onModDisable: function () {
          this.ObjectMaker.getFunction("Cloud").prototype.parallaxHoriz =
            undefined;
        },
      },
    },
      ...
      events: {
        onModEnable: function () {
          ...
          if (this.player) {
            ...
            this.ThingHitter.cacheChecksForType(
              this.player.title,

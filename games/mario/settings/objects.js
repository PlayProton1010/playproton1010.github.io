FullScreenMario.FullScreenMario.settings.objects = {
  ...
  properties: {
    ...
    Area: {
      ...
      setBackground:
        FullScreenMario.FullScreenMario.prototype.setAreaBackground,
      floor: 104,
      jumpmod: 1.056,
      ...
      attributes: {
        ...
        random: {
          onPlayerDeath:
            FullScreenMario.FullScreenMario.prototype.mapEntranceRespawn,
    ...
    Player: {
      ...
      onRestingOff:
        FullScreenMario.FullScreenMario.prototype.animatePlayerRestingOff,
      type: "character",
    ...
    Goomba: {
      ...
      spriteCycleSynched: [
        [
          FullScreenMario.FullScreenMario.prototype.unflipHoriz,
          FullScreenMario.FullScreenMario.prototype.flipHoriz,
        ],
      ],
    },
    Koopa: {
      ...
      attributes: {
        ...
        floating: {
          onThingAdded:
            FullScreenMario.FullScreenMario.prototype.spawnMoveFloating,
    ...
    CheepCheep: {
      ...
      attributes: {
        ...
        flying: {
          movement:
            FullScreenMario.FullScreenMario.prototype.moveCheepCheepFlying,
    ...
    SpinyEgg: {
      ...
      movement: undefined,
      onResting:
        FullScreenMario.FullScreenMario.prototype.animateSpinyEggHatching,
      spawnType: "Spiny",
      spriteCycleSynched: [["one", "two"]],
    },
    Spiny: {
    ...
    Hammer: {
      ...
      deadly: true,
      nofire: true,
      spriteCycle: [["one", "two", "three", "four"], 3],
    },
    BowserFire: {
      width: 12,
      height: 4,
    ...
    PipeHorizontal: {
      ...
      spritewidth: 19.5,
      actionLeft:
        FullScreenMario.FullScreenMario.prototype.mapExitPipeHorizontal,
      attributes: {
        width: 8,
        spritewidth: 8,
      },
    ...
    Platform: {
      ...
      attributes: {
        ...
        sliding: {
          onThingAdded:
            FullScreenMario.FullScreenMario.prototype.spawnMoveSliding,
    ...
    RestingStone: {
      ...
      onRestedUpon:
        FullScreenMario.FullScreenMario.prototype.activateRestingStone,
    },
    Cannon: {
      frequency: 280,
      spriteheight: 8,
    ...
    CastleBridge: {
      ...
      spritewidth: 4,
      killonend:
        FullScreenMario.FullScreenMario.prototype.animateCastleBridgeOpen,
    },
    CastleChain: {
      width: 7.5,
      spritewidth: 7.5,
      ...
      nocollide: true,
      killonend:
        FullScreenMario.FullScreenMario.prototype.animateCastleChainOpen,
    },
    Floor: {
    ...
    DetectWindow: {
      movement:
        FullScreenMario.FullScreenMario.prototype.activateWindowDetector,
    },
    RandomSpawner: {
    ...
    ScrollBlocker: {
      onThingAdded:
        FullScreenMario.FullScreenMario.prototype.spawnScrollBlocker,

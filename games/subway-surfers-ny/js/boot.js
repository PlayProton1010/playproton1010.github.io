  ...
  486: function (e, n, t) {
    ...
    function initApp(e) {
      ...
      (n = e.meta),
        ...
        ((a = document.querySelector("#og-game-holder")).style.backgroundColor =
          n.color),
        ...
        window.sharedAppData.config.leaderboards &&
    ...
    (console.log = function () {
      ...
      loadJson("assets/data/config.json", function (t) {
        ...
        for (var r in ((t.pokiSdkDebug = !1), window.GAME_CONFIG))
          t[r] = window.GAME_CONFIG[r];

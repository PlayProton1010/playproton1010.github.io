      ...
      var BinaryParser_BinaryParser =
        ...
        (function () {
          ...
          _proto.parseNode = function parseNode(reader, version) {
            ...
            var numProperties =
              version >= 7500 ? reader.getUint64() : reader.getUint32(); // note: do not remove this even if you get a linter warning as it moves the buffer forward
          ...
          _proto.parseProperty = function parseProperty(reader) {
            ...
            switch (type) {
              ...
              case "l":
                ...
                var reader2 = new BinaryReader_BinaryReader(

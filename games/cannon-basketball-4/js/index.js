!(function (t) {
  ...
  function o() {
    EventTarget.call(this),
      ...
      (this._onWebkitVisibilityChange =
        this._onWebkitVisibilityChange.bind(this)),
  ...
  function P(t, a) {
    ...
    n.scale.set(0.5, 0.5),
      n.anchor.set(0.5, 0.76),
      (n.x = 0.5 * Pt.gameWidth0),
      (n.y = 0.5 * Pt.gameHeight0),
      this.addChild(n);
    var i = e.generateButton("btnBackCredits", "atlasUI", t, a);
    (i.name = "BackCredits"),
      i.scale.set(0.5, 0.5),
      (i.x = Pt.gameWidth0 - i.width / 2 - 10),
      (i.y = Pt.gameHeight0 - i.height / 2 - 5),
      this.addChild(i);
  }
    ...
    for (var i = 12, s = 7, o = 0, r = 8, y = 0; y < 2; y++) {
      for (var h = 0; h < r; h++) {
        ...
        (d.x += o + h * (i + d.width)),
          ...
          d.setLocked(n > Pt.levelMng.lastOpened),
  ...
  function v(t, a) {
    ...
    const i = 0.35;
    (this._btnRestart = e.generateButton(
      "btnRestartComplete",
      "atlasUI",
      t,
      a,
      ...
      (this._btnRestart.yOut =
        Pt.gameHeight0 + this._btnRestart.height / 2 + 10),
    ...
    Pt.levelMng.currLevel == Pt.levelMng.totalLevels &&
      ...
      (this._text.y = Pt.gameHeight0 / 2 - 100),
  ...
  function b(t, a, n) {
    ...
    (o.name = "BackLevels"),
      o.scale.set(0.5, 0.5),
      (o.x = o.width / 2 + 10),
      (o.y = Pt.gameHeight0 - o.height / 2 - 5),
      this.addChild(o);
  }
  ...
  function A(t, e) {
    ...
    var i = u.createCircleShape(7.5),
      s = u.createFixtureDef(i, 0.5, 0.15, 1, {
        item: this,
        isBall: !0,
        dynamic: !0,
      }),
  ...
  function I(t, e) {
    ...
    (this._body = u.createBody(w, [o, l, h, c, g, x])),
      Pt.physics.contactListener.addBeginContactListener(
  ...
  function C(t, e, n, i) {
    ...
    var o = u.createPolygonShape(45, 45),
      r = u.createFixtureDef(o, 0.5, 0, i, {
        item: this,
        dynamic: !0,
      }),
  ...
  function B(t, e) {
    ...
    n.anchor.set(0.5, 0.7), n.scale.set(0.5, 0.5), this.addChild(n);
    ...
    o.anchor.set(0.5, 1),
      ...
      Pt.playState.aimControl &&
        ...
        Pt.playState.bg.on("pointerupoutside", this._pointerUp, this),
        (this._isAllowMove = !1),
  ...
  function M(t, e) {
    ...
    var i = u.createPolygonShape(10, 50),
      s = u.createFixtureDef(i, 0.5, 0, 0.5, {
        item: this,
        dynamic: !0,
      }),
  ...
  function E(t, e, n, i, s, o) {
    ...
    l.scale.set(0.5, 0.5),
      "left" == n
        ? l.anchor.set(0.2, 0.5)
        : "right" == n && l.anchor.set(0.8, 0.5),
      this.addChild(l);
    var y;
    "left" == n
      ? (y = u.createPolygonShape(30, 8, 11))
      : "right" == n && (y = u.createPolygonShape(30, 8, -11));
  ...
  function T(t, e, n, i) {
    ...
    var o = u.createPolygonShape(12, 74, 62, 0),
      r = u.createFixtureDef(o, 0.3, 0.1, i, {
        item: this,
        dynamic: !0,
      }),
      l = u.createPolygonShape(59, 12, 26, 0),
      y = u.createFixtureDef(l, 0.3, 0.1, i, {
        item: this,
        dynamic: !0,
      }),
  ...
  function O(t, e, n, i, s) {
    ...
    var r = u.createPolygonShape(150, 14),
      l = u.createFixtureDef(r, 0.5, 0, 0.2, {
        item: this,
        dynamic: !0,
      }),
      y = u.createPolygonShape(14, 150),
      h = u.createFixtureDef(y, 0.5, 0, 0.2, {
        item: this,
        dynamic: !0,
      }),
  ...
  function k(t, e) {
    ...
    var i = u.createCircleShape(15),
      s = u.createFixtureDef(i, 0.2, 0.1, 1, {
        item: this,
        isPeg: !0,
      }),
  ...
  function R(t, e, n, i, s, o, r, l, y) {
    if (
      (a.call(this, "Pivot", Z.zOrder.pivot),
      (this.x = t),
      (this.y = e),
      (this.type = n),
      "bolt" == this.type)
    ...
    for (
      var g = [],
        m = new lt(t / Pt.physScale, e / Pt.physScale),
        u = Pt.physWorld.GetBodyList();
      null != u;
    ...
    if (
      ...
      if (
        ...
        (this._massData.mass = 0.05),
        this._trackBody.SetUseOwnGravity(!0),
        this._trackBody.SetGravity(0, 0),
  ...
  function L(t, e, n, i, s, o) {
    ...
    var r = u.convertBodyTypeFromStringToNumber(s),
      l = 18;
    a.call(this, "Platform", Z.zOrder.platform),
      (this.x = t),
      (this.y = e),
      (this.rotation = i);
    ...
    h.scale.set(0.5, 0.5),
      h.anchor.set(0.5, 0.5),
      (h.x = Pt.rnd.realInRange(0, h.width / 2 - n / 2)),
      y.addChild(h);
    var d = 1,
      c = new PIXI.Graphics();
    c.lineStyle(d, 1968900, 1),
      c.drawRect(-n / 2 - d / 2, -l / 2, n + d, l),
      this.addChild(c);
    var p = u.createPolygonShape(n, l),
      g = u.createFixtureDef(p, 0.1, 0.1, o, {
        item: this,
        dynamic: !0,
      }),
    ...
    x.beginFill(9160191, 0.4),
      x.drawRect(-n / 2, -l / 2, n, l),
      x.endFill(),
      y.addChild(x),
      (y.mask = x),
      r != ht.b2_staticBody &&
  ...
  function G(t, e, n) {
    ...
    var s = u.createCircleShape(24),
      o = u.createFixtureDef(s, 0.5, 0, n, {
        item: this,
        dynamic: !0,
      }),
      r = u.createBodyDef(t, e, ht.b2_dynamicBody);
    (this._body = u.createBody(r, [o])),
      this._enableUpdate(),
      (this.angleUpdate = !0),
      (this.positionUpdate = !0);
  }
  ...
  function U(t, e, n, i, s) {
    ...
    var l = u.createPolygonShape(14, 14),
      ...
      h = u.createBodyDef(
        t,
        e,
        u.convertBodyTypeFromStringToNumber(this.type),
        !1,
        !0,
        n,
      );
    ...
    var d = u.createPolygonShape(4, 10, -22, -26),
      ...
      x = u.createFixtureDef(m, 1, 0, 0.1, this, !0),
    ...
    if (((this._body2 = u.createBody(v, [c, g, x, f, _])), "dynamic" == i)) {
      ...
      b.Initialize(
        this._body,
        this._body2,
        new lt(t / Pt.physScale, e / Pt.physScale),
      );
  ...
  function N(t, e, n, i, s, o) {
    ...
    (this._body = u.createBody(g, [d, p])),
      ...
      "button" == this.type &&
        Pt.physics.contactListener.addEndContactListener(
          this._onEndContact,
          this,
        ),
  ...
  function H(t, e, n) {
    a.call(this, "WightBall", Z.zOrder.peg),
      (n = n || 2),
      (this.x = t),
      (this.y = e);
  ...
  function J() {
    ...
    t.beginFill(0),
      t.drawRect(0, 0, Pt.gameWidth0, Pt.gameHeight0),
      t.endFill(),
      this.addChild(t);
  }
  ...
  function K() {
    ...
    t.scale.set(0.5, 0.5),
      ...
      (this._levelsDialog = new b(this._onBtnsLevelClick, this._onClick, this)),
  ...
  function Z() {
    ...
    (e.alpha = 0.1),
      ...
      (this._isComplete = !1),
      Pt.levelMng.create(),
      Pt.levelMng.currLevel >= 1 &&
        Pt.levelMng.currLevel <= 2 &&
        this.gameLayer.addChild(new z(Pt.levelMng.currLevel)),
      (this.sndButton = Pt.assets.getSound("sndButton")),
      this.aimControl &&
  ...
  function $() {
    if (
      ...
      (Pt.audioEnabled =
        !Pt.device.ie &&
        (Pt.device.canPlayAudio("ogg") || Pt.device.canPlayAudio("m4a"))),
      ...
      return (
        t.appendChild(e), void document.getElementById("msg").appendChild(t)
      );
    }
    var a = document.getElementById("msg");
    a.parentNode.removeChild(a),
      (Pt.pixi = new PIXI.Application(Pt.canvasWidth, Pt.canvasHeight, {
        antialias: !0,
      })),
    ...
    Pt.storage.read(i),
      (Pt.assets = new s(Pt)),
      (Pt.rnd = new x([(Date.now() * Math.random()).toString()]));
    try {
  ...
  function tt() {
    Pt.preloader
      ? (Pt.preloader.setLoading(100), Pt.preloader.loadedCallback(et))
      : at();
  }

  function et() {
    (Pt.splash = new i()),
      Pt.splash.runAfter(at, 3e3),
      Pt.pixi.stage.addChild(Pt.splash);
  }
  ...
  function at() {
    if (
      ...
      rt.atHome([
        "games.armorgames.com",
        "preview.armorgames.com",
        "cache.armorgames.com",
        "cdn.armorgames.com",
        "gamemedia.armorgames.com",
        "files.armorgames.com",
        "armorgames.com",
        "www.cb4.bitballoon.com",
        "cb4.bitballoon.com",
        "localhost",
      ]))
    ) {
      ...
      1 == t
        ? new K()
        : 2 == t && ((Pt.levelMng.currLevel = Pt.currLevelDebug), new Z()),
        Pt.shutter.hide();
    }
  }
  ...
  (e.prototype = Object.create(PIXI.Sprite.prototype)),
    ...
    (e.prototype.setIcon = function (t, e, a, n, i) {
      if (!this.disposed) {
        ...
        s &&
          (this.icon
            ? this.icon.setTexture(s)
            : (this.icon = new PIXI.Sprite(s))),
    ...
    (e.prototype.setLabel = function (t, e, a, n) {
      (t = t || ""),
        ...
        (n = n || 0),
        this._label ||
          ((this._label = new PIXI.Text(t, e)), this.addChild(this._label)),
        (this._label.text = t),
    ...
    (e.prototype._mouseDown = function (t) {
      this.disposed ||
        ((this.isDown = !0), (this.tint = this.downTint), this.onDown.call(t));
    }),
    ...
    (a.prototype._update = function () {
      this.angleUpdate && (this.rotation = this._body.GetAngle()),
        this.positionUpdate &&
          ((this.x = this._body.GetPosition().x * Pt.physScale),
          (this.y = this._body.GetPosition().y * Pt.physScale)),
        this.y > 3e3 &&
          (console.log(
            "Item " +
              this.name +
    ...
    (n.prototype._update = function () {
      this._curr < this._loaded &&
        (this._curr = Math.round(this._curr + 2 * Pt.pixi.ticker.deltaTime)),
    ...
    (s.prototype.getTexture = function (t, e) {
      return e
        ? PIXI.loader.resources[e].textures[t]
        : PIXI.utils.TextureCache[t];
    }),
    ...
    (o.prototype._onVisibilityChange = function (t) {
      t.preventDefault(),
        ...
        (this._event.type =
          document.hidden === !1 ? "onPageShow" : "onPageHide"),
    ...
    (o.prototype._onWebkitVisibilityChange = function (t) {
      t.preventDefault(),
        (this._event.originalEvent = t),
        (this._event.type =
          document.webkitHidden === !1 ? "onPageShow" : "onPageHide"),
        this.emit(this._event);
    }),
    ...
    (o.prototype._onResize = function (t) {
      ...
      this.orientation !== e &&
        ((this._event.orientation = this.orientation = e),
    ...
    Object.defineProperty(r.prototype, "enable", {
      ...
      set: function (t) {
        this.disposed ||
          ((this.interactive = t),
          t === !1 && ((this.isOver = !1), this._mouseUp()));
      },
    }),
    ...
    (l.prototype.setLocked = function (t) {
      if (((this.enable = !t), t)) {
        ...
        for (
          var a = Pt.storage.get(Pt.SAVE_KEY_STARS + this.num), n = 0;
          n < 3;
          n++
        )
    ...
    (h.prototype.add = function (t) {
      ...
      return e >= 0
        ? void (
            this.throwIfIn &&
            new Error("Item already in collection. [" + this.name + "].")
          )
    ...
    (h.prototype.remove = function (t) {
      ...
      return e < 0
        ? void (
            this.throwIfNotIn &&
            new Error("There is not item in collection. [" + this.name + "].")
          )
    ...
    (h.prototype.at = function (t) {
      return (
        t < 0
          ? (this.throwIfOut &&
              new Error("Index is lower than zero. [" + this.name + "]."),
            (t = 0))
          : t >= this._arr.length &&
            (this.throwIfOut &&
              new Error("Index is higher than total. [" + this.name + "]."),
    ...
    (Device.prototype = {
      ...
      _checkFeatures: function () {
        ...
        (this.file = !!(t.File && t.FileReader && t.FileList && t.Blob)),
          ...
          ("ontouchstart" in document.documentElement ||
            ...
            (this.touch = !0),
          (t.navigator.msPointerEnabled || t.navigator.pointerEnabled) &&
            (this.mspointer = !0),
          (this.pointerLock =
      ...
      _checkAudio: function () {
        ...
        try {
          (a = !!e.canPlayType) &&
            (e.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/, "") &&
              (this.ogg = !0),
            ...
            (e.canPlayType("audio/x-m4a;") ||
              ...
              (this.m4a = !0),
            e.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "") &&
              (this.webm = !0));
        } catch (t) {}
      },
      ...
      _checkCSS3D: function () {
        ...
        for (var i in n)
          void 0 !== a.style[i] &&
            ((a.style[i] = "translate3d(1px,1px,1px)"),
            (e = t.getComputedStyle(a).getPropertyValue(n[i])));
    ...
    (c.prototype.call = function () {
      if (!this.disposed && this._callbacks.length > 0) {
        ...
        for (this._blocked = !0, t = this._callbacks.length - 1; t >= 0; t--)
          this._callbacks[t].apply(
            null,
            arguments.length > 0 ? Array.prototype.slice.call(arguments) : null,
          );
  ...
  (g.prototype.collectInteractiveSprite = function (t, e) {
      ...
      (s.visible === !1 && this.interactInvisible === !1) ||
        (s.interactive
          ? (console.log(st, s.name),
            ...
            s.children.length > 0 &&
              ((st += "\t"), this.collectInteractiveSprite(s, s)))
          : ((s.__iParent = null),
              ...
              (i.__hit = null != i.__target || this.hitTest(i, this.mouse)),
                i.__hit
                  ? (i.buttonMode &&
                    ...
                    i.__target
                      ? (this.mouse.target = i.__target)
                      : (this.mouse.target = i),
                    i.__isOver ||
                      (i.mouseover && i.mouseover(this.mouse),
                      (i.__isOver = !0)))
                  : i.__isOver &&
                    (i.mouseout && i.mouseout(this.mouse), (i.__isOver = !1));
            }
          }
          for (a = n - 1; a >= 0; a--)
            (i = this.interactiveItems[a]), (i.__target = null);
        }
      }
    }),
    (g.prototype.onMouseMove = function (e) {
      ...
      (this.mouse.global.x =
        (e.clientX - a.left) * (this.target.width / a.width)),
        (this.mouse.global.y =
          (e.clientY - a.top) * (this.target.height / a.height));
    ...
    (g.prototype.onMouseDown = function (e) {
      ...
      for (console.log(s, a), o = a - 1; o >= 0; o--)
        (r = this.interactiveItems[o]), (r.__target = null);
    }),
    (g.prototype.onMouseOut = function () {
      ...
      for (var e = 0; e < t; e++) {
        ...
        a.__isOver &&
          ((this.mouse.target = a),
          a.mouseout && a.mouseout(this.mouse),
          (a.__isOver = !1));
      }
    }),
    ...
    (g.prototype.hitTest = function (t, e) {
      ...
      if (t.hitArea && t.hitArea.contains)
        return !!t.hitArea.contains(c, p) && ((e.target = t), !0);
      if (n) {
        var g,
          m = t.texture.frame.width,
          u = t.texture.frame.height,
          x = -m * t.anchor.x;
        if (c > x && c < x + m && ((g = -u * t.anchor.y), p > g && p < g + u))
          return (e.target = t), !0;
      }
      ...
      for (s = 0; s < i.length; s++) {
        ...
        (a = this.touchs[o.identifier]),
          ...
          navigator.isCocoonJS &&
            ((a.global.x = o.clientX), (a.global.y = o.clientY));
      }
      ...
      for (
        ...
        for (var r = this.interactiveItems.length, l = 0; l < r; l++) {
          ...
          if (
            ...
            y.__hit &&
              (y.touchstart && y.touchstart(o),
              (y.__isDown = !0),
              (y.__touchData = o),
              !y.interactiveChildren))
          )
            break;
        }
      }
        ...
        for (var l = this.interactiveItems.length, y = 0; y < l; y++) {
          ...
          (h.__hit = this.hitTest(h, o)),
            d === o &&
              ...
              (h.touchend || h.tap) &&
                (h.__hit && !r
                  ? (h.touchend && h.touchend(o),
                    h.__isDown && h.tap && h.tap(o),
                    h.interactiveChildren || (r = !0))
  ...
  (rt.generateFrameNames = function (t, e, a, n, i) {
    ...
    if (e < a)
      ...
      for (s = e; s >= a; s--)
        (r =
          "number" == typeof i
            ? Phaser.Utils.pad(s.toString(), i, "0", 1)
            : s.toString()),
          (r = t + r + n),
          o.push(r);
    return o;
  ...
  (u.prototype.constructor = u),
    ...
    (u.prototype._createGround = function () {
      ...
      (e.type = ht.b2_staticBody),
        (t.shape = new gt()),
        t.shape.SetAsBox(
          (Pt.gameWidth0 / 2 - 4) / Pt.physScale,
          10 / Pt.physScale,
        ),
        e.position.Set(
          Pt.gameWidth0 / 2 / Pt.physScale,
          Pt.gameHeight0 / Pt.physScale,
        ),
    ...
    (v.prototype.show = function (t, e) {
      ...
      TweenMax.to(this._btnMenu, a, {
        ...
        TweenMax.to(this._btnRestart, a, {
          delay: (t += 0.05),
          x: r,
          y: l,
          ease: o,
        }),
        (this._btnNext.enable =
          Pt.levelMng.currLevel != Pt.levelMng.totalLevels),
        (r = this._btnNext.xIn),
        (l = this._btnNext.yIn),
        TweenMax.to(this._btnNext, a, {
          delay: (t += 0.05),
          x: r,
          y: l,
          ease: o,
    ...
    (b.prototype.refresh = function () {
      for (var t = this._boards.length, e = 0; e < t; e++)
        this._boards[e].refresh();
    }),
    ...
    (A.prototype.setVelocity = function (t) {
      ...
      this._body.SetLinearVelocity(e),
        this._body.SetAngularVelocity(e.x / 10 + 0.4),
        this._body.SetAwake(!0);
    }),
    (A.prototype._update = function () {
      a.prototype._update.call(this),
        this.y > Pt.gameHeight0 + 50 && this.destroy();
    }),
    ...
    (I.prototype.destroy = function () {
      a.prototype.destroy.call(this),
        Pt.physics.contactListener.removeBeginContactListener(
          this._onBeginContact,
          this,
        );
    }),
    ...
    (D.prototype._createRails = function () {
      ...
      for (var n = 0; n < a; n++) {
        ...
        i.scale.set(0.5, 0.5),
          i.anchor.set(0, 0.5),
          (i.x = (i.width - 1) * n),
          this._rails.addChild(i);
      }
      "v" == this._orienation
        ? ((this._rails.rotation = ot.toRadians(90)),
          this.y > this._endY && (this._rails.y -= t))
    ...
    (B.prototype.destroy = function () {
      a.prototype.destroy.call(this),
        ...
        Pt.playState.bg.off("pointerupoutside", this._pointerUp, this);
    }),
    ...
    (B.prototype._update = function (t) {
      if (this._isAllowMove) {
        var e = Pt.pixi.renderer.plugins.interaction,
          a = {};
        Pt.playState.aimControl
          ? ((a.x = this._pointerData.global.x),
            (a.y = this._pointerData.global.y))
          : (a = e.pointer.global),
          (a = {
            x: a.x / Pt.scale,
            y: a.y / Pt.scale,
        ...
        var s = 0,
          o = 0;
        Pt.playState.aimControl
          ? ((s = Pt.playState.aim.position.x),
            (o = Pt.playState.aim.position.y))
        ...
        var r =
            ot.distance1(this._launchX, this._launchY, s, o) / this.shotScale,
        ...
        (l < h || l < y || o > this.y + 50) && (r = 0),
          r > 1 && (r = 1),
          (this._powerBarMask.scale.y = r);
        ...
        for (var g = 25, m = 4, u = 0.8, x = 1; x <= 15 * r; x++)
          this.graphics.beginFill(32110, (u /= 1.1)),
    ...
    (E.prototype._onTriggerEvent = function (t) {
      ...
      if (this.id == e && !this.opened) {
        ...
        "left" == this.direction
          ? (this._body.SetAwake(!0),
            this._body.SetAngularVelocity(a * (this.inversed ? -1 : 1)))
    ...
    (O.prototype._onTriggerEvent = function (t) {
      ...
      this.signalID == e &&
        ((this.motorSpeed *= -1),
        this._revJoint.SetMotorSpeed(this.motorSpeed));
    }),
    ...
    (R.prototype._onTriggerEvent = function (t) {
      ...
      t.state;
      this.gearSignalID == e &&
        ("on" == this._state ? (this._state = "off") : (this._state = "on"),
        "on" == this._state
          ? this._motorOn(this.gearPower, this.TO_DESTINATION)
          : "off" == this._state &&
            this._motorOn(-this.gearPower, this.TO_START_ANGLE));
    }),
    ...
    (R.prototype._motorOff = function () {
      ...
      Pt.physics.doIt(function () {
        t._movingTo == t.TO_DESTINATION
          ...
          : t._movingTo == t.TO_START_ANGLE &&
            t._trackBody.SetAngle(ot.toRadians(t._trackBodyStartAngle)),
    ...
    (R.prototype._update = function () {
      ...
      this._movingTo == this.TO_DESTINATION
        ...
        : this._movingTo == this.TO_START_ANGLE &&
          ot.equal(t, this._trackBodyStartAngle, 2) &&
          this._motorOff();
    }),
    ...
    (U.prototype._throwBody = function (t) {
      ...
      t.SetLinearVelocity(a),
        this._spring.gotoAndPlay(0),
        this._spring.play(),
        Pt.soundOn && this.sndSpring.play();
    }),
    ...
    (N.prototype.destroy = function () {
      a.prototype.destroy.call(this),
        ...
        Pt.physics.contactListener.removeEndContactListener(
          this._onEndContact,
          this,
        );
    }),
      ...
      if (null != e && 1 == e.dynamic) {
        if ("button" == this.type) {
          ...
          this._switcher.onComplete = function () {
            n._on &&
              a.events.emit(a.EVENT_TRIGGER_PRESSED, {
                id: n.signalID,
                state: "on",
              });
          };
    ...
    (W.prototype._onBeginContact = function (t) {
      ...
      e instanceof A &&
        ((null != e.teleportPhase && 0 != e.teleportPhase) ||
          ((e.teleportPhase = 1),
          a.events.emit(a.EVENT_TELEPORTATION, {
            sender: this,
            ball: e,
            id: this.id,
          })));
    ...
    (W.prototype._onEndContact = function (t) {
      var e = u.getAnotherOfContact(t, this);
      e instanceof A &&
        (e.teleportPhase++, e.teleportPhase >= 3 && (e.teleportPhase = 0));
    }),
      ...
      if (e != this && n == this.id) {
        ...
        Pt.physics.doIt(function () {
          ...
          var t = a._body.GetLinearVelocity(),
            e = ot.vectorVelocityRad(
              i.rotation - ot.toRadians(90),
              t.Length() * i.mulVel,
            ),
            n = new lt(e.x, e.y);
    ...
    (H.prototype._update = function () {
      a.prototype._update.call(this),
        this.y > Pt.gameHeight0 + 100 && this.destroy();
    }),
    ...
    (j.prototype.create = function (t) {
      (t = t || this.currLevel),
        ...
        (this.currLevel = t),
        t--;
      for (var e = ft[t].items, a = e.length, n = 0; n < a; n++)
        this._createItem(e[n]);
    }),
    (j.prototype.onLevelComplete = function () {
      this.currLevel == this.lastOpened &&
        (this.lastOpened++,
        Pt.storage.set(Pt.SAVE_KEY_LAST_OPENED, this.lastOpened));
    }),
  ...
  (ft[0] = {
    ...
    (Z.prototype._createUI = function () {
      ...
      (n.name = "Facebook"),
        n.scale.set(0.5, 0.5),
        n.anchor.set(0.5, 1),
        (n.x = a.x - a.width / 2 - n.width / 2 - 5),
        (n.y = t.y),
        this.uiLayer.addChild(n);
      var i = e.generateButton(
        "btnMoreGamesGame",
        "atlasUI",
        this._onBtnsClick,
        this,
      ...
      (this._txtLevel = new PIXI.Text("Level: " + Pt.levelMng.currLevel, o)),
        (this._txtLevel.x = 5),
        (this._txtLevel.y = 5),
      ...
      r.anchor.set(0.5, 0.5),
        r.scale.set(0.5, 0.5),
        (r.x = Pt.gameWidth0 - r.width / 2 - 10),
      ...
      y.anchor.set(0.5, 0.5),
        y.scale.set(0.5, 0.5),
        (y.x = l.x - l.width / 2 - y.width / 2 - 5),
        (y.y = r.y),
        (y.empty = !0),
        this.addChild(y),
        (this._starPlaces = [r, l, y]),
  ...
  (t.App = Pt),
    ...
    (Pt._checkAudio = function () {
      Pt.audioEnabled
        ? (void 0 != Pt.storage.get(Pt.SAVE_KEY_MUSIC) &&
            (Pt.musicOn = "true" == Pt.storage.get(Pt.SAVE_KEY_MUSIC)),
          void 0 != Pt.storage.get(Pt.SAVE_KEY_SOUND) &&
            (Pt.soundOn = "true" == Pt.storage.get(Pt.SAVE_KEY_SOUND)),
    ...
    (Pt.setMusicEnable = function (t) {
      Pt.audioEnabled !== !1 &&
        ((Pt.musicOn = t),
        Pt.musicOn
          ? Pt.mainTheme.isPlaying ||
            (Pt.mainTheme.resume(),
            Pt.mainTheme.isPlaying || Pt.mainTheme.play())
    ...
    (Pt.setSoundEnable = function (t) {
      Pt.audioEnabled !== !1 &&
        ((Pt.soundOn = t), Pt.storage.set(Pt.SAVE_KEY_SOUND, Pt.soundOn));
    }),
    (Pt.switchSoundEnable = function () {
      Pt.setSoundEnable(!Pt.soundOn);
    }),
    (t.unlockAllLevels = function () {
      Pt.levelMng && Pt.levelMng.unlockAllLevels(),
        Pt.menuState && Pt.menuState._levelsDialog.refresh();
    }),
